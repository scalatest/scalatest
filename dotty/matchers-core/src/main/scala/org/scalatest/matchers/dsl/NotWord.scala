...
final class NotWord {
   ...
   * </pre>
   **/
  private[scalatest] infix def contain[T](resultOfAWordApplication: ResultOfAWordToAMatcherApplication[T]): Matcher[Iterable[T]] = {
   ...
   * </pre>
   **/
  private[scalatest] infix def contain[T](resultOfAnWordApplication: ResultOfAnWordToAnMatcherApplication[T]): Matcher[Iterable[T]] = {
    new Matcher[Iterable[T]] {
      def apply(left: Iterable[T]): MatchResult = {
