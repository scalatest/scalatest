...
object MatchPatternHelper {
   ...
   * </pre>
   */
  def matchPatternMatcher(right: PartialFunction[Matchable, _]): Matcher[Any] =
    new Matcher[Any] {
   ...
   * </pre>
   */
  def notMatchPatternMatcher(right: PartialFunction[Matchable, _]): Matcher[Any] =
    new Matcher[Any] {
      def apply(left: Any): MatchResult = {
        MatchResult(
          !right.isDefinedAt(left),
   ...
   * </pre>
   */
  def checkMatchPattern(resultOfNoWordForAny: ResultOfNotWordForAny[_], right: PartialFunction[Matchable, _]): Unit = {
