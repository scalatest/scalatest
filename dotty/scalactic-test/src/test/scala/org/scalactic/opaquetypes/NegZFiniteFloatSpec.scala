...
class NegZFiniteFloatSpec extends funspec.AnyFunSpec with matchers.should.Matchers with PropertyChecks with TypeCheckedTripleEquals with NegZFiniteFloatSpecSupport {
  ...
  describe("A NegZFiniteFloat") {
    ...
    it("should be sortable") {
      ...
      xs.sorted(using summon[Ordering[NegZFiniteFloat]]) shouldEqual List(NegZFiniteFloat(-3.3F), NegZFiniteFloat(-2.2F),
    ...
    describe("when created with apply method") {
      ...
      it("should compile when -8 is passed in") {
        ...
        "NegZFiniteFloat(-8.0)" shouldNot compile
      }

      it("should compile when 0 is passed in") {
        "NegZFiniteFloat(0)" shouldNot compile
        "NegZFiniteFloat(0L)" shouldNot compile
        "NegZFiniteFloat(0.0F)" should compile
        NegZFiniteFloat(0.0F).value shouldEqual 0.0F
        "NegZFiniteFloat(0.0)" shouldNot compile
      }
      ...
      it("should not compile when x is passed in") {
        ...
        val d: Double = -8.0
        "NegZFiniteFloat(d)" shouldNot compile
      }
    }
    describe("when specified as a plain-old Float") {
      ...
      it("should compile when -8 is passed in") {
        ...
        "takesNegZFiniteFloat(-8.0)" shouldNot compile
      }

      it("should compile when 0 is passed in") {
        "takesNegZFiniteFloat(0)" shouldNot compile
        "takesNegZFiniteFloat(0L)" shouldNot compile
        "takesNegZFiniteFloat(0.0F)" should compile
        takesNegZFiniteFloat(0.0F) shouldEqual 0.0F
        "takesNegZFiniteFloat(0.0)" shouldNot compile
      }
      ...
      it("should not compile when x is passed in") {
        ...
        val d: Double = -8.0
        "takesNegZFiniteFloat(d)" shouldNot compile
      }
