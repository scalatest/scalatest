  ...
  describe("A PosZInt") {
    describe("should offer a from factory method that") {
      it("returns Some[PosZInt] if the passed Int is greater than or equal to 0") {
        PosZInt.from(0) shouldBe Some(PosZInt(0))
        PosZInt.from(50) shouldBe Some(PosZInt(50))
        PosZInt.from(100) shouldBe Some(PosZInt(100))
      }
    ...
    describe("should offer an ensuringValid factory method that") {
      it("returns PosZInt if the passed Int is greater than or equal to 0") {
        PosZInt.ensuringValid(0) shouldBe PosZInt(0)
        PosZInt.ensuringValid(50) shouldBe PosZInt(50)
        PosZInt.ensuringValid(100) shouldBe PosZInt(100)
      }
    ...
    describe("should offer a tryingValid factory method that") {
      ...
      it("returns a PosZInt wrapped in a Success if the passed Int is greater than or equal 0") {
        PosZInt.tryingValid(0) shouldBe Success(0)
        PosZInt.tryingValid(50) shouldBe Success(50)
        PosZInt.tryingValid(100) shouldBe Success(100)
      }
    ...
    describe("should offer a fromOrElse factory method that") {
      it("returns a PosZInt if the passed Int is greater than or equal to 0") {
        PosZInt.fromOrElse(50, PosZInt(42)) shouldBe PosZInt(50)
        PosZInt.fromOrElse(100, PosZInt(42)) shouldBe PosZInt(100)
        PosZInt.fromOrElse(0, PosZInt(42)) shouldBe PosZInt(0)
      }
      it("returns a given default if the passed Int is NOT greater than or equal to 0") {
        PosZInt.fromOrElse(-1, PosZInt(42)) shouldBe PosZInt(42)
        PosZInt.fromOrElse(-99, PosZInt(42)) shouldBe PosZInt(42)
      }
    } 
