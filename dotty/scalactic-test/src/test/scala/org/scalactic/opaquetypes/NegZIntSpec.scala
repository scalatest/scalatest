...
trait NegZIntSpecSupport {
  ...
  given Generator[NegZInt] =
    Generator.negZIntGenerator.map((i: org.scalactic.anyvals.NegZInt) => NegZInt.ensuringValid(i.value))
  ...
  describe("A NegZInt") {
    ...
    describe("when specified as a plain-old Int") {
      ...
      it("should compile when -8 is passed in") {
        ...
        "takesNegZInt(-8L)" shouldNot compile
        "takesNegZInt(-8.0f)" shouldNot compile
        "takesNegZInt(-8.0)" shouldNot compile
      }

      it("should compile when 0 is passed in") {
        "takesNegZInt(0)" should compile
        takesNegZInt(0) shouldEqual 0
        "takesNegZInt(0L)" shouldNot compile
        "takesNegZInt(0.0f)" shouldNot compile
        "takesNegZInt(0.0)" shouldNot compile
      }
      ...
      it("should not compile when x is passed in") {
        ...
        val l: Long = -8L
        "takesNegZInt(l)" shouldNot compile
        val f: Float = -8.0f
        "takesNegZInt(f)" shouldNot compile
        val d: Double = -8.0
        "takesNegZInt(d)" shouldNot compile
      }
    }
