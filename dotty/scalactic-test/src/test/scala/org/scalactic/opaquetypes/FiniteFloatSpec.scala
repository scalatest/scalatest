  ...
  describe("A FiniteFloat") {
    ...
    describe("when created with apply method") {
      ...
      it("should compile when 8 is passed in") {
        "FiniteFloat(8)" shouldNot compile
        "FiniteFloat(8L)" shouldNot compile
        "FiniteFloat(8.0F)" should compile
        FiniteFloat(8.0F).value shouldEqual 8.0F
        "FiniteFloat(8.0)" shouldNot compile
      }

      it("should compile when 0 is passed in") {
        "FiniteFloat(0)" shouldNot compile
        "FiniteFloat(0L)" shouldNot compile
        "FiniteFloat(0.0F)" should compile
        FiniteFloat(0.0F).value shouldEqual 0.0F
        "FiniteFloat(0.0)" shouldNot compile
      }
      ...
      it("should not compile when x is passed in") {
        ...
        val d: Double = -8.0
        "FiniteFloat(d)" shouldNot compile
      }
    }
    describe("when specified as a plain-old Float") {
      ...
      it("should compile when 8 is passed in") {
        "takesFiniteFloat(8)" shouldNot compile
        "takesFiniteFloat(8L)" shouldNot compile
        "takesFiniteFloat(8.0F)" should compile
        takesFiniteFloat(8.0F) shouldEqual 8.0F
        "takesFiniteFloat(8.0)" shouldNot compile
      }

      it("should compile when 0 is passed in") {
        "takesFiniteFloat(0)" shouldNot compile
        "takesFiniteFloat(0L)" shouldNot compile
        "takesFiniteFloat(0.0F)" should compile
        takesFiniteFloat(0.0F) shouldEqual 0.0F
        "takesFiniteFloat(0.0)" shouldNot compile
      }
      ...
      it("should not compile when x is passed in") {
        ...
        val d: Double = -8.0
        "takesFiniteFloat(d)" shouldNot compile
      }
