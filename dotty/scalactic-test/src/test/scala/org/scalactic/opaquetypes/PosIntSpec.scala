  ...
  describe("A PosInt") {
    ...
    describe("should offer a from factory method that") {
      it("returns Some[PosInt] if the passed Int is greater than 0") {
        PosInt.from(50) shouldBe Some(PosInt(50))
        PosInt.from(100) shouldBe Some(PosInt(100))
      }
    ...
    describe("should offer an ensuringValid factory method that") {
      it("returns PosInt if the passed Int is greater than 0") {
        PosInt.ensuringValid(50) shouldBe PosInt(50)
        PosInt.ensuringValid(100) shouldBe PosInt(100)
      }
