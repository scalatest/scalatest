  ...
  describe("A NegFloat") {
    ...
    describe("when created with apply method") {
      ...
      it("should compile when -8 is passed in") {
        ...
        "NegFloat(-8.0)" shouldNot compile
      }
      ...
      it("should not compile when 0 is passed in") {
        ...
        "NegFloat(0.0)" shouldNot compile
      }
    ...
    describe("when specified as a plain-old Float") {
      ...
      it("should compile when -8.0f is passed in") {
        ...
        "takesNegFloat(-8.0)" shouldNot compile
      }
      ...
      it("should not compile when 0 is passed in") {
        ...
        "takesNegFloat(0.0)" shouldNot compile
      }
      ...
      it("should not compile when x is passed in") {
        ...
        val d: Double = -8.0
        "takesNegFloat(d)" shouldNot compile
      }
