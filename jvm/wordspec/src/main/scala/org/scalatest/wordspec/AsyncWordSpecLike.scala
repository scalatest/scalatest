...
trait AsyncWordSpecLike extends AsyncTestSuite with ShouldVerb with MustVerb with CanVerb with Informing with Notifying with Alerting with Documenting { thisSuite =>
  ...
  //DOTTY-ONLY   ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => engine.registerIgnoredAsyncTest(testText, transformToOutcome(testFun), Resources.testCannotBeNestedInsideAnotherTest, None, p, testTags: _*) }) } 
  //DOTTY-ONLY }
  ...
  protected final class ResultOfTaggedAsInvocationOnString(specText: String, tags: List[Tag]) {
    ...
    //DOTTY-ONLY   ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerPendingTestToRun(specText, tags, "is", () => testFun, p) }) } 
    //DOTTY-ONLY }
    ...
    // SKIP-DOTTY-END
    //DOTTY-ONLY inline infix def ignore(testFun: => Future[compatible.Assertion])(implicit pos: source.Position) = {
  ...
  //DOTTY-ONLY    * </p>
  //DOTTY-ONLY    */
  //DOTTY-ONLY   inline infix def in(f: => Future[compatible.Assertion])(implicit pos: source.Position): Unit = {
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerTestToRun(s, List(), "in", () => f, p) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY   /**
  ...
  //DOTTY-ONLY    * </p>
  //DOTTY-ONLY    */
  //DOTTY-ONLY   inline infix def ignore(f: => Future[compatible.Assertion])(implicit pos: source.Position): Unit = {
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerTestToIgnore(s, List(), "ignore", () => f, p) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY   /**
  ...
  //DOTTY-ONLY    * </p>
  //DOTTY-ONLY    */
  //DOTTY-ONLY   inline infix def is(f: => PendingStatement)(implicit pos: source.Position): Unit = {
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerPendingTestToRun(s, List(), "is", () => f, p) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY   /**
  ...
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerBranch(s, Some("when"), "when", p, () => f) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY   /**
  ...
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerBranch(s, Some("when " + resultOfAfterWordApplication.text), "when", p, resultOfAfterWordApplication.f) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY   /**
  ...
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerBranch(s.trim + " that", None, "that", p, () => f) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY   /**
  ...
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerBranch(s.trim + " which", None, "which", p, () => f) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY   /**
  ...
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerBranch(s.trim + " that " + resultOfAfterWordApplication.text.trim, None, "that", p, resultOfAfterWordApplication.f) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY   /**
  ...
  //DOTTY-ONLY     ${ source.Position.withCallerPosition[Unit]('{pos}, '{(p: source.Position) => registerBranch(s.trim + " which " + resultOfAfterWordApplication.text.trim, None, "which", p, resultOfAfterWordApplication.f) }) } 
  //DOTTY-ONLY   }
  //DOTTY-ONLY }
