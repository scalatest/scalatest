...
private[tools] case object FilterAlertProvided extends ReporterConfigParam("A")
private[tools] case object FilterNoteProvided extends ReporterConfigParam("B")
...
private[tools] case object PresentJson extends ReporterConfigParam("J")
