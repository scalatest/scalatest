...
class DeprecatedAsyncFeatureSpecLikeSpec2 extends scalatest.funspec.AsyncFunSpec {
  ...
  describe("AsyncFeatureSpecLike") {
    ...
    it("can be used for tests that return Future under parallel async test execution") {
      ...
      class ExampleSpec extends org.scalatest.featurespec.FixtureAsyncFeatureSpecLike with ParallelTestExecution {
    ...
    it("should run tests that return Future in serial by default") {
      ...
      class ExampleSpec extends org.scalatest.featurespec.FixtureAsyncFeatureSpecLike {
    ...
    it("should send an InfoProvided event for an info in main spec body") {
      class MySuite extends org.scalatest.featurespec.FixtureAsyncFeatureSpecLike  {
    ...
    it("should allow other execution context to be used") {
      class TestSpec extends org.scalatest.featurespec.FixtureAsyncFeatureSpecLike {
        // SKIP-SCALATESTJS,NATIVE-START
