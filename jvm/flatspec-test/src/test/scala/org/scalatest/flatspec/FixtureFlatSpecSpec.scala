...
class FixtureFlatSpecSpec extends scalatest.funspec.AnyFunSpec {
...
*/
    ...
    it("should allow test registration with registerTest and registerIgnoredTest") {
      class TestSpec extends flatspec.FixtureAnyFlatSpec {
        ...
        registerTest("test 1") { fixture =>
          ...
          assert(e.failedCodeFileName == Some("FixtureFlatSpecSpec.scala"))
    ...
    ignore("should support expectations") { // Unignore after we uncomment the expectation implicits in RegistrationPolicy
      ...
      assert(rep.testFailedEventsReceived(0).throwable.get.asInstanceOf[TestFailedException].failedCodeFileName.get === "FixtureFlatSpecSpec.scala")
      ...
      assert(rep.testFailedEventsReceived(1).throwable.get.asInstanceOf[TestFailedException].failedCodeFileName.get === "FixtureFlatSpecSpec.scala")
  ...
  describe("when failure happens") {
    ...
    it("should generate TestRegistrationClosedException with correct stack depth info when has an in nested inside an in") {
      ...
      assert("FixtureFlatSpecSpec.scala" === trce.failedCodeFileName.get)
    ...
    it("should generate a DuplicateTestNameException is detected") {
      ...
      assert("FixtureFlatSpecSpec.scala" == e.failedCodeFileName.get)
