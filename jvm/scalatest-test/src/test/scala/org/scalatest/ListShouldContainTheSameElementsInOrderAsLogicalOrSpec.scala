...
class ListShouldContainTheSameElementsInOrderAsLogicalOrSpec extends AnyFreeSpec {
  ...
  "collection of Lists" - {
    ...
    "when used with (be xx and contain theSameElementsInOrderAs xx)" - {
      ...
      "should do nothing if valid, else throw a TFE with an appropriate error message" in {
        all (list1s) should (be (List(1, 2, 3)) or contain theSameElementsInOrderAs ListBuffer(1, 2, 3))
        all (list1s) should (be (List(2, 3, 4)) or contain theSameElementsInOrderAs ListBuffer(1, 2, 3))
        all (list1s) should (be (List(1, 2, 3)) or contain theSameElementsInOrderAs ListBuffer(2, 3, 4))
        
        val e1 = intercept[TestFailedException] {
          all (list1s) should (be (List(2, 3, 4)) or contain theSameElementsInOrderAs ListBuffer(2, 3, 4))
        }
      ...
      "should use the implicit Equality in scope" in {
        ...
        all (hiLists) should (be (List("hi", "hello")) or contain theSameElementsInOrderAs ListBuffer("HI", "HELLO"))
        all (hiLists) should (be (List("ho", "hello")) or contain theSameElementsInOrderAs ListBuffer("HI", "HELLO"))
        all (hiLists) should (be (List("hi", "hello")) or contain theSameElementsInOrderAs ListBuffer("HELLO", "HI"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (be (List("ho", "hello")) or contain theSameElementsInOrderAs ListBuffer("HELLO", "HI"))
        }
    ...
    "when used with (not be xx and not contain theSameElementsInOrderAs xx)" - {
      ...
      "should do nothing if valid, else throw a TFE with an appropriate error message" in {
        all (list1s) should (not be (List(2)) or not contain theSameElementsInOrderAs (ListBuffer(8, 3, 4)))
        all (list1s) should (not be (List(1, 2, 3)) or not contain theSameElementsInOrderAs (ListBuffer(8, 3, 4)))
        all (list1s) should (not be (List(2)) or not contain theSameElementsInOrderAs (ListBuffer(1, 2, 3)))
        
        val e1 = intercept[TestFailedException] {
          all (list1s) should (not be (List(1, 2, 3)) or not contain theSameElementsInOrderAs (ListBuffer(1, 2, 3)))
        }
      ...
      "should use the implicit Equality in scope" in {
        ...
        all (hiLists) should (not be (List("hello", "ho")) or not contain theSameElementsInOrderAs (ListBuffer("HELLO", "HO")))
        all (hiLists) should (not be (List("hi", "hello")) or not contain theSameElementsInOrderAs (ListBuffer("HELLO", "HO")))
        all (hiLists) should (not be (List("hello", "ho")) or not contain theSameElementsInOrderAs (ListBuffer("HI", "HELLO")))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("hi", "hello")) or not contain theSameElementsInOrderAs (ListBuffer("HI", "HELLO")))
        }
