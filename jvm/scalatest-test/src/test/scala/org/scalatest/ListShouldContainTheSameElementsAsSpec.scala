...
class ListShouldContainTheSameElementsAsSpec extends AnyFunSpec {
  ...
  describe("a col of Lists") {
    ...
    describe("when used with contain theSameElementsAs (..)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        e1.message should be (Some("'all' inspection failed, because: \n" +
                                   "  at index 2, " + decorateToStringValue(prettifier, List(4, 3, 2)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(1, 2, 3)) + " (ListShouldContainTheSameElementsAsSpec.scala:" + (thisLineNumber - 5) + ") \n" +
        ...
        e3.message should be (Some("'all' inspection failed, because: \n" +
                                   "  at index 2, " + decorateToStringValue(prettifier, Nil) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(1, 2, 3)) + " (ListShouldContainTheSameElementsAsSpec.scala:" + (thisLineNumber - 5) + ") \n" +
    ...
    describe("when used with not contain theSameElementsAs (..)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        e1.failedCodeLineNumber.get should be (thisLineNumber - 3)
        e1.message should be (Some("'all' inspection failed, because: \n" +
                                   "  at index 0, " + decorateToStringValue(prettifier, List("to", "you")) + " contained the same elements as " + decorateToStringValue(prettifier, Set("you", "to")) +  " (ListShouldContainTheSameElementsAsSpec.scala:" + (thisLineNumber - 5) + ") \n" +
