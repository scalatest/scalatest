  ...
  describe("The be (X +- Y) syntax") {
    ...
    */
    ...
    it("should throw TestFailedException if the number is not within the specified range") {
      ...
      assert(caught1.getMessage === sevenDotOh + " was not 17.1 plus or minus 0.2")

      // Double +- Float
      val caught2 = intercept[TestFailedException] {
        sevenDotOh should be (17.1 +- 0.2f)
      }
      assert(caught2.getMessage === sevenDotOh + " was not 17.1 plus or minus 0.20000000298023224")
      ...
      assert(caught7.getMessage === sevenDotOhFloat + " was not " + 17.1f + " plus or minus " + 0.2f)
    ...
    it("should throw TestFailedException if the number is within the specified range, when used with not") {
      ...
      assert(caught1.getMessage === sevenDotOh + " was 7.1 plus or minus 0.2")

      // Double +- Float
      val caught2 = intercept[TestFailedException] {
        sevenDotOh should not be (7.1 +- 0.2f)
      }
      assert(caught2.getMessage === sevenDotOh + " was 7.1 plus or minus 0.20000000298023224")
      ...
      assert(caught7.getMessage === sevenDotOhFloat + " was " + 7.1f + " plus or minus " + 0.2f)
    ...
    it("should throw TestFailedException if the number is not within the specified range, when used in a logical-and expression") {
      ...
      assert(caught2.getMessage === sevenDotOh + " was 6.9 plus or minus 0.2, but " + 7.0 + " was not 17.1 plus or minus 0.2")
      val caught3 = intercept[TestFailedException] {
        sevenDotOh should (be (17.0 +- 0.2) and be (7.0 +- 0.2))
      }
      assert(caught3.getMessage === sevenDotOh + " was not " + 17.0 + " plus or minus 0.2")

      // Double +- Float
      val caught4 = intercept[TestFailedException] {
        sevenDotOh should ((be (17.1 +- 0.2f)) and (be (17.1 +- 0.2f)))
      }
      assert(caught4.getMessage === sevenDotOh + " was not 17.1 plus or minus 0.20000000298023224")
      val caught5 = intercept[TestFailedException] {
        sevenDotOh should (be (6.9 +- 0.2f) and (be (17.1 +- 0.2f)))
      }
      assert(caught5.getMessage === sevenDotOh + " was 6.9 plus or minus 0.20000000298023224, but " + sevenDotOh + " was not 17.1 plus or minus 0.20000000298023224")
      val caught6 = intercept[TestFailedException] {
        sevenDotOh should (be (17.0 +- 0.2f) and be (7.0 +- 0.2f))
      }
      assert(caught6.getMessage === sevenDotOh + " was not " + 17.0 + " plus or minus 0.20000000298023224")
      ...
      assert(caught2.getMessage === sevenDotOh + " was 6.9 plus or minus 0.2, but " + sevenDotOh + " was not 17.1 plus or minus 0.2")
      val caught12 = intercept[TestFailedException] {
      ...
      assert(caught19.getMessage === sevenDotOhFloat + " was not " + 17.1f + " plus or minus " + 0.2f)
      val caught20 = intercept[TestFailedException] {
        sevenDotOhFloat should (be (6.9f +- 0.2f) and (be (17.1f +- 0.2f)))
      }
      assert(caught20.getMessage === sevenDotOhFloat + " was " + 6.9f + " plus or minus " + 0.2f + ", but " + sevenDotOhFloat + " was not " + 17.1f + " plus or minus " +0.2f)
      val caught21 = intercept[TestFailedException] {
        sevenDotOhFloat should (be (17.0f +- 0.2f) and be (7.0f +- 0.2f))
      }
      assert(caught21.getMessage === sevenDotOhFloat + " was not " + 17.0f + " plus or minus " + 0.2f)
    ...
    it("should throw TestFailedException if the number is not within the specified range, when used in a logical-or expression") {
      ...
      assert(caught1.getMessage === sevenDotOh + " was not 17.1 plus or minus 0.2, and " + 7.0 + " was not 17.1 plus or minus 0.2")
      val caught2 = intercept[TestFailedException] {
        sevenDotOh should (be (16.9 +- 0.2) or (be (17.1 +- 0.2)))
      }
      assert(caught2.getMessage === sevenDotOh + " was not 16.9 plus or minus 0.2, and " + 7.0 + " was not 17.1 plus or minus 0.2")
      val caught3 = intercept[TestFailedException] {
        sevenDotOh should (be (17.0 +- 0.2) or be (97.0 +- 0.2))
      }
      assert(caught3.getMessage === sevenDotOh + " was not " + 17.0 + " plus or minus 0.2, and " + 7.0 + " was not " + 97.0 + " plus or minus 0.2")
    }
    ...
    it("should throw TestFailedException if the number is within the specified range, when used in a logical-and expression with not") {
      ...
      assert(caught1.getMessage === sevenDotOh + " was not 17.1 plus or minus 0.2, but " + 7.0 + " was 7.1 plus or minus 0.2")
      val caught2 = intercept[TestFailedException] {
        sevenDotOh should (not be (16.9 +- 0.2) and (not be (7.1 +- 0.2)))
      }
      assert(caught2.getMessage === sevenDotOh + " was not 16.9 plus or minus 0.2, but " + 7.0 + " was 7.1 plus or minus 0.2")
      val caught3 = intercept[TestFailedException] {
        sevenDotOh should (not be (17.0 +- 0.2) and not be (7.0 +- 0.2))
      }
      assert(caught3.getMessage === sevenDotOh + " was not " + 17.0 + " plus or minus 0.2, but " + 7.0 + " was " + 7.0 + " plus or minus 0.2")

      // Check that the error message "short circuits"
      val caught4 = intercept[TestFailedException] {
        sevenDotOh should (not (be (7.1 +- 0.2)) and not (be (7.1 +- 0.2)))
      }
      assert(caught4.getMessage === sevenDotOh + " was 7.1 plus or minus 0.2")
    }
    ...
    it("should throw TestFailedException if the number is within the specified range, when used in a logical-or expression with not") {
      ...
      assert(caught1.getMessage === sevenDotOh + " was 7.1 plus or minus 0.2, and " + 7.0 + " was 7.1 plus or minus 0.2")
      val caught2 = intercept[TestFailedException] {
        sevenDotOh should ((not be (6.9 +- 0.2)) or (not be (7.1 +- 0.2)))
      }
      assert(caught2.getMessage === sevenDotOh + " was 6.9 plus or minus 0.2, and " + 7.0 + " was 7.1 plus or minus 0.2")
      val caught3 = intercept[TestFailedException] {
        sevenDotOh should (not be (7.0 +- 0.2) or not be (7.0 +- 0.2))
      }
      assert(caught3.getMessage === sevenDotOh + " was " + 7.0 + " plus or minus 0.2, and " + 7.0 + " was " + 7.0 + " plus or minus 0.2")
    }

    it("should throw IllegalArgumentException if the number passed as the range is 0 or negative") {
