...
class ListShouldContainAllOfLogicalOrSpec extends AnyFunSpec {
  ...
  describe("collection of Lists") {
    ...
    describe("when used with (contain allOf (..) and contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " did not contain all of " + "(3, 1, 2)" + ", and " + decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " did not contain all of " + "(1, 3, 2)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (be (..) and contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " was not equal to " + decorateToStringValue(prettifier, List(2, 3, 4)) + ", and " + decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " did not contain all of " + "(2, 3, 4)", thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not contain allOf xx and not contain allOf xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " contained all of " + "(4, 2, 3)" + ", and " + decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " contained all of " + "(2, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not be (...) and not contain allOf (...))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " was equal to " + decorateToStringValue(prettifier, List(3, 2, 1, 0)) + ", and " + decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " contained all of " + "(2, 3, 1)", thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
      }
