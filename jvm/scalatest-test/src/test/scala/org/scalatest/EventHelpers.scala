...
trait EventHelpers extends Assertions {
  ...
  def checkScopeOpened(event: Event, message: String): Unit = {
    event match {
  ...
  def checkScopeClosed(event: Event, message: String): Unit = {
    event match {
  ...
  def checkTestStarting(event: Event, testName: String): Unit = {
    event match {
  ...
  def checkTestSucceeded(event: Event, testName: String): Unit = {
    event match {
  ...
  def checkInfoProvided(event: Event, message: String): Unit = {
    event match {
  ...
  def checkSuiteStarting(event: Event, suiteId: String): Unit = {
    event match {
  ...
  def checkSuiteCompleted(event: Event, suiteId: String): Unit = {
    event match {
