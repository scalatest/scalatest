...
class EveryShouldContainAllOfLogicalAndSpec extends AnyFunSpec {
  ...
  val fileName: String = "EveryShouldContainAllOfLogicalAndSpec.scala"
  ...
  describe("col of Lists") {
    ...
    describe("used with contain allOf xx and contain allOf xx") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, Many(8, 4, 3, 2)) + " did not contain all of " + "(1, 2, 3)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)

        val e2 = intercept[TestFailedException] {
          all (list1s) should (contain allOf (1, 2, 3) and contain allOf (1, 3, 4))
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(prettifier, Many(3, 2, 1, 0)) + " contained all of " + "(1, 2, 3)" + ", but " + decorateToStringValue(prettifier, Many(3, 2, 1, 0)) + " did not contain all of " + "(1, 3, 4)", thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)

        val e4 = intercept[TestFailedException] {
          all (hiLists) should (contain allOf ("hi", "hello") and contain allOf ("ho", "hey", "howdy"))
        }
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " contained all of " + "(\"hi\", \"hello\")" + ", but " + decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " did not contain all of " + "(\"ho\", \"hey\", \"howdy\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (be (..) and contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(prettifier, Many(3, 2, 1, 0)) + " was equal to " + decorateToStringValue(prettifier, Many(3, 2, 1, 0)) + ", but " + decorateToStringValue(prettifier, Many(3, 2, 1, 0)) + " did not contain all of " + "(2, 3, 8)", thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)

        val e3 = intercept[TestFailedException] {
          all (hiLists) should (be (Many("howdy", "hi", "hello")) and contain allOf ("ho", "hey", "howdy"))
        }
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " was equal to " + decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + ", but " + decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " did not contain all of " + "(\"ho\", \"hey\", \"howdy\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)

        val e4 = intercept[TestFailedException] {
          all (list1s) should (be (Many(3, 2, 1, 0)) and contain allOf (2, 3, 8))
        }
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, Many(3, 2, 1, 0)) + " was equal to " + decorateToStringValue(prettifier, Many(3, 2, 1, 0)) + ", but " + decorateToStringValue(prettifier, Many(3, 2, 1, 0)) + " did not contain all of " + "(2, 3, 8)", thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not contain allOf xx and not contain allOf xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, Many(8, 4, 3, 2)) + " contained all of " + "(2, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)

        val e2 = intercept[TestFailedException] {
          all (lists) should (not contain allOf (3, 6, 8) and not contain allOf (2, 3, 4))
        }
        checkMessageStackDepth(e2, allErrMsg(2, decorateToStringValue(prettifier, Many(8, 4, 3, 2)) + " did not contain all of " + "(3, 6, 8)" + ", but " + decorateToStringValue(prettifier, Many(8, 4, 3, 2)) + " contained all of " + "(2, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)

        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not contain allOf ("hello", "hi") and not contain allOf ("ho", "hey", "howdy"))
        }
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " contained all of " + "(\"hello\", \"hi\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)

        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not contain allOf ("ho", "hey", "howdy") and not contain allOf ("hello", "hi"))
        }
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " did not contain all of " + "(\"ho\", \"hey\", \"howdy\")" + ", but " + decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " contained all of " + "(\"hello\", \"hi\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not be (..) and not contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, allErrMsg(2, decorateToStringValue(prettifier, Many(8, 4, 3, 2)) + " was not equal to " + decorateToStringValue(prettifier, One(3)) + ", but " + decorateToStringValue(prettifier, Many(8, 4, 3, 2)) + " contained all of " + "(2, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " was not equal to " + decorateToStringValue(prettifier, One("ho")) + ", but " + decorateToStringValue(prettifier, Many("howdy", "hi", "hello")) + " contained all of " + "(\"hello\", \"hi\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
