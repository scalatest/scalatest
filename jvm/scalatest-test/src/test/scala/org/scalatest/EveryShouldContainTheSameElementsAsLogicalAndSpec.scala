...
class EveryShouldContainTheSameElementsAsLogicalAndSpec extends AnyFunSpec {
  ...
  describe("every of Everys") {
    ...
    describe("used with contain theSameElementsAs xx and contain theSameElementsAs xx") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, Many(4, 3, 2)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(1, 2, 3)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)

        val e2 = intercept[TestFailedException] {
          all (list1s) should (contain theSameElementsAs Set(1, 2, 3) and contain theSameElementsAs Set(1, 3, 4))
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(prettifier, Many(3, 2, 1)) + " contained the same elements as " + decorateToStringValue(prettifier, Set(1, 2, 3)) + ", but " + decorateToStringValue(prettifier, Many(3, 2, 1)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(1, 3, 4)), thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)

        val e3 = intercept[TestFailedException] {
          all (hiLists) should (contain theSameElementsAs Set("hi", "hello") and contain theSameElementsAs Set("ho", "hey", "howdy"))
        }
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, Many("hi", "hello")) + " contained the same elements as " + decorateToStringValue(prettifier, Set("hi", "hello")) + ", but " + decorateToStringValue(prettifier, Many("hi", "hello")) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set("ho", "hey", "howdy")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (be (..) and contain theSameElementsAs (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(prettifier, Many(3, 2, 1)) + " was equal to " + decorateToStringValue(prettifier, Many(3, 2, 1)) + ", but " + decorateToStringValue(prettifier, Many(3, 2, 1)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(2, 3, 8)), thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)

        val e3 = intercept[TestFailedException] {
          all (hiLists) should (be (Many("hi", "hello")) and contain theSameElementsAs Set("ho", "hey", "howdy"))
        }
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, Many("hi", "hello")) + " was equal to " + decorateToStringValue(prettifier, Many("hi", "hello")) + ", but " + decorateToStringValue(prettifier, Many("hi", "hello")) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set("ho", "hey", "howdy")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)

        val e4 = intercept[TestFailedException] {
          all (list1s) should (be (Many(3, 2, 1)) and contain theSameElementsAs Set(2, 3, 8))
        }
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, Many(3, 2, 1)) + " was equal to " + decorateToStringValue(prettifier, Many(3, 2, 1)) + ", but " + decorateToStringValue(prettifier, Many(3, 2, 1)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(2, 3, 8)), thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not contain theSameElementsAs xx and not contain theSameElementsAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, Many(4, 3, 2)) + " contained the same elements as " + decorateToStringValue(prettifier, Set(2, 3, 4)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)

        val e2 = intercept[TestFailedException] {
          all (lists) should (not contain theSameElementsAs (Set(3, 6, 8)) and not contain theSameElementsAs (Set(2, 3, 4)))
        }
        checkMessageStackDepth(e2, allErrMsg(2, decorateToStringValue(prettifier, Many(4, 3, 2)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(3, 6, 8)) + ", but " + decorateToStringValue(prettifier, Many(4, 3, 2)) + " contained the same elements as " + decorateToStringValue(prettifier, Set(2, 3, 4)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)

        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not contain theSameElementsAs (Set("hello", "hi")) and not contain theSameElementsAs (Set("ho", "hey", "howdy")))
        }
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, Many("hi", "hello")) + " contained the same elements as " + decorateToStringValue(prettifier, Set("hello", "hi")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)

        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not contain theSameElementsAs (Set("ho", "hey", "howdy")) and not contain theSameElementsAs (Set("hello", "hi")))
        }
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, Many("hi", "hello")) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set("ho", "hey", "howdy")) + ", but " + decorateToStringValue(prettifier, Many("hi", "hello")) + " contained the same elements as " + decorateToStringValue(prettifier, Set("hello", "hi")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not be (..) and not contain theSameElementsAs (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, allErrMsg(2, decorateToStringValue(prettifier, Many(4, 3, 2)) + " was not equal to " + decorateToStringValue(prettifier, One(3)) + ", but " + decorateToStringValue(prettifier, Many(4, 3, 2)) + " contained the same elements as " + decorateToStringValue(prettifier, Set(2, 3, 4)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, Many("hi", "hello")) + " was not equal to " + decorateToStringValue(prettifier, One("ho")) + ", but " + decorateToStringValue(prettifier, Many("hi", "hello")) + " contained the same elements as " + decorateToStringValue(prettifier, Set("hello", "hi")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
