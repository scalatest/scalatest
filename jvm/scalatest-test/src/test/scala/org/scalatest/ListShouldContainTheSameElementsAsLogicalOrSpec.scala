...
class ListShouldContainTheSameElementsAsLogicalOrSpec extends AnyFunSpec {
  ...
  describe("collection of Lists") {
    ...
    describe("when used with (contain theSameElementsAs (..) and contain theSameElementsAs (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(4, 3, 2)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(3, 1, 2)) + ", and " + decorateToStringValue(prettifier, List(4, 3, 2)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(1, 3, 2)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (be (..) and contain theSameElementsAs (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(prettifier, List(3, 2, 1)) + " was not equal to " + decorateToStringValue(prettifier, List(2, 3, 4)) + ", and " + decorateToStringValue(prettifier, List(3, 2, 1)) + " did not contain the same elements as " + decorateToStringValue(prettifier, Set(2, 3, 4)), thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not contain theSameElementsAs xx and not contain theSameElementsAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(4, 3, 2)) + " contained the same elements as " + decorateToStringValue(prettifier, Set(4, 2, 3)) + ", and " + decorateToStringValue(prettifier, List(4, 3, 2)) + " contained the same elements as " + decorateToStringValue(prettifier, Set(2, 3, 4)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not be (...) and not contain theSameElementsAs (...))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(prettifier, List(3, 2, 1)) + " was equal to " + decorateToStringValue(prettifier, List(3, 2, 1)) + ", and " + decorateToStringValue(prettifier, List(3, 2, 1)) + " contained the same elements as " + decorateToStringValue(prettifier, Set(2, 3, 1)), thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
      }
