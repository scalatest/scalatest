...
class InOrderOnlyContainMatcherSpec extends AnyFunSpec {
...
*/
      ...
      checkStackDepth(e5, left5, deep(Array(1, 2)), thisLineNumber - 2)
    }
...
*/
      ...
      checkStackDepth(e5, left5, deep(Array(3, 2, 1)), thisLineNumber - 2)
    }
  }
