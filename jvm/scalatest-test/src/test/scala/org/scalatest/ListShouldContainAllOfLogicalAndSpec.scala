...
class ListShouldContainAllOfLogicalAndSpec extends AnyFunSpec {
  ...
  describe("a List") {
    ...
    describe("when used with (contain allOf (..) and contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, Resources.didNotContainAllOfElements(decorateToStringValue(prettifier, fumList), "\"happy\", \"birthday\", \"to\", \"you\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (contain allOf ("fee", "fie", "foe", "fum") and contain allOf ("happy", "birthday", "to", "you"))
        }
        checkMessageStackDepth(e2, Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"fee\", \"fie\", \"foe\", \"fum\"") + ", but " + Resources.didNotContainAllOfElements(decorateToStringValue(prettifier, fumList), "\"happy\", \"birthday\", \"to\", \"you\""), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (equal (..) and contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, Resources.equaled(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, fumList)) + ", but " + Resources.didNotContainAllOfElements(decorateToStringValue(prettifier, fumList), "\"happy\", \"birthday\", \"to\", \"you\""), fileName, thisLineNumber - 2)
      }
      ...
      it("should use the implicit Equality in scope") {
        ...
        checkMessageStackDepth(e2, Resources.equaled(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, fumList)) + ", but " + Resources.didNotContainAllOfElements(decorateToStringValue(prettifier, fumList), "\"FEE\", \"FIE\", \"FOE\", \"FAM\""), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (be (..) and contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, Resources.wasEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, fumList)) + ", but " + Resources.didNotContainAllOfElements(decorateToStringValue(prettifier, fumList), "\"happy\", \"birthday\", \"to\", \"you\""), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (contain allOf (..) and be (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"fee\", \"fie\", \"foe\", \"fum\"") + ", but " + Resources.wasNotEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (contain allOf ("happy", "birthday", "to", "you") and be (fumList))
        }
        checkMessageStackDepth(e2, Resources.didNotContainAllOfElements(decorateToStringValue(prettifier, fumList), "\"happy\", \"birthday\", \"to\", \"you\""), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not contain allOf xx and not contain allOf xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"fee\", \"fie\", \"foe\", \"fum\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (not contain allOf ("happy", "birthday", "to", "you") and not contain allOf ("fee", "fie", "foe", "fum"))
        }
        checkMessageStackDepth(e2, Resources.didNotContainAllOfElements(decorateToStringValue(prettifier, fumList), "\"happy\", \"birthday\", \"to\", \"you\"") + ", but " + Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"fee\", \"fie\", \"foe\", \"fum\""), fileName, thisLineNumber - 2)
      }
      ...
      it("should use the implicit Equality in scope") {
        ...
        checkMessageStackDepth(e1, Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"FIE\", \"FEE\", \"FUM\", \"FOE\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (not contain allOf ("FIE", "FEE", "FAM", "FOE") and (not contain allOf ("FIE", "FEE", "FOE", "FUM")))
        }
        checkMessageStackDepth(e2, Resources.didNotContainAllOfElements(decorateToStringValue(prettifier, fumList), "\"FIE\", \"FEE\", \"FAM\", \"FOE\"") + ", but " + Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"FIE\", \"FEE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not equal (..) and not contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, Resources.didNotEqual(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)) + ", but " + Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"fee\", \"fie\", \"foe\", \"fum\""), fileName, thisLineNumber - 2)
      }
      ...
      it("should use the implicit Equality in scope") {
        ...
        checkMessageStackDepth(e2, Resources.didNotEqual(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)) + ", but " + Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"FIE\", \"FEE\", \"FUM\", \"FOE\""), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not be (..) and not contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, Resources.wasNotEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)) + ", but " + Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"fee\", \"fie\", \"foe\", \"fum\""), fileName, thisLineNumber - 2)
      }
      ...
      it("should use the implicit Equality in scope") {
        ...
        checkMessageStackDepth(e2, Resources.wasNotEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)) + ", but " + Resources.containedAllOfElements(decorateToStringValue(prettifier, fumList), "\"FIE\", \"FEE\", \"FUM\", \"FOE\""), fileName, thisLineNumber - 2)
      }
  ...
  describe("col of Lists") {
    ...
    describe("used with contain allOf xx and contain allOf xx") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " did not contain all of " + "(1, 2, 3)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          all (list1s) should (contain allOf (1, 2, 3) and contain allOf (1, 3, 4))
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " contained all of " + "(1, 2, 3)" + ", but " + decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " did not contain all of " + "(1, 3, 4)", thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
        
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (contain allOf ("hi", "hello") and contain allOf ("ho", "hey", "howdy"))
        }
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " contained all of " + "(\"hi\", \"hello\")" + ", but " + decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " did not contain all of " + "(\"ho\", \"hey\", \"howdy\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (be (..) and contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " was not equal to " + decorateToStringValue(prettifier, List(3, 2, 1, 0)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          all (list1s) should (be (List(3, 2, 1, 0)) and contain allOf (2, 3, 8))
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " was equal to " + decorateToStringValue(prettifier, List(3, 2, 1, 0)) + ", but " + decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " did not contain all of " + "(2, 3, 8)", thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " was equal to " + decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + ", but " + decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " did not contain all of " + "(\"ho\", \"hey\", \"howdy\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e6, allErrMsg(0, decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " was equal to " + decorateToStringValue(prettifier, List(3, 2, 1, 0)) + ", but " + decorateToStringValue(prettifier, List(3, 2, 1, 0)) + " did not contain all of " + "(2, 3, 8)", thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not contain allOf xx and not contain allOf xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " contained all of " + "(2, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          all (lists) should (not contain allOf (3, 6, 8) and not contain allOf (2, 3, 4))
        }
        checkMessageStackDepth(e2, allErrMsg(2, decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " did not contain all of " + "(3, 6, 8)" + ", but " + decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " contained all of " + "(2, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        
        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not contain allOf ("hello", "hi") and not contain allOf ("ho", "hey", "howdy"))
        }
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " contained all of " + "(\"hello\", \"hi\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not contain allOf ("ho", "hey", "howdy") and not contain allOf ("hello", "hi"))
        }
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " did not contain all of " + "(\"ho\", \"hey\", \"howdy\")" + ", but " + decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " contained all of " + "(\"hello\", \"hi\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (not be (..) and not contain allOf (..))") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " was equal to " + decorateToStringValue(prettifier, List(8, 4, 3, 2)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          all (lists) should (not be (List(3)) and not contain allOf (2, 3, 4))
        }
        checkMessageStackDepth(e2, allErrMsg(2, decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " was not equal to " + decorateToStringValue(prettifier, List(3)) + ", but " + decorateToStringValue(prettifier, List(8, 4, 3, 2)) + " contained all of " + "(2, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        
        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("howdy", "hi", "hello")) and not contain allOf ("ho", "hey", "howdy"))
        }
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " was equal to " + decorateToStringValue(prettifier, List("howdy", "hi", "hello")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("ho")) and not contain allOf ("hello", "hi"))
        }
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " was not equal to " + decorateToStringValue(prettifier, List("ho")) + ", but " + decorateToStringValue(prettifier, List("howdy", "hi", "hello")) + " contained all of " + "(\"hello\", \"hi\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
