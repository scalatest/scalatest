...
class DirectExpectationsSpec extends AnyFunSpec {
  ...
  describe("The expect(condition, clue) method") {
    ...
    it("should return Yes with correct message when is used to check 3 == 3") {
      val fact = org.scalatest.expectations.Expectations.expect(3 == 3, "dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check 3 == 5") {
      ...
      val f1 = org.scalatest.expectations.Expectations.expect(3 == 5, "dude")
      assert(f1.isNo)
      assert(f1.factMessage === "Expression was false dude")

      val f2 = org.scalatest.expectations.Expectations.expect(3 == 5, "3 did not equal 5")
      assert(f2.isNo)
    ...
    it("should return No with correct message when is used to check a == b") {
      val fact = org.scalatest.expectations.Expectations.expect(a == b, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "3 did not equal 5, dude")
    }
    ...
    it("should return No with correct message when is used to check a == null") {
      val s = "test"
      val fact = org.scalatest.expectations.Expectations.expect(s == null, ". dude")
      assert(fact.isNo)
    ...
    it("should return No with correct message when is used to check a >= 4") {
      val fact = org.scalatest.expectations.Expectations.expect(a >= 4, ", dude")
      assert(fact.isNo)
    ...
    it("should return No with correct message when is used to check 2 >= a") {
      val fact = org.scalatest.expectations.Expectations.expect(2 >= a, ". dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check b < 6") {
      val fact = org.scalatest.expectations.Expectations.expect(b < 6, "; dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check b < 5") {
      val fact = org.scalatest.expectations.Expectations.expect(b < 5, "; dude")
      assert(fact.isNo)
    ...
    it("should return No with correct message when is used to check b <= 4") {
      val fact = org.scalatest.expectations.Expectations.expect(b <= 4, ". dude")
      assert(fact.isNo)
    ...
    it("should return No with correct message when is used to check 6 <= b") {
      val fact = org.scalatest.expectations.Expectations.expect(6 <= b, "; dude")
      assert(fact.isNo)
    ...
    it("should return No with correct message when is used to check java.lang.Integer(5) < java.lang.Integer(4) with import scala.math.Ordering.Implicits.infixOrderingOps in scope") {
      ...
      val fact = org.scalatest.expectations.Expectations.expect(first < second, "; dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check bob == \"bob\"") {
      val fact = org.scalatest.expectations.Expectations.expect(bob == "bob", "dude")
      assert(fact.isYes)
      assert(fact.factMessage == "\"bob\" equaled \"bob\" dude")
    }

    it("should return Yes with correct message when is used to check bob != \"alice\"") {
      val fact = org.scalatest.expectations.Expectations.expect(bob != "alice", "dude")
      assert(fact.isYes)
    ...
    it("should return Yes with correct message when is used to check alice == \"alice\"") {
      val fact = org.scalatest.expectations.Expectations.expect(alice == "alice", "dude")
      assert(fact.isYes)
    ...
    it("should return Yes with correct message when is used to check alice != \"bob\"") {
      val fact = org.scalatest.expectations.Expectations.expect(alice != "bob", "dude")
      assert(fact.isYes)
    ...
    it("should return Yes with correct message when is used to check a == 3 && b == 5") {
      val fact = org.scalatest.expectations.Expectations.expect(a == 3 && b == 5, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check a == 3 && b == 6") {
      val fact = org.scalatest.expectations.Expectations.expect(a == 3 && b == 6, ", dude")
      assert(fact.isNo)
    ...
    it("should return No with correct message when is used to check a == 2 && b == 5") {
      val fact = org.scalatest.expectations.Expectations.expect(a == 2 && b == 5, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "3 did not equal 2, dude")
    }

    it("should return No with correct message when is used to check a == 2 && b == 6") {
      val fact = org.scalatest.expectations.Expectations.expect(a == 2 && b == 6, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "3 did not equal 2, dude")
    }
    ...
    it("should return Yes with correct message when is used to check a == 3 && (b == 5 && b > 3)") {
      val fact = org.scalatest.expectations.Expectations.expect(a == 3 && (b == 5 && b > 3), ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check a == 3 && (b == 5 && b > 5)") {
      val fact = org.scalatest.expectations.Expectations.expect(a == 3 && (b == 5 && b > 5), ", dude")
      assert(fact.isNo)
    ...
    it("should short-circuit && when first condition was false") {
      val s = new Stateful
      val fact = org.scalatest.expectations.Expectations.expect(a == 5 && s.changeState, ", dude")
      assert(fact.isNo)
    ...
    it("should short-circuit || when first condition was true") {
      val s = new Stateful
      val fact = org.scalatest.expectations.Expectations.expect(a == 3 || s.changeState, ", dude")
      assert(fact.isYes)
      assert(s.state == false)
    }
    ...
    it("should return Yes with correct message when it is used to check a == 3 && { println(\"hi\"); b == 5}") {
      val fact = org.scalatest.expectations.Expectations.expect(a == 3 && { println("hi"); b == 5}, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check a == 3 && { println(\"hi\"); b == 3}") {
      val fact = org.scalatest.expectations.Expectations.expect(a == 3 && { println("hi"); b == 3}, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when it is used to check { println(\"hi\"); b == 5} && a == 3 ") {
      val fact = org.scalatest.expectations.Expectations.expect({ println("hi"); b == 5} && a == 3, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is usesd to check { println(\"hi\"); b == 5} && a == 5") {
      val fact = org.scalatest.expectations.Expectations.expect({ println("hi"); b == 5} && a == 5, ", dude")
      assert(fact.isNo)
    ...
    it("should preserve side effects when Apply with single argument is passed in") {
      val fact = org.scalatest.expectations.Expectations.expect(neverRuns1(sys.error("Sad times 1")), "should not fail!")
      assert(fact.isYes)
    }

    it("should preserve side effects when Apply with 2 argument list is passed in") {
      val fact = org.scalatest.expectations.Expectations.expect(neverRuns2(sys.error("Sad times 2"))(0), "should not fail!")
      assert(fact.isYes)
    }

    it("should preserve side effects when typed Apply with 2 argument list is passed in") {
      val fact = org.scalatest.expectations.Expectations.expect(neverRuns3(sys.error("Sad times 3"))(0), "should not fail!")
      assert(fact.isYes)
    }
    ...
    it("should return Yes with correct message when is used to check s1 startsWith \"hi\"") {
      val fact = org.scalatest.expectations.Expectations.expect(s1 startsWith "hi", ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == "\"hi ScalaTest\" started with \"hi\", dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(s1.startsWith("hi"), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check s2 startsWith \"hi\"") {
      val fact = org.scalatest.expectations.Expectations.expect(s2 startsWith "hi", ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "\"ScalaTest hi\" did not start with \"hi\", dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(s2.startsWith("hi"), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes with correct message when is used to check ci1 startsWith 1") {
      val fact = org.scalatest.expectations.Expectations.expect(ci1 startsWith 1, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == "123 started with 1, dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(ci1.startsWith(1), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check ci2 startsWith 1") {
      val fact = org.scalatest.expectations.Expectations.expect(ci2 startsWith 1, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "321 did not start with 1, dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(ci2.startsWith(1), ", dude")
      assert(fact2.isNo)
      assert(fact.factMessage == "321 did not start with 1, dude")
    }
    ...
    it("should return Yes with correct message when is used to check s2 endsWith \"hi\"") {
      val fact = org.scalatest.expectations.Expectations.expect(s2 endsWith "hi", ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == "\"ScalaTest hi\" ended with \"hi\", dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(s2.endsWith("hi"), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check s1 endsWith \"hi\"") {
      val fact = org.scalatest.expectations.Expectations.expect(s1 endsWith "hi", ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "\"hi ScalaTest\" did not end with \"hi\", dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(s1.endsWith("hi"), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes with correct message when is used to check ci2 endsWith 1") {
      val fact = org.scalatest.expectations.Expectations.expect(ci2 endsWith 1, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == "321 ended with 1, dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(ci2.endsWith(1), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check ci1 endsWith 1") {
      val fact = org.scalatest.expectations.Expectations.expect(ci1 endsWith 1, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "123 did not end with 1, dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(ci1.endsWith(1), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes with correct message when is used to check s3 contains \"hi\"") {
      val fact = org.scalatest.expectations.Expectations.expect(s3 contains "hi", ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == "\"Say hi to ScalaTest\" contained \"hi\", dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(s3.contains("hi"), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check s3 contains \"hello\"") {
      val fact = org.scalatest.expectations.Expectations.expect(s3 contains "hello", ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "\"Say hi to ScalaTest\" did not contain \"hello\", dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(s3.contains("hello"), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes with correct message when is used to check ci2 contains 2") {
      val fact = org.scalatest.expectations.Expectations.expect(ci2 contains 2, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == "321 contained 2, dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(ci2.contains(2), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check ci1 contains 5") {
      val fact = org.scalatest.expectations.Expectations.expect(ci1 contains 5, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "123 did not contain 5, dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(ci1.contains(5), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes when is used to check l1 contains 2") {
      val fact = org.scalatest.expectations.Expectations.expect(l1 contains 2, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == "List(1, 2, 3) contained 2, dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(l1.contains(2), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check l1 contains 5") {
      val fact = org.scalatest.expectations.Expectations.expect(l1 contains 5, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == "List(1, 2, 3) did not contain 5, dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(l1.contains(5), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes with correct message when is used to check m1 contains 2") {
      val fact = org.scalatest.expectations.Expectations.expect(m1 contains 2, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == Prettifier.default(m1) + " contained key 2, dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(m1.contains(2), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check m1 contains 5") {
      val fact = org.scalatest.expectations.Expectations.expect(m1 contains 5, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == Prettifier.default(m1) + " did not contain key 5, dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(m1.contains(5), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes when is used to check ct1 contains 8") {
      val fact = org.scalatest.expectations.Expectations.expect(ct1 contains 8, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == Prettifier.default(ct1) + " contained 8, dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(ct1.contains(8), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message when is used to check ct1 contains 5") {
      val fact = org.scalatest.expectations.Expectations.expect(ct1 contains 5, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == Prettifier.default(ct1) + " did not contain 5, dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(ct1.contains(5), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes with correct message when is used to check ci1 eq ci3") {
      val fact = org.scalatest.expectations.Expectations.expect(ci1 eq ci3, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == Prettifier.default(ci1) + " was the same instance as " + Prettifier.default(ci3) + ", dude")
      
      val fact2 = org.scalatest.expectations.Expectations.expect(ci1.eq(ci3), ", dude")
      assert(fact2.isYes)
    ...
    it("should return No with correct message and stack depth when is used to check ci1 eq ci2") {
      val fact = org.scalatest.expectations.Expectations.expect(ci1 eq ci2, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == Prettifier.default(ci1) + " was not the same instance as " + Prettifier.default(ci2) + ", dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(ci1.eq(ci2), ", dude")
      assert(fact2.isNo)
    ...
    it("should return Yes with correct message when is used to check ci1 ne ci2") {
      val fact = org.scalatest.expectations.Expectations.expect(ci1 ne ci2, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == Prettifier.default(ci1) + " was not the same instance as " + Prettifier.default(ci2) + ", dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(ci1.ne(ci2), ", dude")
      assert(fact2.isYes)
      assert(fact2.factMessage == Prettifier.default(ci1) + " was not the same instance as " + Prettifier.default(ci2) + ", dude")
    }

    it("should return No with correct message when is used to check ci1 ne ci3") {
      val fact = org.scalatest.expectations.Expectations.expect(ci1 ne ci3, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == Prettifier.default(ci1) + " was the same instance as " + Prettifier.default(ci3) + ", dude")

      val fact2 = org.scalatest.expectations.Expectations.expect(ci1.ne(ci3), ", dude")
      assert(fact2.isNo)
      assert(fact2.factMessage == Prettifier.default(ci1) + " was the same instance as " + Prettifier.default(ci3) + ", dude")
    }
    ...
    it("should return Yes with correct message when is used to check s4.isEmpty") {
      val fact = org.scalatest.expectations.Expectations.expect(s4.isEmpty, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message and stack depth when is used to check s3.isEmpty") {
      val fact = org.scalatest.expectations.Expectations.expect(s3.isEmpty, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check l2.isEmpty") {
      val fact = org.scalatest.expectations.Expectations.expect(l2.isEmpty, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check l1.isEmpty") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.isEmpty, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes when is used to check s3.nonEmpty") {
      val fact = org.scalatest.expectations.Expectations.expect(s3.nonEmpty, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == Prettifier.default(s3) + " was not empty, dude")
    }

    it("should return No with correct message when is used to check s4.nonEmpty") {
      val fact = org.scalatest.expectations.Expectations.expect(s4.nonEmpty, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == Prettifier.default(s4) + " was empty, dude")
    }
    ...
    it("should return Yes with correct message when is used to check l1.nonEmpty") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.nonEmpty, ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == Prettifier.default(l1) + " was not empty, dude")
    }

    it("should return No with correct message when is used to check l2.nonEmpty") {
      val fact = org.scalatest.expectations.Expectations.expect(l2.nonEmpty, ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == Prettifier.default(l2) + " was empty, dude")
    }
    ...
    it("should return Yes with correct message when is used to check s1.isInstanceOf[String]") {
      val fact = org.scalatest.expectations.Expectations.expect(s1.isInstanceOf[String], ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check l1.isInstanceOf[String]") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.isInstanceOf[String], ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check l1.isInstanceOf[List[Int]]") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.isInstanceOf[List[Int]], ", dude")
      assert(fact.isYes)
      if (ScalaTestVersions.BuiltForScalaVersion.startsWith("3."))
    ...
    it("should return No with correct message when is used to check s1.isInstanceOf[List[Int]]") {
      val fact = org.scalatest.expectations.Expectations.expect(s1.isInstanceOf[List[Int]], ", dude")
      assert(fact.isNo)
      if (ScalaTestVersions.BuiltForScalaVersion.startsWith("3."))
    ...
    it("should return Yes with correct message when is used to check date.isInstanceOf[Date]") {
      val fact = org.scalatest.expectations.Expectations.expect(date.isInstanceOf[Date], ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check l1.isInstanceOf[Date]") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.isInstanceOf[Date], ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check s1.length == 9") {
      val fact = org.scalatest.expectations.Expectations.expect(s1.length == 12, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check s1.length == 10") {
      val fact = org.scalatest.expectations.Expectations.expect(s1.length == 10, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check l1.length == 3") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.length == 3, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check l1.length == 10") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.length == 10, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check !(l1.length == 2)") {
      val fact = org.scalatest.expectations.Expectations.expect(!(l1.length == 2), ", dude")
      assert(fact.isYes)
    ...
    it("should return Yes with correct message when is used to check floatLengthSize.length == 2.0f") {
      val fact = org.scalatest.expectations.Expectations.expect(floatLengthSize.length == 2.0f, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check floatLengthSize.length == 1.0f") {
      val fact = org.scalatest.expectations.Expectations.expect(floatLengthSize.length == 1.0f, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check s1.size == 9") {
      val fact = org.scalatest.expectations.Expectations.expect(s1.size == 12, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check s1.size == 10") {
      val fact = org.scalatest.expectations.Expectations.expect(s1.size == 10, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check l1.size == 3") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.size == 3, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check l1.size == 10") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.size == 10, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check !(l1.size == 2)") {
      val fact = org.scalatest.expectations.Expectations.expect(!(l1.size == 2), ", dude")
      assert(fact.isYes)
    ...
    it("should return Yes with correct message when is used to check floatLengthSize.size == 2.0f") {
      val fact = org.scalatest.expectations.Expectations.expect(floatLengthSize.size == 2.0f, ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check floatLengthSize.size == 1.0f") {
      val fact = org.scalatest.expectations.Expectations.expect(floatLengthSize.size == 1.0f, ", dude")
      assert(fact.isNo)
    ...
    it("should return Yes with correct message when is used to check l1.exists(_ == 3)") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.exists(_ == 3), ", dude")
      assert(fact.isYes)
    ...
    it("should return Yes with correct message when is used to check l1.exists(3 == _)") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.exists(3 == _), ", dude")
      assert(fact.isYes)
      assert(fact.factMessage == Prettifier.default(l1) + " contained 3, dude")
    }

    it("should return No with correct message when is used to check l1.exists(_ == 5)") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.exists(_ == 5), ", dude")
      assert(fact.isNo)
    ...
    it("should return No with correct message when is used to check l1.exists(5 == _)") {
      val fact = org.scalatest.expectations.Expectations.expect(l1.exists(5 == _), ", dude")
      assert(fact.isNo)
      assert(fact.factMessage == Prettifier.default(l1) + " did not contain 5, dude")
    }
    ...
    it("should return No with correct message when is used to check l3.exists(_.isEmpty)") {
      val fact = org.scalatest.expectations.Expectations.expect(l3.exists(_.isEmpty), ", dude")
      assert(fact.isNo)
      assert(fact.factMessage endsWith " was false, dude")
    }

    it("should return No with correct message when is used to check l3.exists(false)") {
      val fact = org.scalatest.expectations.Expectations.expect(ci1.exists(321), ", dude")
      assert(fact.isNo)
      assert(fact.factMessage endsWith " was false, dude")
    }
    ...
    it("should return Yes when used to check woof { meow(y = 5) } == \"woof\"") {
      val fact = org.scalatest.expectations.Expectations.expect(woof { meow(y = 5) } == "woof", ", dude")
      assert(fact.isYes)
    ...
    it("should return No with correct message when is used to check woof { meow(y = 5) } == \"meow\"") {
      val fact = org.scalatest.expectations.Expectations.expect(woof { meow(y = 5) } == "meow", ", dude")
      assert(fact.isNo)
