...
Before publishing any patch release, binary compatibility with previous version should be checked:
    ...
    $ sbt ++2.12.21 scalactic/package scalactic/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestCore/package scalatestCore/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFeatureSpec/package scalatestFeatureSpec/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFlatSpec/package scalatestFlatSpec/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFreeSpec/package scalatestFreeSpec/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFunSuite/package scalatestFunSuite/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFunSpec/package scalatestFunSpec/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestPropSpec/package scalatestPropSpec/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestRefSpec/package scalatestRefSpec/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestWordSpec/package scalatestWordSpec/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestDiagrams/package scalatestDiagrams/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestMatchersCore/package scalatestMatchersCore/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestShouldMatchers/package scalatestShouldMatchers/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestMustMatchers/package scalatestMustMatchers/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalacticJS/package scalacticJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestCoreJS/package scalatestCoreJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFeatureSpecJS/package scalatestFeatureSpecJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFlatSpecJS/package scalatestFlatSpecJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFreeSpecJS/package scalatestFreeSpecJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFunSuiteJS/package scalatestFunSuiteJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestFunSpecJS/package scalatestFunSpecJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestPropSpecJS/package scalatestPropSpecJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestWordSpecJS/package scalatestWordSpecJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestDiagramsJS/package scalatestDiagramsJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestMatchersCoreJS/package scalatestMatchersCoreJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestShouldMatchersJS/package scalatestShouldMatchersJS/mimaReportBinaryIssues
    $ sbt ++2.12.21 scalatestMustMatchersJS/package scalatestMustMatchersJS/mimaReportBinaryIssues

    $ sbt ++2.13.18 scalactic/package scalactic/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestCore/package scalatestCore/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFeatureSpec/package scalatestFeatureSpec/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFlatSpec/package scalatestFlatSpec/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFreeSpec/package scalatestFreeSpec/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFunSuite/package scalatestFunSuite/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFunSpec/package scalatestFunSpec/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestPropSpec/package scalatestPropSpec/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestRefSpec/package scalatestRefSpec/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestWordSpec/package scalatestWordSpec/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestDiagrams/package scalatestDiagrams/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestMatchersCore/package scalatestMatchersCore/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestShouldMatchers/package scalatestShouldMatchers/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestMustMatchers/package scalatestMustMatchers/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalacticJS/package scalacticJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestCoreJS/package scalatestCoreJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFeatureSpecJS/package scalatestFeatureSpecJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFlatSpecJS/package scalatestFlatSpecJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFreeSpecJS/package scalatestFreeSpecJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFunSuiteJS/package scalatestFunSuiteJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestFunSpecJS/package scalatestFunSpecJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestPropSpecJS/package scalatestPropSpecJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestWordSpecJS/package scalatestWordSpecJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestDiagramsJS/package scalatestDiagramsJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestMatchersCoreJS/package scalatestMatchersCoreJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestShouldMatchersJS/package scalatestShouldMatchersJS/mimaReportBinaryIssues
    $ sbt ++2.13.18 scalatestMustMatchersJS/package scalatestMustMatchersJS/mimaReportBinaryIssues
