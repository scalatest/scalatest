...
trait TreeEquaSetView[+T] extends SortedEquaSetView[T] {
  ...
  def force[U >: T](toPath: SortedEquaPath[U]): toPath.TreeEquaSet
...
object TreeEquaSetView {
  private class BasicTreeEquaSetView[T](private val args: List[T]) extends TreeEquaSetView[T] { thisTreeEquaSetView =>
    ...
    def toSortedEquaSet[U >: T](toPath: SortedEquaPath[U]): toPath.SortedEquaSet = force(toPath)
    def force[U >: T](toPath: SortedEquaPath[U]): toPath.TreeEquaSet = toPath.TreeEquaSet(args: _*)
  ...
  private abstract class TransformTreeEquaSetView[T, U] extends TreeEquaSetView[U] { thisTreeEquaSetView =>
    ...
    def force[V >: U](toPath: SortedEquaPath[V]): toPath.TreeEquaSet = {
      toPath.TreeEquaSet(toList: _*)
    }
    def toSortedEquaSet[V >: U](toPath: SortedEquaPath[V]): toPath.SortedEquaSet = force(toPath)
    def toList: List[U]
