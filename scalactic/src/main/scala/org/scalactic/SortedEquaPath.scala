...
class SortedEquaPath[E](override val equality: OrderingEquality[E]) extends EquaPath[E](equality) { thisEquaPath =>

  def ordering[T <: E]: Ordering[thisEquaPath.EquaBox[T]] =
    new Ordering[thisEquaPath.EquaBox[T]] {
      def compare(a: thisEquaPath.EquaBox[T], b: thisEquaPath.EquaBox[T]): Int =
  ...
  class SortedImmutable extends Immutable {
    ...
    trait SortedEquaSet[T <: E] extends EquaSet[T] {
       ...
       * contains `elem`.
       */
      def + (elem: T): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def + (elem1: T, elem2: T, elems: T*): thisEquaPath.immutable.SortedEquaSet[T]
      ...
      /** Creates a new `SortedEquaSet` by adding all elements contained in another collection to this `SortedEquaSet`.
        ...
        *  @return          a new `SortedEquaSet` with the given elements added.
        */
      def ++ (elems: GenTraversableOnce[T]): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       * @return         a new `SortedEquaSet` with the given elements added.
       */
      def ++ (that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       * The order of the elements is preserved.
       */
      def collect(pf: PartialFunction[T, T]): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       * `SortedEquaSet` that are not also contained in the given `EquaSet` `that`.
       */
      def diff(that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def drop(n: Int): thisEquaPath.immutable.SortedEquaSet[T]
      ...
      /** Selects all elements except last ''n'' ones.
        ...
        */
      def dropRight(n: Int): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def dropWhile(pred: T => Boolean): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def filter(pred: T => Boolean): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       * predicate <code>pred</code>.
       */
      def filterNot(pred: T => Boolean): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       *
       */
      def groupBy[K](f: T => K): GenMap[K, thisEquaPath.immutable.SortedEquaSet[T]]
       ...
       */
      def grouped(size: Int): Iterator[thisEquaPath.immutable.SortedEquaSet[T]]
       ...
       */
      def init: thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def inits: Iterator[thisEquaPath.immutable.SortedEquaSet[T]]
       ...
       * `SortedEquaSet` and in the given `EquaSet` `that`.
       */
      def intersect(that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def partition(pred: T => Boolean): (thisEquaPath.immutable.SortedEquaSet[T], thisEquaPath.immutable.SortedEquaSet[T])
       ...
       */
      def scanLeft(z: T)(op: (T, T) => T): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       * @return `SortedEquaSet` with intermediate results
       */
      def scanRight(z: T)(op: (T, T) => T): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       * of this `EquaSet`.
       */
      def slice(unc_from: Int, unc_until: Int): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def sliding(size: Int): Iterator[thisEquaPath.immutable.SortedEquaSet[T]]
       ...
       * fewer elements than size.
       */
      def sliding(size: Int, step: Int): Iterator[thisEquaPath.immutable.SortedEquaSet[T]]
       ...
       */
      def span(pred: T => Boolean): (thisEquaPath.immutable.SortedEquaSet[T], thisEquaPath.immutable.SortedEquaSet[T])
       ...
       */
      def splitAt(n: Int): (thisEquaPath.immutable.SortedEquaSet[T], thisEquaPath.immutable.SortedEquaSet[T])
       ...
       * @return the iterator.
       */
      def subsets(len: Int): Iterator[thisEquaPath.immutable.SortedEquaSet[T]]
       ...
       * @return the iterator.
       */
      def subsets: Iterator[thisEquaPath.immutable.SortedEquaSet[T]]
       ...
       * @throws `UnsupportedOperationException` if the `SortedEquaSet` is empty.
       */
      def tail: thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def tails: Iterator[thisEquaPath.immutable.SortedEquaSet[T]]
       ...
       */
      def take(n: Int): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def takeRight(n: Int): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def toEquaBoxSet: SortedSet[thisEquaPath.EquaBox[T]]
       ...
       */
      def transpose[B](implicit asTraversable: T => GenTraversableOnce[B]): thisEquaPath.immutable.SortedEquaSet[T]
       ...
       */
      def union(that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.SortedEquaSet[T]
  ...
  */
    ...
    class TreeEquaSet[T <: E] private[scalactic] (private val underlying: TreeSet[EquaBox[T]]) extends SortedEquaSet[T] { thisTreeEquaSet =>
      ...
      def + (elem: T): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying + EquaBox[T](elem))
      def + (elem1: T, elem2: T, elems: T*): thisEquaPath.immutable.TreeEquaSet[T] =
        new immutable.TreeEquaSet[T](underlying + (EquaBox[T](elem1), EquaBox[T](elem2), elems.map(EquaBox[T](_)): _*))
      def ++ (elems: GenTraversableOnce[T]): thisEquaPath.immutable.TreeEquaSet[T] =
        new immutable.TreeEquaSet[T](underlying ++ elems.toSeq.map(EquaBox[T](_)))
      def ++ (that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying ++ that.toEquaBoxSet)
      def - (elem: T): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying - EquaBox[T](elem))
      def - (elem1: T, elem2: T, elems: T*): thisEquaPath.immutable.TreeEquaSet[T] =
        new immutable.TreeEquaSet[T](underlying - (EquaBox[T](elem1), EquaBox[T](elem2), elems.map(EquaBox[T](_)): _*))
      def --(elems: GenTraversableOnce[T]): thisEquaPath.immutable.TreeEquaSet[T] =
        new immutable.TreeEquaSet[T](underlying -- elems.toSeq.map(EquaBox[T](_)))
      def --(that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.TreeEquaSet[T] =
      ...
      def | (that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.TreeEquaSet[T] = this union that
      def & (that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.TreeEquaSet[T] = this intersect that
      def &~ (that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.TreeEquaSet[T] = this diff that
      ...
      def canEqual(that: Any): Boolean =
        ...
        // that.isInstanceOf[thisEquaPath.immutable.EquaSet] && equality == that.asInstanceOf[thisEquaPath.immutable.EquaSet].path.equality
      def collect(pf: PartialFunction[T, T]): thisEquaPath.immutable.TreeEquaSet[T] = {
        implicit val ord: Ordering[thisEquaPath.EquaBox[T]] = ordering
        new immutable.TreeEquaSet[T](underlying collect { case hb: thisEquaPath.EquaBox[T] if pf.isDefinedAt(hb.value) => EquaBox[T](pf(hb.value)) })
      }
      ...
      def diff(that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.TreeEquaSet[T] =
        new immutable.TreeEquaSet[T](underlying diff that.toEquaBoxSet)
      def drop(n: Int): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.drop(n))
      def dropRight(n: Int): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.dropRight(n))
      def dropWhile(pred: T => Boolean): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.dropWhile((p: EquaBox[T]) => pred(p.value)))
  ...
  /*
        other match {
          case equaSet: thisEquaPath.immutable.EquaSet => 
            underlying == equaSet.toSet
          case _ => false
        }
  */
      def exists(pred: T => Boolean): Boolean = underlying.exists((box: EquaBox[T]) => pred(box.value))
      def filter(pred: T => Boolean): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.filter((box: EquaBox[T]) => pred(box.value)))
      def filterNot(pred: T => Boolean): thisEquaPath.immutable.SortedEquaSet[T] = new immutable.TreeEquaSet[T](underlying.filterNot((box: EquaBox[T]) => pred(box.value)))
      ...
      def groupBy[K](f: T => K): GenMap[K, thisEquaPath.immutable.TreeEquaSet[T]] = underlying.groupBy((box: EquaBox[T]) => f(box.value)).map(t => (t._1, new immutable.TreeEquaSet[T](t._2)))
      def grouped(size: Int): Iterator[thisEquaPath.immutable.TreeEquaSet[T]] = underlying.grouped(size).map(new immutable.TreeEquaSet[T](_))
      ...
      def init: thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.init)
      def inits: Iterator[thisEquaPath.immutable.TreeEquaSet[T]] = underlying.inits.map(new immutable.TreeEquaSet[T](_))
      def intersect(that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.TreeEquaSet[T] =
      ...
      def partition(pred: T => Boolean): (thisEquaPath.immutable.TreeEquaSet[T], thisEquaPath.immutable.TreeEquaSet[T]) = {
      ...
      def scanLeft(z: T)(op: (T, T) => T): thisEquaPath.immutable.TreeEquaSet[T] = {
      ...
      def scanRight(z: T)(op: (T, T) => T): thisEquaPath.immutable.TreeEquaSet[T] = {
        val set = underlying.scanRight(EquaBox[T](z))((b1: EquaBox[T], b2: EquaBox[T]) => EquaBox[T](op(b1.value, b2.value)))
        new immutable.TreeEquaSet[T](TreeSet(set.toList: _*)(ordering))
      }
      def size: Int = underlying.size
      def slice(unc_from: Int, unc_until: Int): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.slice(unc_from, unc_until))
      def sliding(size: Int): Iterator[thisEquaPath.immutable.TreeEquaSet[T]] = underlying.sliding(size).map(new immutable.TreeEquaSet[T](_))
      def sliding(size: Int, step: Int): Iterator[thisEquaPath.immutable.TreeEquaSet[T]] = underlying.sliding(size, step).map(new immutable.TreeEquaSet[T](_))
      def span(pred: T => Boolean): (thisEquaPath.immutable.TreeEquaSet[T], thisEquaPath.immutable.TreeEquaSet[T]) = {
      ...
      def splitAt(n: Int): (thisEquaPath.immutable.TreeEquaSet[T], thisEquaPath.immutable.TreeEquaSet[T]) = {
      ...
      def subsets(len: Int): Iterator[thisEquaPath.immutable.TreeEquaSet[T]] = underlying.subsets(len).map(new immutable.TreeEquaSet[T](_))
      def subsets: Iterator[thisEquaPath.immutable.TreeEquaSet[T]] = underlying.subsets.map(new immutable.TreeEquaSet[T](_))
      def sum[T1 >: T](implicit num: Numeric[T1]): T1 = underlying.map(_.value).sum(num)
      def tail: thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.tail)
      def tails: Iterator[thisEquaPath.immutable.TreeEquaSet[T]] = underlying.tails.map(new immutable.TreeEquaSet[T](_))
      def take(n: Int): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.take(n))
      def takeRight(n: Int): thisEquaPath.immutable.TreeEquaSet[T] = new immutable.TreeEquaSet[T](underlying.takeRight(n))
      ...
      def toEquaBoxSet: TreeSet[thisEquaPath.EquaBox[T]] = underlying
      ...
      def transpose[B](implicit asTraversable: T => GenTraversableOnce[B]): thisEquaPath.immutable.TreeEquaSet[T] = {
      ...
      def union(that: thisEquaPath.immutable.EquaSet[T]): thisEquaPath.immutable.TreeEquaSet[T] =
        new immutable.TreeEquaSet[T](underlying union that.toEquaBoxSet)
      def unzip[T1, T2](t1EquaPath: EquaPath[T1], t2EquaPath: EquaPath[T2])(implicit asPair: T => (T1, T2)): (t1EquaPath.immutable.EquaSet[T1], t2EquaPath.immutable.EquaSet[T2]) = {
        val (t1, t2) =  underlying.toList.map(_.value).unzip(asPair)
        (t1EquaPath.immutable.EquaSet[T1](t1: _*), t2EquaPath.immutable.EquaSet[T2](t2: _*))
      }
      def unzip3[T1, T2, T3](t1EquaPath: EquaPath[T1], t2EquaPath: EquaPath[T2], t3EquaPath: EquaPath[T3])(implicit asTriple: T => (T1, T2, T3)): (t1EquaPath.immutable.EquaSet[T1], t2EquaPath.immutable.EquaSet[T2], t3EquaPath.immutable.EquaSet[T3]) = {
        val (t1, t2, t3) =  underlying.toList.map(_.value).unzip3(asTriple)
        (t1EquaPath.immutable.EquaSet[T1](t1: _*), t2EquaPath.immutable.EquaSet[T2](t2: _*), t3EquaPath.immutable.EquaSet[T3](t3: _*))
      }
  ...
  */
  ...
  /*
    trait SortedEquaMap[V] extends EquaMap[V] {
       ...
       */
      def +[V1 >: V](entry1: (T, V1), entry2: (T, V1), entries: (T, V1)*): thisEquaPath.immutable.SortedEquaMap[V1]
      ...
      /** Creates a new `SortedEquaMap` by adding all entries contained in another collection to this `SortedEquaMap`.
        ...
        *  @return          a new `SortedEquaMap` with the given entries added.
        */
      def ++[V1 >: V](entries: GenTraversableOnce[(T, V1)]): thisEquaPath.immutable.SortedEquaMap[V1]
       ...
       * @return         a new `SortedEquaMap` with the given entries added.
       */
      def ++[V1 >: V](that: EquaMap[V1]): thisEquaPath.immutable.SortedEquaMap[V1]
       ...
       */
      def -(key: T): thisEquaPath.immutable.SortedEquaMap[V]
       ...
       */
      def -(key1: T, key2: T, keys: T*): thisEquaPath.immutable.SortedEquaMap[V]
       ...
       */
      def --(keys: GenTraversableOnce[T]): thisEquaPath.immutable.SortedEquaMap[V]
       ...
       */
      def --(equaSet: thisEquaPath.immutable.EquaSet): thisEquaPath.immutable.SortedEquaMap[V]
    ...
    class TreeEquaMap[V] private[scalactic] (private val underlying: TreeMap[EquaBox, V]) extends SortedEquaMap[V] { thisTreeEquaSet =>
      ...
      def --(equaSet: thisEquaPath.immutable.EquaSet): TreeEquaMap[V] =
