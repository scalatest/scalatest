...
private[scalactic] class SimpleBool(expression: Boolean, p: Prettifier) extends Bool {

  val prettifier: Prettifier = p
 ...
 */
private[scalactic] class AndBool(bool1: Bool, bool2: Bool, p: Prettifier) extends Bool {
 ...
 * @param bool2 the second <code>Bool</code>
 */
private[scalactic] class OrBool(bool1: Bool, bool2: Bool, p: Prettifier) extends Bool {
...
private[scalactic] class NotBool(bool: Bool, p: Prettifier) extends Bool {
 ...
 * @param expressionText the original expression text (source code)
 */
private[scalactic] class SimpleMacroBool(expression: Boolean, val expressionText: String, p: Prettifier) extends Bool {
 ...
 * @param expression the <code>Boolean</code> expression
 */
private[scalactic] class BinaryMacroBool(left: Any, operator: String, right: Any, expression: Boolean, p: Prettifier) extends Bool {
   ...
   * @param bool the <code>Bool</code> that will provide the <code>Boolean</code> expression value with <code>bool.value</code>
   */
  def this(left: Any, operator: String, right: Any, bool: Bool, p: Prettifier) =
    this(left, operator, right, bool.value, p)
 ...
 * @param expression the <code>Boolean</code> expression
 */
private[scalactic] class UnaryMacroBool(left: Any, operator: String, expression: Boolean, p: Prettifier) extends Bool {
 ...
 * @param expression the <code>Boolean</code> expression
 */
private[scalactic] class IsInstanceOfMacroBool(left: Any, operator: String, className: String, expression: Boolean, p: Prettifier) extends Bool {
 ...
 */
private[scalactic] class LengthSizeMacroBool(left: Any, operator: String, actual: Any, expected: Any, p: Prettifier) extends Bool {
 ...
 * @param expression the <code>Boolean</code> expression
 */
private[scalactic] class ExistsMacroBool(left: Any, right: Any, expression: Boolean, p: Prettifier) extends Bool {
