...
object FastEquaSetView {
  private class BasicFastEquaSetView[T](private val args: List[T]) extends FastEquaSetView[T] { thisFastEquaSetView =>
    ...
    def force[U >: T](toPath: Collections[U]): toPath.immutable.FastEquaSet[U] = toPath.immutable.FastEquaSet[U](args: _*)
    def toSortedEquaSet[U >: T](toPath: SortedCollections[U]): toPath.immutable.SortedEquaSet[U] = ???
...
*/
  ...
  private abstract class TransformFastEquaSetView[T, U] extends FastEquaSetView[U] { thisFastEquaSetView =>
    ...
    def toSortedEquaSet[V >: U](toPath: SortedCollections[V]): toPath.immutable.SortedEquaSet[V] = ???
