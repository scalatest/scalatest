...
object GenRegularTests2 {
  ...
  def genTest(targetBaseDir: File, version: String, scalaVersion: String) {
    ...
    processJavaDir(new File("src/test/java"), new File(javaDir, "genregular2"))

    def isNotShouldFile(file: File): Boolean =
