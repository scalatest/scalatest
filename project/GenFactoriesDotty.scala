...
import org.scalatest.matchersdsl.MatcherWords
...
import org.scalatest.matchersdsl.IncludeWord
import org.scalatest.matchersdsl.HaveWord
import org.scalatest.matchersdsl.BeWord
import org.scalatest.matchersdsl.NotWord
import org.scalatest.matchersdsl.ContainWord
import org.scalatest.matchersdsl.ResultOfLengthWordApplication
import org.scalatest.matchersdsl.ResultOfSizeWordApplication
import org.scalatest.matchersdsl.ResultOfMessageWordApplication
import org.scalatest.matchersdsl.ResultOfLessThanComparison
import org.scalatest.matchersdsl.ResultOfGreaterThanComparison
import org.scalatest.matchersdsl.ResultOfLessThanOrEqualToComparison
import org.scalatest.matchersdsl.ResultOfGreaterThanOrEqualToComparison
import org.scalatest.matchersdsl.ResultOfAWordToSymbolApplication
import org.scalatest.matchersdsl.ResultOfAWordToBePropertyMatcherApplication
import org.scalatest.matchersdsl.ResultOfAWordToAMatcherApplication
import org.scalatest.matchersdsl.ResultOfAnWordToSymbolApplication
import org.scalatest.matchersdsl.ResultOfAnWordToBePropertyMatcherApplication
import org.scalatest.matchersdsl.ResultOfAnWordToAnMatcherApplication
import org.scalatest.matchersdsl.ResultOfTheSameInstanceAsApplication
import org.scalatest.matchersdsl.ResultOfRegexWordApplication
import org.scalatest.matchersdsl.ResultOfKeyWordApplication
import org.scalatest.matchersdsl.ResultOfValueWordApplication
import org.scalatest.matchersdsl.RegexWithGroups
import org.scalatest.matchersdsl.ResultOfDefinedAt
import org.scalatest.matchersdsl.ResultOfOneOfApplication
import org.scalatest.matchersdsl.ResultOfOneElementOfApplication
import org.scalatest.matchersdsl.ResultOfAtLeastOneOfApplication
import org.scalatest.matchersdsl.ResultOfAtLeastOneElementOfApplication
import org.scalatest.matchersdsl.ResultOfNoneOfApplication
import org.scalatest.matchersdsl.ResultOfNoElementsOfApplication
import org.scalatest.matchersdsl.ResultOfTheSameElementsAsApplication
import org.scalatest.matchersdsl.ResultOfTheSameElementsInOrderAsApplication
import org.scalatest.matchersdsl.ResultOfOnlyApplication
import org.scalatest.matchersdsl.ResultOfAllOfApplication
import org.scalatest.matchersdsl.ResultOfAllElementsOfApplication
import org.scalatest.matchersdsl.ResultOfInOrderOnlyApplication
import org.scalatest.matchersdsl.ResultOfInOrderApplication
import org.scalatest.matchersdsl.ResultOfInOrderElementsOfApplication
import org.scalatest.matchersdsl.ResultOfAtMostOneOfApplication
import org.scalatest.matchersdsl.ResultOfAtMostOneElementOfApplication
import org.scalatest.matchersdsl.SortedWord
import org.scalatest.matchersdsl.ResultOfATypeInvocation
import org.scalatest.matchersdsl.ResultOfAnTypeInvocation
import org.scalatest.matchersdsl.ExistWord
import org.scalatest.matchersdsl.ResultOfNotExist
import org.scalatest.matchersdsl.ReadableWord
import org.scalatest.matchersdsl.WritableWord
import org.scalatest.matchersdsl.EmptyWord
import org.scalatest.matchersdsl.DefinedWord
...
*/
  ...
  def genMatcherFactory(targetDir: File, arity: Int, scalaJS: Boolean): File = {
    ...
    def setCommonOnes(arity: Int, st: org.antlr.stringtemplate.StringTemplate) {
      ...
      val typeConstructorsWithType = (1 to arity).map(i => s"tp$i: Type[TC$i]").mkString(", ")
