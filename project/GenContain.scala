...
object GenContain {
  ...
  def genTest(targetBaseDir: File, scalaVersion: String) {
    ...
    val stringLowerCased = "val lowerCased: Normalizer[Char] = new Normalizer[Char] {\n" +
    ...
    val mapLowerCased = "val lowerCased: Normalizer[(String, String)] = new Normalizer[(String, String)] {\n" + 
    ...
    val mapTrimmed = "val trimmed: Normalizer[(String, String)] = new Normalizer[(String, String)] {\n" + 
    ...
    val javaMapLowerCased = "val lowerCased: Normalizer[java.util.Map.Entry[String, String]] = new Normalizer[java.util.Map.Entry[String, String]] {\n" + 
    ...
    val javaMapTrimmed = "val trimmed: Normalizer[java.util.Map.Entry[String, String]] = new Normalizer[java.util.Map.Entry[String, String]] {\n" + 
