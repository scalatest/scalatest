...
trait Assertions extends TripleEquals  {
   ...
   */
  def assert(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = macro AssertionsMacro.assert
  ...
  class AssertionsHelper {
     ...
     */
    def macroAssert(bool: Bool, clue: Any, prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = {
     ...
     */
    def macroAssume(bool: Bool, clue: Any, prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = {
      requireNonNull(clue)(prettifier, pos)
      if (!bool.value) {
        val failureMessage = if (Bool.isSimpleWithoutExpressionText(bool)) None else Some(bool.failureMessage)
   ...
   */
  def assert(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = macro AssertionsMacro.assertWithClue
   ...
   */
  def assume(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = macro AssertionsMacro.assume
   ...
   * @throws NullArgumentException if <code>message</code> is <code>null</code>.
   */
  def assume(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = macro AssertionsMacro.assumeWithClue
