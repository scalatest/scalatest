...
trait Assertions extends TripleEquals with DefaultPrettifier {
  ...
  implicit val FailureMessages = new FailureMessages(prettifier)
   ...
   */
  def assert(condition: Boolean): Assertion = macro AssertionsMacro.assert
  ...
  /**
    ...
    */
  val typeMatcherHelper = new matchers.TypeMatcherHelper(FailureMessages)

  /**
    * Helper instance used by code generated by type checking macro assertion.
    */
  val matchPatternHelper = new matchers.MatchPatternHelper(FailureMessages)
   ...
   */
  def assert(condition: Boolean, clue: Any): Assertion = macro AssertionsMacro.assertWithClue
   ...
   */
  def assume(condition: Boolean): Assertion = macro AssertionsMacro.assume
   ...
   * @throws NullArgumentException if <code>message</code> is <code>null</code>.
   */
  def assume(condition: Boolean, clue: Any): Assertion = macro AssertionsMacro.assumeWithClue
