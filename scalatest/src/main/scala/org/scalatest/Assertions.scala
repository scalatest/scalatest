...
trait Assertions extends TripleEquals  {
   ...
   */
  def assert(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ): Assertion = macro AssertionsMacro.assert
  ...
  class AssertionsHelper {
     ...
     */
    def macroAssert(bool: Bool, clue: Any, prettifier: Prettifier, pos: source.Position, differ: Differ): Assertion = {
      ...
      if (!bool.value) {
        ...
        throw newAssertionFailedException(append(failureMessage, clue), None, pos, bool.differences)
      }
      Succeeded
    }
     ...
     */
    def macroAssume(bool: Bool, clue: Any, prettifier: Prettifier, pos: source.Position, differ: Differ): Assertion = {
      requireNonNull(clue)(prettifier, pos)
      if (!bool.value) {
        val failureMessage = if (Bool.isSimpleWithoutExpressionText(bool)) None else Some(bool.failureMessage)
  ...
  private[scalatest] def newAssertionFailedException(optionalMessage: Option[String], optionalCause: Option[Throwable], pos: source.Position, differences: scala.collection.immutable.IndexedSeq[Difference]): Throwable =
    new exceptions.TestFailedException(toExceptionFunction(optionalMessage), optionalCause, Left(pos), None, differences)
   ...
   */
  def assert(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ): Assertion = macro AssertionsMacro.assertWithClue
   ...
   */
  def assume(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ): Assertion = macro AssertionsMacro.assume
   ...
   * @throws NullArgumentException if <code>message</code> is <code>null</code>.
   */
  def assume(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ): Assertion = macro AssertionsMacro.assumeWithClue
