...
trait Assertions extends TripleEquals  {
   ...
   */
  def assert(condition: Boolean)(implicit prettifier: Prettifier): Assertion = macro AssertionsMacro.assert
   ...
   */
  def assert(condition: Boolean, clue: Any)(implicit prettifier: Prettifier): Assertion = macro AssertionsMacro.assertWithClue
   ...
   */
  def assume(condition: Boolean)(implicit prettifier: Prettifier): Assertion = macro AssertionsMacro.assume
   ...
   * @throws NullArgumentException if <code>message</code> is <code>null</code>.
   */
  def assume(condition: Boolean, clue: Any)(implicit prettifier: Prettifier): Assertion = macro AssertionsMacro.assumeWithClue
