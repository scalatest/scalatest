...
trait Assertions extends TripleEquals  {
   ...
   */
  def assert(condition: Boolean)(implicit prettifier: Prettifier, sourceInfo: SourceInfo): Assertion = macro AssertionsMacro.assert
  ...
  class AssertionsHelper {
     ...
     */
    def macroAssert(bool: Bool, clue: Any, prettifier: Prettifier, sourceInfo: SourceInfo): Assertion = {
     ...
     */
    def macroAssume(bool: Bool, clue: Any, prettifier: Prettifier, sourceInfo: SourceInfo): Assertion = {
      requireNonNull(clue)(prettifier, sourceInfo)
      if (!bool.value) {
        val failureMessage = if (Bool.isSimpleWithoutExpressionText(bool)) None else Some(bool.failureMessage)
   ...
   */
  def assert(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, sourceInfo: SourceInfo): Assertion = macro AssertionsMacro.assertWithClue
   ...
   */
  def assume(condition: Boolean)(implicit prettifier: Prettifier, sourceInfo: SourceInfo): Assertion = macro AssertionsMacro.assume
   ...
   * @throws NullArgumentException if <code>message</code> is <code>null</code>.
   */
  def assume(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, sourceInfo: SourceInfo): Assertion = macro AssertionsMacro.assumeWithClue
