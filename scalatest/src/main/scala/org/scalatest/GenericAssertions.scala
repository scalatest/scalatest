...
/**
  ...
  * @author Bill Venners
  */
trait GenericAssertions extends TripleEquals  {
  ...
  /**
    ...
    */
  def assert(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position): RESULT = macro AssertionsMacro.assert[RESULT]
  ...
  /**
    ...
    */
  def assert(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position): RESULT = macro AssertionsMacro.assertWithClue[RESULT]
  ...
  /**
    ...
    */
  def assume(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position): RESULT = macro AssertionsMacro.assume[RESULT]
  ...
  /**
    ...
    * @throws NullArgumentException if <code>message</code> is <code>null</code>.
    */
  def assume(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position): RESULT = macro AssertionsMacro.assumeWithClue[RESULT]
