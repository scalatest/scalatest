 ...
 * using a style consistent with traditional <code>WordSpec</code> tests.
 *
 ...
 *
 * <p>
 * In an <code>AsyncWordSpec</code> you will need to define an implicit
 * <code>ExecutionContext</code> named <code>executionContext</code>. This
 * execution context will be used by <code>AsyncWordSpec</code> to
 ...
 *
 * <p>
 * By default, tests in an <code>AsyncWordSpec</code> will be executed one after
 ...
 *
 * <p>
 * Given these definitions, you could place <code>AsyncFunSpec</code> tests into groups like this:
 * </p>
 *
 * <pre class="stHighlight">
 * import org.scalatest.AsyncWordSpec
 ...
 * method defined in trait <a href="AsyncSuite.html"><code>AsyncSuite</code></a>, a supertrait of <code>AsyncFunSpec</code>.
 * </p>
 *
 * <p>
