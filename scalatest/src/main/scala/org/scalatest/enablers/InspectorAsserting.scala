...
abstract class MediumPriorityInspectorAsserting extends LowPriorityInspectorAsserting {
  implicit def assertingNatureOfAssertion: InspectorAsserting[Assertion] { type Result = Assertion } = {
    new InspectorAsserting[Assertion] {
      ...
      def doForAll[E](xs: GenTraversable[E], original: Any, shorthand: Boolean, sourceFileName: String, methodName: String, stackDepthAdjustment: Int)(fun: E => Assertion): Result = {
        val xsIsMap = isMap(original)
        val result =
          runFor(xs.toIterator, xsIsMap, 0, new ForResult[E], fun, _.failedElements.length > 0)
        if (result.failedElements.length > 0)
      ...
      def doForAtLeast[E](min: Int, xs: GenTraversable[E], original: Any, shorthand: Boolean, sourceFileName: String, methodName: String, stackDepthAdjustment: Int)(fun: E => Assertion): Result = {
        @tailrec
        def forAtLeastAcc(itr: Iterator[E], includeIndex: Boolean, index: Int, passedCount: Int, messageAcc: IndexedSeq[String]): (Int, IndexedSeq[String]) = {
          if (itr.hasNext) {
            val head = itr.next
      ...
      def doForAtMost[E](max: Int, xs: GenTraversable[E], original: Any, shorthand: Boolean, sourceFileName: String, methodName: String, stackDepthAdjustment: Int)(fun: E => Assertion): Result = {
        if (max <= 0)
          throw new IllegalArgumentException(Resources.forAssertionsMoreThanZero("'max'"))
      ...
      def doForExactly[E](succeededCount: Int, xs: GenTraversable[E], original: Any, shorthand: Boolean, sourceFileName: String, methodName: String, stackDepthAdjustment: Int)(fun: E => Assertion): Result = {
        if (succeededCount <= 0)
          throw new IllegalArgumentException(Resources.forAssertionsMoreThanZero("'succeededCount'"))
      ...
      def doForNo[E](xs: GenTraversable[E], original: Any, shorthand: Boolean, sourceFileName: String, methodName: String, stackDepthAdjustment: Int)(fun: E => Assertion): Result = {
        val xsIsMap = isMap(original)
        val result =
          runFor(xs.toIterator, xsIsMap, 0, new ForResult[E], fun, _.passedCount != 0)
        if (result.passedCount != 0)
      ...
      def doForBetween[E](from: Int, upTo: Int, xs: GenTraversable[E], original: Any, shorthand: Boolean, sourceFileName: String, methodName: String, stackDepthAdjustment: Int)(fun: E => Assertion): Result = {
        if (from < 0)
          throw new IllegalArgumentException(Resources.forAssertionsMoreThanEqualZero("'from'"))
        if (upTo <= 0)
          throw new IllegalArgumentException(Resources.forAssertionsMoreThanZero("'upTo'"))
      ...
      def doForEvery[E](xs: GenTraversable[E], original: Any, shorthand: Boolean, sourceFileName: String, methodName: String, stackDepthAdjustment: Int)(fun: E => Assertion): Result = {
        @tailrec
        def runAndCollectErrorMessage[E](itr: Iterator[E], messageList: IndexedSeq[String], index: Int)(fun: E => Assertion): IndexedSeq[String] = {
          if (itr.hasNext) {
            val head = itr.next
            val newMessageList =
              try {
