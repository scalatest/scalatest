 ...
 * <li>arbitrary object with a <code>isEmpty()</code> method that returns <code>Boolean</code></li>
 * <li>arbitrary object with a parameterless <code>isEmpty</code> method that returns <code>Boolean</code></li>
 * </ul>
 */
object Emptiness {
