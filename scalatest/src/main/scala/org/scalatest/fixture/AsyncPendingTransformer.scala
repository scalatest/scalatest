...
private[scalatest] case class AsyncPendingTransformer[FixtureParam](exceptionalTestFun: FixtureParam => Future[PendingStatement])(implicit ctx: ExecutionContext) extends (FixtureParam => AsyncOutcome) {
