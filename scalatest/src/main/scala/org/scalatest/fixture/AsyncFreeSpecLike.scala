...
trait AsyncFreeSpecLike extends FreeSpecRegistering[Future[Assertion]] with AsyncFixtures with org.scalatest.AsyncCompatibility with OneInstancePerTest { thisSuite =>
