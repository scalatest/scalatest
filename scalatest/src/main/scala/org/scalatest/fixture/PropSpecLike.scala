...
trait PropSpecLike extends org.scalatest.fixture.TestSuite with org.scalatest.fixture.TestRegistration with Informing with Notifying with Alerting with Documenting { thisSuite =>
  ...
  class ResultOfPropertyInvocation(testName: String, testTags: Tag*) {
    ...
    def apply(testFun: () => Any /* Assertion */)(implicit pos: source.Position): Unit = {
      ...
      //SCALATESTJS-ONLY val stackDepth = 5
      //SCALATESTJS-ONLY val stackDepthAdjustment = -5
      engine.registerTest(testName, org.scalatest.fixture.Transformer(new NoArgTestWrapper(testFun)), Resources.propertyCannotAppearInsideAnotherProperty, sourceFileName, "apply", stackDepth, stackDepthAdjustment, None, None, Some(pos), None, testTags: _*)
    }
  }
  ...
  class ResultOfIgnoreInvocation(testName: String, testTags: Tag*) {
    ...
    def apply(testFun: () => Any /* Assertion */)(implicit pos: source.Position): Unit = {
      ...
      //SCALATESTJS-ONLY val stackDepth = 5
      //SCALATESTJS-ONLY val stackDepthAdjustment = -6
      engine.registerIgnoredTest(testName, org.scalatest.fixture.Transformer(new NoArgTestWrapper(testFun)), Resources.ignoreCannotAppearInsideAProperty, sourceFileName, "apply", stackDepth, stackDepthAdjustment, None, Some(pos), testTags: _*)
    }
  }
