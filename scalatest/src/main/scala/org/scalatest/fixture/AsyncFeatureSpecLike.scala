...
trait AsyncFeatureSpecLike extends FeatureSpecRegistering[Future[Assertion]] with AsyncFixtures with org.scalatest.AsyncCompatibility with org.scalatest.OneInstancePerTest { thisSuite =>
