...
trait AsyncWordSpecLike extends WordSpecRegistering with AsyncFixtures with org.scalatest.AsyncCompatibility with org.scalatest.OneInstancePerTest { thisSuite =>
