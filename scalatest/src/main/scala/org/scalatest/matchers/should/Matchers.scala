...
*/
  ...
  final class StringShouldWrapper(val leftSideString: String, pos: source.Position, prettifier: Prettifier) extends AnyShouldWrapper(leftSideString, pos, prettifier) with StringShouldWrapperForVerb {
    ...
    // SKIP-DOTTY-END
    //DOTTY-ONLY inline def should(compileWord: CompileWord)(implicit pos: source.Position): Assertion = ${ org.scalatest.matchers.MatchersCompileMacro.shouldCompileImpl('{this}, '{compileWord})('{pos}) }
    ...
    // SKIP-DOTTY-END
    //DOTTY-ONLY inline def shouldNot(compileWord: CompileWord)(implicit pos: source.Position): Assertion = ${ org.scalatest.matchers.MatchersCompileMacro.shouldNotCompileImpl('{this}, '{compileWord})('{pos}) }
    ...
    // SKIP-DOTTY-END
    //DOTTY-ONLY inline def shouldNot(typeCheckWord: TypeCheckWord)(implicit pos: source.Position): Assertion = ${ org.scalatest.matchers.MatchersCompileMacro.shouldNotTypeCheckImpl('{this}, '{typeCheckWord})('{pos}) }
