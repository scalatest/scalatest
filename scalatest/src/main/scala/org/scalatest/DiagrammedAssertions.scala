...
trait DiagrammedAssertions extends Assertions {
   ...
   */
  override def assert(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = macro DiagrammedAssertionsMacro.assert
   ...
   */
  override def assert(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = macro DiagrammedAssertionsMacro.assertWithClue
   ...
   */
  override def assume(condition: Boolean)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = macro DiagrammedAssertionsMacro.assume
   ...
   * @throws NullArgumentException if <code>message</code> is <code>null</code>.
   */
  override def assume(condition: Boolean, clue: Any)(implicit prettifier: Prettifier, pos: source.Position, differ: Differ[Any]): Assertion = macro DiagrammedAssertionsMacro.assumeWithClue
}
