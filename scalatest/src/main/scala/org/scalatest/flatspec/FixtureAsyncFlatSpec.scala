...
/**
 * A sister class to <code>AsyncFlatSpec</code> that can pass a fixture object into its tests.
 *
 ...
 *
 * <p>
 * Class <code>FixtureAsyncFlatSpec</code> behaves similarly to class <code>AsyncFlatSpec</code>, except that tests may have a
 ...
 *
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>AsyncFlatSpec</code>:
 * </p>
 *
 * <ol>
