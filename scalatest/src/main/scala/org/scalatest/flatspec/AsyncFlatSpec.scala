 ...
 * You can also write <code>they</code> instead of <code>it</code>. See the documentation for <a href="AnyFlatSpec.html"><code>AnyFlatSpec</code></a> for
 * more detail.
 * </p>
 *
 * <p>
 ...
 * import org.scalatest._
 * 
 * class SetSpec extends flatspec.AsyncFlatSpec with GivenWhenThen {
 *   
 ...
 * import org.scalatest._
 *
 * class SetSpec extends flatspec.AsyncFlatSpec {
 *
 *   "A mutable Set" should "allow an element to be added" in {
 *
 ...
 * import scala.concurrent.Future
 *
 * class ExampleSpec extends flatspec.AsyncFlatSpec {
 *
 *   override def withFixture(test: NoArgAsyncTest) = {
 *
 ...
 * }
 *
 * class ExampleSpec extends flatspec.AsyncFlatSpec with Builder with Buffer {
 *
 *   "Testing" should "be easy" in {
 ...
 *
 * <pre class="stHighlight">
 * class StackSpec extends flatspec.AsyncFlatSpec with AsyncFlatSpecStackBehaviors {
 *
 *   val Max = 10
