 ...
 * Use class <code>FixtureAnyFlatSpec</code> in situations for which <a href="FixtureAnyFlatSpec.html"><code>FixtureAnyFlatSpec</code></a>
 ...
 * 
 * <p>
 * Class <code>FixtureAnyFlatSpec</code> behaves similarly to class <code>AnyFlatSpec</code>, except that tests may have a
 ...
 * 
 * <p>
 * Subclasses of this class must, therefore, do three things differently from a plain old <code>AnyFlatSpec</code>:
 * </p>
 * 
 * <ol>
 ...
 * }
 * 
 * class ExampleSpec extends FixtureAnyFlatSpec with DbFixture {
 * 
...
abstract class FixtureAnyFlatSpec extends FixtureAnyFlatSpecLike {
