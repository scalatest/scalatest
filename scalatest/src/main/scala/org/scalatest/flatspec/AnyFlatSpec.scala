 ...
 * the <a href="GivenWhenThen.html"><code>GivenWhenThen</code></a> trait provides methods that use the implicit <code>info</code> provided by <code>AnyFlatSpec</code>
 ...
 * You can mark tests as pending in <code>AnyFlatSpec</code> like this:
 * </p>
 *
 * <pre class="stHighlight">
