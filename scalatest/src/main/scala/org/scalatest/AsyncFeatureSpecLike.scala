...
trait AsyncFeatureSpecLike extends FeatureSpecRegistering[Future[Assertion]] with AsyncFixtures with AsyncCompatibility with OneInstancePerTest { thisSuite =>
