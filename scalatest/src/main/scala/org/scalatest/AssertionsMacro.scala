...
private[scalatest] object AssertionsMacro {
   ...
   */
  def assert[T](context: Context)(condition: context.Expr[Boolean])(prettifier: context.Expr[Prettifier], pos: context.Expr[source.Position]): context.Expr[T] =
    new BooleanMacro[context.type](context, "assertionsHelper").genMacro[T](condition, "macroAssert", context.literal(""), prettifier, pos)
   ...
   */
  def assertWithClue[T](context: Context)(condition: context.Expr[Boolean], clue: context.Expr[Any])(prettifier: context.Expr[Prettifier], pos: context.Expr[source.Position]): context.Expr[T] =
    new BooleanMacro[context.type](context, "assertionsHelper").genMacro[T](condition, "macroAssert", clue, prettifier, pos)
   ...
   */
  def assume[T](context: Context)(condition: context.Expr[Boolean])(prettifier: context.Expr[Prettifier], pos: context.Expr[source.Position]): context.Expr[T] =
    new BooleanMacro[context.type](context, "assertionsHelper").genMacro[T](condition, "macroAssume", context.literal(""), prettifier, pos)
   ...
   */
  def assumeWithClue[T](context: Context)(condition: context.Expr[Boolean], clue: context.Expr[Any])(prettifier: context.Expr[Prettifier], pos: context.Expr[source.Position]): context.Expr[T] =
    new BooleanMacro[context.type](context, "assertionsHelper").genMacro[T](condition, "macroAssume", clue, prettifier, pos)
}