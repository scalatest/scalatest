  ...
  private class GraphicRunReporter extends Reporter {
    ...
    override def apply(event: Event): Unit = {
      event match {
        ...
        case TestFailed(ordinal, message, suiteName, suiteId, suiteClassName, testName, testText, recordedEvents, differences, throwable, duration, formatter, location, rerunner, payload, threadName, timeStamp) =>
