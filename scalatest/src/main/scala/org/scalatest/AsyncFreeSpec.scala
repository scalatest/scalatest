 ...
 *
 * <p>
 * In an <code>AsyncFreeSpec</code> you will need to define an implicit
 * <code>ExecutionContext</code> named <code>executionContext</code>. This
 * execution context will be used by <code>AsyncFreeSpec</code> to
 ...
 *
 * <p>
 * By default, tests in an <code>AsyncFreeSpec</code> will be executed one after
 ...
 * <code>AsyncFreeSpec</code>'s <code>describe</code> clause.
