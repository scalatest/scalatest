...
/**
  ...
  */
@deprecated("Please use org.scalatest.freespec.AsyncFreeSpec instead")
...
In an AsyncFreeSpec, threads that transform and perform callbacks for Futures
...
to use a synchronous style, such as FunSpec, which doesn't take threads fron
