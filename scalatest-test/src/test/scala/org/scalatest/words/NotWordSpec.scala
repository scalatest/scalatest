...
class NotWordSpec extends Spec with FileMocks {
  ...
  object `NotWord ` {
    ...
    object `contain(ResultOfNoElementsOfApplication) method returns MatcherFactory1` {

      val mtf = not contain noElementsOf (List(1, 2))
      val mt = mtf.matcher[List[Int]]
    ...
    object `contain(ResultOfAtMostOneElementOfApplication) method returns MatcherFactory1` {

      val mtf = not contain atMostOneElementOf (List(1, 2))
      val mt = mtf.matcher[List[Int]]

      def `should have pretty toString` {
        mtf.toString should be ("not contain atMostOneElementOf (List(1, 2))")
        mt.toString should be ("not contain atMostOneElementOf (List(1, 2))")
      }
