...
class ConfigMapSpec extends FunSpec {
  ...
  describe("A ConfigMap") {
    ...
    it("should provide a nice syntax for getting a required entry") {
      assert(cm.getRequired[String]("string") === "aStringValue")
      assert(cm.getRequired[Int]("int") === 1)
    }

    it("should throw a TestCanceledException if a required entry is missing") {
      val caught =
...
// 510 287 1900
    ...
    it("should return None if an optional entry is missing") {
...
// 510 287 1900
    ...
    it("should provide a nice syntax for getting an optional entry with a default value") {
    ...
    it("should throw a TestCanceledException if an optional entry requested with a default has an unexpected type") {
...
// 510 287 1900
  ...
  describe("The ConfigMap companion object") {
    it("should provide a factory method for constructing new ConfigMaps") {
    ...
    it("should provide a factory method for constructing empty ConfigMaps") {
