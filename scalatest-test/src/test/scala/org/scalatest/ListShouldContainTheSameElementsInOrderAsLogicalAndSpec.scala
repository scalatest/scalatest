...
class ListShouldContainTheSameElementsInOrderAsLogicalAndSpec extends FunSpec {
  ...
  describe("a List") {
    ...
    describe("when used with (contain theSameElementsInOrderAs xx and contain theSameElementsInOrderAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fee", "fie", "foe", "fum"))), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e2, Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fum", "foe", "fie", "fee"))) + ", but " + Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fee", "fie", "foe", "fum"))), fileName, thisLineNumber - 2)
      }
    ...
    describe("when used with (equal xx and contain theSameElementsInOrderAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, Resources.equaled(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, fumList)) + ", but " + Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fee", "fie", "foe", "fum"))), fileName, thisLineNumber - 2)
      }
      ...
      it("should use the implicit Equality in scope") {
        ...
        checkMessageStackDepth(e2, Resources.equaled(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, fumList)) + ", but " + Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FEE", "FIE", "FOE", "FAM"))), fileName, thisLineNumber - 2)
      }
      ...
      it("should use an explicitly provided Equality") {
        ...
        checkMessageStackDepth(e1, Resources.equaled(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)) + ", but " + Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FEE", "FIE", "FOE", "FUM"))), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
    ...
    describe("when used with (be xx and contain theSameElementsInOrderAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, Resources.wasEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, fumList)) + ", but " + Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fee", "fie", "foe", "fum"))), fileName, thisLineNumber - 2)
      }
      ...
      it("should use an explicitly provided Equality") {
        ...
        checkMessageStackDepth(e1, Resources.wasEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, fumList)) + ", but " + Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FEE", "FIE", "FOE", "FUM"))), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
    ...
    describe("when used with (contain theSameElementsInOrderAs xx and be xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fum", "foe", "fie", "fee"))) + ", but " + Resources.wasNotEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (contain theSameElementsInOrderAs LinkedList("fee", "fie", "foe", "fum") and be (fumList))
        }
        checkMessageStackDepth(e2, Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fee", "fie", "foe", "fum"))), fileName, thisLineNumber - 2)
      }
      ...
      it("should use the implicit Equality in scope") {
        ...
        checkMessageStackDepth(e2, Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("HAPPY", "BIRTHDAY", "TO", "YOU"))), fileName, thisLineNumber - 2)
      }
      ...
      it("should use an explicitly provided Equality") {
        ...
        checkMessageStackDepth(e2, Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FUM", "FOE", "FIE", "FEE"))) + ", but " + Resources.wasNotEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)), fileName, thisLineNumber - 2)
    ...
    describe("when used with (not contain theSameElementsInOrderAs xx and not contain theSameElementsInOrderAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fum", "foe", "fie", "fee"))), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
        ...
        checkMessageStackDepth(e2, Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fee", "fie", "foe", "fum"))) + ", but " + Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fum", "foe", "fie", "fee"))), fileName, thisLineNumber - 2)
      }
      ...
      it("should use an explicitly provided Equality") {
        ...
        checkMessageStackDepth(e1, Resources.didNotContainSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FEE", "FIE", "FOE", "FUM"))) + ", but " + Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FUM", "FOE", "FIE", "FEE"))), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
        ...
        checkMessageStackDepth(e2, Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FUM", "FOE", "FIE", "FEE"))), fileName, thisLineNumber - 2)
      }
    }
    ...
    describe("when used with (not equal xx and not contain theSameElementsInOrderAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, Resources.didNotEqual(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)) + ", but " + Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fum", "foe", "fie", "fee"))), fileName, thisLineNumber - 2)
      }
      ...
      it("should use an explicitly provided Equality") {
        ...
        checkMessageStackDepth(e1, Resources.didNotEqual(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, fumList)) + ", but " + Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FUM", "FOE", "FIE", "FEE"))), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
    ...
    describe("when used with (not be xx and not contain theSameElementsInOrderAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e2, Resources.wasNotEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)) + ", but " + Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("fum", "foe", "fie", "fee"))), fileName, thisLineNumber - 2)
      }
      ...
      it("should use an explicitly provided Equality") {
        ...
        checkMessageStackDepth(e1, Resources.wasNotEqualTo(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, toList)) + ", but " + Resources.containedSameElementsInOrder(decorateToStringValue(prettifier, fumList), decorateToStringValue(prettifier, LinkedList("FUM", "FOE", "FIE", "FEE"))), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
  ...
  describe("col of Lists") {
    ...
    describe("used with contain theSameElementsInOrderAs xx and contain theSameElementsInOrderAs xx") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(2, 3, 4)) + " did not contain the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList(1, 2, 3)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(prettifier, List(1, 2, 3)) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList(1, 2, 3)) + ", but " + decorateToStringValue(prettifier, List(1, 2, 3)) + " did not contain the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList(1, 3, 4)), thisLineNumber - 2, list1s), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, nils(0)) + " did not contain the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("hi", "hello")), thisLineNumber - 2, nils), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, List("hi", "hello")) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("hi", "hello")) + ", but " + decorateToStringValue(prettifier, List("hi", "hello")) + " did not contain the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("hello", "hi")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
      ...
      it("should use the implicit Equality in scope") {
        ...
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(prettifier, List("hi", "hello")) + " did not contain the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("HO", "HELLO")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
    ...
    describe("when used with (not contain theSameElementsInOrderAs xx and not contain theSameElementsInOrderAs xx)") {
      ...
      it("should do nothing if valid, else throw a TFE with an appropriate error message") {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(prettifier, List(2, 3, 4)) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList(2, 3, 4)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e2, allErrMsg(2, decorateToStringValue(prettifier, List(2, 3, 4)) + " did not contain the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList(3, 6, 8)) + ", but " + decorateToStringValue(prettifier, List(2, 3, 4)) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList(2, 3, 4)), thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e3, allErrMsg(0, decorateToStringValue(prettifier, List("hi", "hello")) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("hi", "hello")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e4, allErrMsg(0, decorateToStringValue(prettifier, List("hi", "hello")) + " did not contain the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("ho", "hey", "howdy")) + ", but " + decorateToStringValue(prettifier, List("hi", "hello")) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("hi", "hello")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
      ...
      it("should use the implicit Equality in scope") {
        ...
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(prettifier, List("hi", "hello")) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("HI", "HELLO")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        ...
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(prettifier, List("hi", "hello")) + " did not contain the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("HELLO", "HI")) + ", but " + decorateToStringValue(prettifier, List("hi", "hello")) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(prettifier, LinkedList("HI", "HELLO")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
