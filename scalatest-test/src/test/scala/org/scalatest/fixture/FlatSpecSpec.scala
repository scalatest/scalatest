  ...
  describe("A fixture.FlatSpec ") {
    ...
    it("should throw DuplicateTestNameException if a duplicate test name registration is attempted") {
      ...
      intercept[DuplicateTestNameException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          it should "test this" in { fixture => succeed }
          it should "test this" in { fixture => succeed }
        }
      }
      intercept[DuplicateTestNameException] {
        new FlatSpec {
          ...
          def withFixture(test: OneArgTest): Outcome = Succeeded
          it should "test this" in { fixture => succeed }
          it should "test this" taggedAs(SlowTest) ignore { fixture => succeed }
        }
      }
      intercept[DuplicateTestNameException] {
        new FlatSpec {
          ...
          def withFixture(test: OneArgTest): Outcome = Succeeded
          it should "test this" in { fixture => succeed }
          it should "test this" taggedAs(Tag("SlowTest")) ignore { fixture => succeed }
        }
      }
      intercept[DuplicateTestNameException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          ignore should "test this" in { fixture => succeed }
          it should "test this" ignore { fixture => succeed }
        }
      }
      intercept[DuplicateTestNameException] {
        new FlatSpec {
      ...
      intercept[DuplicateTestNameException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerTest("should test this") { fixture => succeed }
          registerTest("should test this") { fixture => succeed }
        }
      }
      intercept[DuplicateTestNameException] {
        new FlatSpec {
          ...
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerTest("should test this") { fixture => succeed }
          registerIgnoredTest("should test this", SlowTest) { fixture => succeed }
        }
      }
      intercept[DuplicateTestNameException] {
        new FlatSpec {
          ...
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerTest("should test this") { fixture => succeed }
          registerIgnoredTest("should test this", Tag("SlowTest")) { fixture => succeed }
        }
      }
      intercept[DuplicateTestNameException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerIgnoredTest("should test this") { fixture => succeed }
          registerIgnoredTest("should test this") { fixture => succeed }
        }
      }
      intercept[DuplicateTestNameException] {
    ...
    it("should throw NullArgumentException if a null test tag is provided") {
      ...
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          it should "hi" taggedAs(null) in { fixture => succeed }
        }
      }
      val caught = intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          it should "hi" taggedAs(mytags.SlowAsMolasses, null) in { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          it should "hi" taggedAs(mytags.SlowAsMolasses, null, mytags.WeakAsAKitten) in { fixture => succeed }
        }
      }
      // ignore
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          ignore should "hi" taggedAs(null) in { fixture => succeed }
        }
      }
      val caught2 = intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          ignore should "hi" taggedAs(mytags.SlowAsMolasses, null) in { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          ignore should "hi" taggedAs(mytags.SlowAsMolasses, null, mytags.WeakAsAKitten) in { fixture => succeed }
        }
      }
      intercept[NullArgumentException] {
        new FlatSpec {
      ...
      val caught3 = intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          it should "hi" taggedAs(mytags.SlowAsMolasses, null) ignore { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          it should "hi" taggedAs(mytags.SlowAsMolasses, null, mytags.WeakAsAKitten) ignore { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerTest("should hi", null) { fixture => succeed }
        }
      }
      val caught4 = intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerTest("should hi", mytags.SlowAsMolasses, null) { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerTest("should hi", mytags.SlowAsMolasses, null, mytags.WeakAsAKitten) { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerIgnoredTest("should hi", null) { fixture => succeed }
        }
      }
      val caught5 = intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerIgnoredTest("should hi", mytags.SlowAsMolasses, null) { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new FlatSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          registerIgnoredTest("should hi", mytags.SlowAsMolasses, null, mytags.WeakAsAKitten) { fixture => succeed }
        }
      }
      intercept[NullArgumentException] {
        new FlatSpec {
    ...
    it("should return a correct tags map from the tags method using is (pending), when using regular (not shorthand)" +
      ...
      val f = new FlatSpec {
        ...
        it can "test that" taggedAs(mytags.SlowAsMolasses) in  { fixture => succeed }
      }
    ...
    it("should return a correct tags map from the tags method using is (pending), when using regular (not shorthand)" +
      ...
      val b = new FlatSpec {
        ...
        def withFixture(test: OneArgTest): Outcome = Succeeded
        it can "test this" is (pending)
        it can "test that" ignore { fixture => succeed }
      }
      assertResult(Map("can test that" -> Set("org.scalatest.Ignore"))) {
        b.tags
      }
      ...
      val c = new FlatSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = Succeeded
        it must "test this" ignore { fixture => succeed }
        it must "test that" ignore { fixture => succeed }
      }
      assertResult(Map("must test this" -> Set("org.scalatest.Ignore"), "must test that" -> Set("org.scalatest.Ignore"))) {
        c.tags
      }
      ...
      val d = new FlatSpec {
        ...
        def withFixture(test: OneArgTest): Outcome = Succeeded
        it must "test this" taggedAs(mytags.SlowAsMolasses) is (pending)
        it must "test that" taggedAs(mytags.SlowAsMolasses) ignore { fixture => succeed }
      }
      assertResult(Map("must test this" -> Set("org.scalatest.SlowAsMolasses"), "must test that" -> Set("org.scalatest.Ignore", "org.scalatest.SlowAsMolasses"))) {
        d.tags
      }
    ...
    it("should return a correct tags map from the tags method using is (pending), when using shorthand notation") {
      ...
      val a = new FlatSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = Succeeded
        "A Stack" should "test this" ignore { fixture => succeed }
      ...
      val b = new FlatSpec {
        ...
        "A Stack" can "test that" ignore { fixture => succeed }
      }
      ...
      val c = new FlatSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = Succeeded
        "A Stack" must "test this" ignore { fixture => succeed }
        "A Stack" must "test that" ignore { fixture => succeed }
      }
      ...
      val d = new FlatSpec {
        ...
        "A Stack" must "test that" taggedAs(mytags.SlowAsMolasses) ignore { fixture => succeed }
      }
      ...
      val f = new FlatSpec {
        ...
        "A Stack" can "test that" taggedAs(mytags.SlowAsMolasses) in  { fixture => succeed }
      }
      ...
      val g = new FlatSpec {
        ...
        "A Stack" should "test that" taggedAs(mytags.SlowAsMolasses) in  { fixture => succeed }
      }
    ...
    class TestWasCalledSuite extends FlatSpec {
      ...
      it should "run this" in { fixture => theTestThisCalled = true; succeed }
      it should "run that, maybe" in { fixture => theTestThatCalled = true; succeed }
    }
    ...
    it("should report as ignored, and not run, tests marked ignored") {
      ...
      val a = new FlatSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        it can "test this" in { fixture => theTestThisCalled = true; succeed }
        it can "test that" in { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val b = new FlatSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        ignore must "test this" in { fixture => theTestThisCalled = true; succeed }
        it must "test that" in { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val c = new FlatSpec {
        ...
        var theTestThatCalled = false
        it can "test this" in { fixture => theTestThisCalled = true; succeed }
        ignore can "test that" in { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val d = new FlatSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        ignore should "test this" in { fixture => theTestThisCalled = true; succeed }
        ignore should "test that" in { fixture => theTestThatCalled = true; succeed }
      }
    ...
    it("should run only those tests selected by the tags to include and exclude sets") {
      ...
      val a = new FlatSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        it should "test this" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThisCalled = true; succeed }
        it should "test that" in { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val c = new FlatSpec {
        ...
        var theTestThatCalled = false
        it should "test this" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThisCalled = true; succeed }
        it should "test that" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThatCalled = true; succeed }
      }
      val repC = new TestIgnoredTrackingReporter
      ...
      val d = new FlatSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        ignore should "test this" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThisCalled = true; succeed }
        it should "test that" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThatCalled = true; succeed }
      }
      val repD = new TestIgnoredTrackingReporter
      ...
      val e = new FlatSpec {
        ...
        it should "test this" taggedAs(mytags.SlowAsMolasses, mytags.FastAsLight) in { fixture => theTestThisCalled = true; succeed }
        it should "test that" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThatCalled = true; succeed }
        it should "test the other" in { fixture => theTestTheOtherCalled = true; succeed }
      }
      val repE = new TestIgnoredTrackingReporter
      ...
      val f = new FlatSpec {
        ...
        var theTestThatCalled = false
        var theTestTheOtherCalled = false
        ignore should "test this" taggedAs(mytags.SlowAsMolasses, mytags.FastAsLight) in { fixture => theTestThisCalled = true; succeed }
        it should "test that" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThatCalled = true; succeed }
        it should "test the other" in { fixture => theTestTheOtherCalled = true; succeed }
      }
      ...
      val g = new FlatSpec {
        ...
        it should "test this" taggedAs(mytags.SlowAsMolasses, mytags.FastAsLight) in { fixture => theTestThisCalled = true; succeed }
        it should "test that" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThatCalled = true; succeed }
        ignore should "test the other" in { fixture => theTestTheOtherCalled = true; succeed }
      }
      ...
      val j = new FlatSpec {
        ...
        var theTestTheOtherCalled = false
        ignore should "test this" taggedAs(mytags.SlowAsMolasses, mytags.FastAsLight) in { fixture => theTestThisCalled = true; succeed }
        ignore should "test that" taggedAs(mytags.SlowAsMolasses) in { fixture => theTestThatCalled = true; succeed }
        it should "test the other" in { fixture => theTestTheOtherCalled = true; succeed }
      }
    ...
    it("should run only those registered tests selected by the tags to include and exclude sets") {
      ...
      val a = new FlatSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        registerTest("should test this", mytags.SlowAsMolasses) { fixture => theTestThisCalled = true; succeed }
        registerTest("should test that") { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val c = new FlatSpec {
        ...
        var theTestThatCalled = false
        registerTest("should test this", mytags.SlowAsMolasses) { fixture => theTestThisCalled = true; succeed }
        registerTest("should test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
      }
      val repC = new TestIgnoredTrackingReporter
      c.run(None, Args(repB, Stopper.default, Filter(Some(Set("org.scalatest.SlowAsMolasses")), Set()), ConfigMap.empty, None, new Tracker, Set.empty))
      assert(!repC.testIgnoredReceived)
      ...
      val d = new FlatSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        registerIgnoredTest("should test this", mytags.SlowAsMolasses) { fixture => theTestThisCalled = true; succeed }
        registerTest("should test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
      }
      val repD = new TestIgnoredTrackingReporter
      d.run(None, Args(repD, Stopper.default, Filter(Some(Set("org.scalatest.SlowAsMolasses")), Set("org.scalatest.Ignore")), ConfigMap.empty, None, new Tracker, Set.empty))
      ...
      val e = new FlatSpec {
        ...
        var theTestThatCalled = false
        var theTestTheOtherCalled = false
        registerTest("should test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        registerTest("should test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        registerTest("should test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
      val repE = new TestIgnoredTrackingReporter
      e.run(None, Args(repE, Stopper.default, Filter(Some(Set("org.scalatest.SlowAsMolasses")), Set("org.scalatest.FastAsLight")),
        ConfigMap.empty, None, new Tracker, Set.empty))
      ...
      val f = new FlatSpec {
        ...
        var theTestThatCalled = false
        var theTestTheOtherCalled = false
        registerIgnoredTest("should test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        registerTest("should test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        registerTest("should test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
      val repF = new TestIgnoredTrackingReporter
      ...
      val g = new FlatSpec {
        ...
        registerTest("should test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        registerTest("should test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        registerIgnoredTest("should test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
      val repG = new TestIgnoredTrackingReporter
      g.run(None, Args(repG, Stopper.default, Filter(Some(Set("org.scalatest.SlowAsMolasses")), Set("org.scalatest.FastAsLight")),
        ConfigMap.empty, None, new Tracker, Set.empty))
      ...
      val j = new FlatSpec {
        ...
        var theTestTheOtherCalled = false
        registerIgnoredTest("should test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        registerIgnoredTest("should test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        registerTest("should test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
      val repJ = new TestIgnoredTrackingReporter
      j.run(None, Args(repJ, Stopper.default, Filter(None, Set("org.scalatest.SlowAsMolasses")), ConfigMap.empty, None, new Tracker, Set.empty))
    ...
    it("should return the correct test count from its expectedTestCount method") {
      ...
      val a = new FlatSpec {
        ...
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        it should "test this" in { fixture => succeed }
        it should "test that" in { fixture => succeed }
      }
      ...
      val c = new FlatSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        it should "test this" taggedAs(mytags.FastAsLight) in { fixture => succeed }
        it should "test that" in { fixture => succeed }
      }
      ...
      val d = new FlatSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        it should "test this" taggedAs(mytags.FastAsLight, mytags.SlowAsMolasses) in { fixture => succeed }
        it should "test that" taggedAs(mytags.SlowAsMolasses) in { fixture => succeed }
        it should "test the other thing" in { fixture => succeed }
      }
      ...
      val e = new FlatSpec {
        ...
        it should "test this" taggedAs(mytags.FastAsLight, mytags.SlowAsMolasses) in { fixture => succeed }
        it should "test that" taggedAs(mytags.SlowAsMolasses) in { fixture => succeed }
        ignore should "test the other thing" in { fixture => succeed }
      }
    ...
    it("should return the correct test count from its expectedTestCount method when uses registerTest and registerIgnoredTest to register tests") {
      ...
      val a = new FlatSpec {
        ...
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        registerTest("should test this") { fixture => succeed }
        registerTest("should test that") { fixture => succeed }
      }
      assert(a.expectedTestCount(Filter()) == 2)
      ...
      val c = new FlatSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        registerTest("should test this", mytags.FastAsLight) { fixture => succeed }
        registerTest("should test that") { fixture => succeed }
      }
      assert(c.expectedTestCount(Filter(Some(Set("org.scalatest.FastAsLight")), Set())) == 1)
      assert(c.expectedTestCount(Filter(None, Set("org.scalatest.FastAsLight"))) == 1)
      ...
      val d = new FlatSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        registerTest("should test this", mytags.FastAsLight, mytags.SlowAsMolasses) { fixture => succeed }
        registerTest("should test that", mytags.SlowAsMolasses) { fixture => succeed }
        registerTest("should test the other thing") { fixture => succeed }
      }
      assert(d.expectedTestCount(Filter(Some(Set("org.scalatest.FastAsLight")), Set())) == 1)
      assert(d.expectedTestCount(Filter(Some(Set("org.scalatest.SlowAsMolasses")), Set("org.scalatest.FastAsLight"))) == 1)
      assert(d.expectedTestCount(Filter(None, Set("org.scalatest.SlowAsMolasses"))) == 1)
      ...
      val e = new FlatSpec {
        ...
        registerTest("should test this", mytags.FastAsLight, mytags.SlowAsMolasses) { fixture => succeed }
        registerTest("should test that", mytags.SlowAsMolasses) { fixture => succeed }
        registerIgnoredTest("should test the other thing") { fixture => succeed }
      }
      assert(e.expectedTestCount(Filter(Some(Set("org.scalatest.FastAsLight")), Set())) == 1)
      assert(e.expectedTestCount(Filter(Some(Set("org.scalatest.SlowAsMolasses")), Set("org.scalatest.FastAsLight"))) == 1)
      assert(e.expectedTestCount(Filter(None, Set("org.scalatest.SlowAsMolasses"))) == 0)
...
*/
    it("should allow both tests that take fixtures and tests that don't") {
      val a = new FlatSpec {
        ...
        it should "take no args" in { () => takesNoArgsInvoked = true; succeed }

        var takesAFixtureInvoked = false
        it should "take a fixture" in { s => takesAFixtureInvoked = true; succeed }
      }
    ...
    it("should work with test functions whose inferred result type is not Unit") {
      val a = new FlatSpec {
        ...
        var takesNoArgsInvoked = false
        it should "take no args" in { () => takesNoArgsInvoked = true; true; succeed }

        var takesAFixtureInvoked = false
        it should "take a fixture" in { s => takesAFixtureInvoked = true; true;; succeed }
      }
    ...
    it("should work with ignored tests whose inferred result type is not Unit") {
      val a = new FlatSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        ignore should "test this" in { () => theTestThisCalled = true; "hi"; succeed }
        ignore should "test that" in { fixture => theTestThatCalled = true; 42; succeed }
      }
    ...
    it("should pass the correct test name in the OneArgTest passed to withFixture") {
      val a = new FlatSpec {
        ...
        it should "do something" in { fixture => succeed }
      }
    ...
    describe("(when a nesting rule has been violated)") {
      ...
      it("should, if they call a should from within an it clause, result in a TestFailedException when running the test") {
        ...
        class MySpec extends FlatSpec {
          ...
          def withFixture(test: OneArgTest): Outcome = { test("hi") }
          it should "blow up" in { fixture =>
            "in the wrong place, at the wrong time" should "definitely blow up" in { fixture => succeed }
            succeed
          }
        }
      ...
      it("should throw DuplicateTestNameException if a duplicate test name registration is attempted") {
        ...
        intercept[DuplicateTestNameException] {
          new FlatSpec {
            type FixtureParam = String
            def withFixture(test: OneArgTest): Outcome = Succeeded
            they should "test this" in { fixture => succeed }
            they should "test this" in { fixture => succeed }
          }
        }
        intercept[DuplicateTestNameException] {
          new FlatSpec {
            ...
            def withFixture(test: OneArgTest): Outcome = Succeeded
            they should "test this" in { fixture => succeed }
            they should "test this" taggedAs(SlowTest) ignore { fixture => succeed }
          }
        }
        intercept[DuplicateTestNameException] {
          new FlatSpec {
            ...
            def withFixture(test: OneArgTest): Outcome = Succeeded
            they should "test this" in { fixture => succeed }
            they should "test this" taggedAs(Tag("SlowTest")) ignore { fixture => succeed }
          }
        }
        intercept[DuplicateTestNameException] {
          new FlatSpec {
            ...
            def withFixture(test: OneArgTest): Outcome = Succeeded
            ignore should "test this" in { fixture => succeed }
            they should "test this" ignore { fixture => succeed }
          }
        }
        intercept[DuplicateTestNameException] {
          new FlatSpec {
