...
class PropSpecSpec extends org.scalatest.FunSpec {
  ...
  describe("A fixture.PropSpec") {
    ...
    it("should throw NullArgumentException if a null test tag is provided") {
      ...
      intercept[NullArgumentException] {
        new PropSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          property("hi", null) { fixture => succeed }
        }
      }
      val caught = intercept[NullArgumentException] {
        new PropSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          property("hi", mytags.SlowAsMolasses, null) { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new PropSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          property("hi", mytags.SlowAsMolasses, null, mytags.WeakAsAKitten) { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new PropSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          ignore("hi", null) { fixture => succeed }
        }
      }
      val caught2 = intercept[NullArgumentException] {
        new PropSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          ignore("hi", mytags.SlowAsMolasses, null) { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new PropSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          ignore("hi", mytags.SlowAsMolasses, null, mytags.WeakAsAKitten) { fixture => succeed }
        }
      }
    ...
    class TestWasCalledSuite extends PropSpec {
      ...
      property("this") { fixture => theTestThisCalled = true; succeed }
      property("that") { fixture => theTestThatCalled = true; succeed }
    }
    ...
    it("should report as ignored, and not run, tests marked ignored") {
      ...
      val a = new PropSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        property("test this") { fixture => theTestThisCalled = true; succeed }
        property("test that") { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val b = new PropSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        ignore("test this") { fixture => theTestThisCalled = true; succeed }
        property("test that") { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val c = new PropSpec {
        ...
        var theTestThatCalled = false
        property("test this") { fixture => theTestThisCalled = true; succeed }
        ignore("test that") { fixture => theTestThatCalled = true; succeed }
      }
    ...
    it("should run only those tests selected by the tags to include and exclude sets") {
      ...
      val a = new PropSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        property("test this", mytags.SlowAsMolasses) { fixture => theTestThisCalled = true; succeed }
        property("test that") { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val c = new PropSpec {
        ...
        var theTestThatCalled = false
        property("test this", mytags.SlowAsMolasses) { fixture => theTestThisCalled = true; succeed }
        property("test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
      }
      val repC = new TestIgnoredTrackingReporter
      ...
      val d = new PropSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        ignore("test this", mytags.SlowAsMolasses) { fixture => theTestThisCalled = true; succeed }
        property("test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
      }
      val repD = new TestIgnoredTrackingReporter
      ...
      val e = new PropSpec {
        ...
        property("test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        property("test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        property("test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
      val repE = new TestIgnoredTrackingReporter
      ...
      val f = new PropSpec {
        ...
        var theTestThatCalled = false
        var theTestTheOtherCalled = false
        ignore("test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        property("test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        property("test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
      ...
      val g = new PropSpec {
        ...
        property("test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        property("test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        ignore("test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
      ...
      val j = new PropSpec {
        ...
        var theTestTheOtherCalled = false
        ignore("test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        ignore("test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        property("test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
    ...
    it("should return the correct test count from its expectedTestCount method") {
      ...
      val a = new PropSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        property("test this") { fixture => succeed }
        property("test that") { fixture => succeed }
      }
      ...
      val b = new PropSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        ignore("test this") { fixture => succeed }
        property("test that") { fixture => succeed }
      }
      ...
      val c = new PropSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        property("test this", mytags.FastAsLight) { fixture => succeed }
        property("test that") { fixture => succeed }
      }
      ...
      val d = new PropSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        property("test this", mytags.FastAsLight, mytags.SlowAsMolasses) { fixture => succeed }
        property("test that", mytags.SlowAsMolasses) { fixture => succeed }
        property("test the other thing") { fixture => succeed }
      }
      ...
      val e = new PropSpec {
        ...
        property("test this", mytags.FastAsLight, mytags.SlowAsMolasses) { fixture => succeed }
        property("test that", mytags.SlowAsMolasses) { fixture => succeed }
        ignore("test the other thing") { fixture => succeed }
      }
    ...
    it("should allow both tests that take fixtures and tests that don't") {
      val a = new PropSpec {
        ...
        property("take no args") { () => takesNoArgsInvoked = true; succeed }

        var takesAFixtureInvoked = false
        property("takes a fixture") { s => takesAFixtureInvoked = true; succeed }
      }
    ...
    it("should work with test functions whose inferred result type is not Unit") {
      val a = new PropSpec {
        ...
        var takesNoArgsInvoked = false
        property("take no args") { () => takesNoArgsInvoked = true; true; succeed }

        var takesAFixtureInvoked = false
        property("takes a fixture") { s => takesAFixtureInvoked = true; true; succeed }
      }
    ...
    it("should work with ignored tests whose inferred result type is not Unit") {
      val a = new PropSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        ignore("test this") { () => theTestThisCalled = true; "hi"; succeed }
        ignore("test that") { fixture => theTestThatCalled = true; 42; succeed }
      }
    ...
    it("should pass the correct test name in the OneArgTest passed to withFixture") {
      val a = new PropSpec {
        ...
        property("something") { fixture => succeed }
      }
    ...
    it("should throw IllegalArgumentException if passed a testName that doesn't exist") {
      class MySuite extends PropSpec {
        ...
        property("one") {s => (); succeed }
        property("two") {s => (); succeed }
      }
