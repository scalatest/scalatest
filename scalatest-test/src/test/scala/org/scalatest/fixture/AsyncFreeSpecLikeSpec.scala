...
class AsyncFreeSpecLikeSpec extends org.scalatest.FunSpec {
  ...
  describe("AsyncFreeSpecLike") {
    ...
    it("can be used for tests that return Future under parallel async test execution") {
      ...
      class ExampleSpec extends AsyncFreeSpecLike with ParallelTestExecution {
        ...
        //SCALATESTJS-ONLY implicit override def executionContext = org.scalatest.concurrent.RunNowExecutionContext
    ...
    it("should generate NotAllowedException wrapping a DuplicateTestNameException is thrown inside scope") {
      ...
      assert("AsyncFreeSpecLikeSpec.scala" == e.failedCodeFileName.get)
