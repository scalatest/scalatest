...
class FeatureSpecSpec extends org.scalatest.FunSpec {
  ...
  describe("A fixture.FeatureSpec") {
    ...
    it("should throw NullArgumentException if a null test tag is provided") {
      ...
      intercept[NullArgumentException] {
        new FeatureSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          scenario("hi", null) { fixture => succeed }
        }
      }
      val caught = intercept[NullArgumentException] {
        new FeatureSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          scenario("hi", mytags.SlowAsMolasses, null) { fixture => succeed }
        }
      }
      ...
      intercept[NullArgumentException] {
        new FeatureSpec {
          type FixtureParam = String
          def withFixture(test: OneArgTest): Outcome = Succeeded
          scenario("hi", mytags.SlowAsMolasses, null, mytags.WeakAsAKitten) { fixture => succeed }
        }
      }
    ...
    class TestWasCalledSuite extends FeatureSpec {
      ...
      scenario("this") { fixture => theTestThisCalled = true; succeed }
      scenario("that") { fixture => theTestThatCalled = true; succeed }
    }
    ...
    it("should report as ignored, and not run, tests marked ignored") {
      ...
      val a = new FeatureSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        scenario("test this") { fixture => theTestThisCalled = true; succeed }
        scenario("test that") { fixture => theTestThatCalled = true; succeed }
      }
    ...
    it("should run only those tests selected by the tags to include and exclude sets") {
      ...
      val a = new FeatureSpec {
        ...
        var theTestThisCalled = false
        var theTestThatCalled = false
        scenario("test this", mytags.SlowAsMolasses) { fixture => theTestThisCalled = true; succeed }
        scenario("test that") { fixture => theTestThatCalled = true; succeed }
      }
      ...
      val c = new FeatureSpec {
        ...
        var theTestThatCalled = false
        scenario("test this", mytags.SlowAsMolasses) { fixture => theTestThisCalled = true; succeed }
        scenario("test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
      }
      val repC = new TestIgnoredTrackingReporter
      ...
      val e = new FeatureSpec {
        ...
        scenario("test this", mytags.SlowAsMolasses, mytags.FastAsLight) { fixture => theTestThisCalled = true; succeed }
        scenario("test that", mytags.SlowAsMolasses) { fixture => theTestThatCalled = true; succeed }
        scenario("test the other") { fixture => theTestTheOtherCalled = true; succeed }
      }
      val repE = new TestIgnoredTrackingReporter
    ...
    it("should return the correct test count from its expectedTestCount method") {
      ...
      val a = new FeatureSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        scenario("test this") { fixture => succeed }
        scenario("test that") { fixture => succeed }
      }
      ...
      val c = new FeatureSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        scenario("test this", mytags.FastAsLight) { fixture => succeed }
        scenario("test that") { fixture => succeed }
      }
      ...
      val d = new FeatureSpec {
        type FixtureParam = String
        def withFixture(test: OneArgTest): Outcome = { test("hi") }
        scenario("test this", mytags.FastAsLight, mytags.SlowAsMolasses) { fixture => succeed }
        scenario("test that", mytags.SlowAsMolasses) { fixture => succeed }
        scenario("test the other thing") { fixture => succeed }
      }
...
*/
    it("should allow both tests that take fixtures and tests that don't") {
      val a = new FeatureSpec {
        ...
        scenario("takes a fixture") { s => takesAFixtureInvoked = true; succeed }
      }
    ...
    it("should work with test functions whose inferred result type is not Unit") {
      val a = new FeatureSpec {
        ...
        scenario("should take no args") { () =>
          takesNoArgsInvoked = true; succeed
        }

        var takesAFixtureInvoked = false
        scenario("should take a fixture") { s => takesAFixtureInvoked = true; succeed }
      }
  ...
  it("should pass the correct test name in the OneArgTest passed to withFixture") {
    val a = new FeatureSpec {
      ...
      scenario("should do something") { fixture => succeed }
    }
