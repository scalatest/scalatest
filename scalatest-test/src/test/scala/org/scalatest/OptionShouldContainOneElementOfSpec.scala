...
class OptionShouldContainOneElementOfSpec extends Spec {
  ...
  object `an Option` {
    ...
    object `when used with contain oneElementOf Seq(...) syntax` {
    ...
    */
    object `when used with not contain oneElementOf Seq(...) syntax` {
