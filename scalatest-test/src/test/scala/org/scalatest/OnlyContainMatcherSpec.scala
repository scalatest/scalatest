...
class OnlyContainMatcherSpec extends FunSpec {
  ...
  describe("only ") {
    ...
    it("should throw TestFailedException with correct stack depth and message when left list contains part of right list") {
      ...
      checkStackDepth(e4, left4, Array(1 -> "one", 2 -> "two", 3 -> "three", 4 -> "four", 5 -> "five").deep, thisLineNumber - 2)
      ...
      checkStackDepth(e6, left6, Array(1, 2, 3, 4, 5).deep, thisLineNumber - 2)
    ...
    it("should throw TestFailedException with correct stack depth and message when left List contains element not in right List") {
      ...
      checkStackDepth(e4, left4, Array(1, 2).deep, thisLineNumber - 2)
