...
import _root_.org.junit.Test
  ...
  class JUnitSuiteSuite extends FunSuite {
    ...
    test("A JUnitSuite with a JUnit 4 Test annotation will cause TestStarting event to be fired") {
      ...
      assert(repA.testStartingEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers.HappySuite")
    }
    ...
    test("A JUnitSuite with a JUnit 4 Test annotation will cause TestSucceeded to be fired") {
      ...
      assert(repA.testSucceededEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers.HappySuite")
    }
    ...
    test("A JUnitSuite with a JUnit 4 Test annotation on a bad test will cause testFailed to be invoked") {
      ...
      assert(repA.testFailedEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers.BitterSuite")
    ...
    test("A JUnitSuite with JUnit 4 Ignore and Test annotations will cause TestIgnored to be fired") {
      ...
      assert(repA.testIgnoredEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers.IgnoredSuite")
    }
    ...
    test("A JUnitSuite with two JUnit 4 Test annotations will cause TestStarting and TestSucceeded events to be fired twice each") {
      ...
      assert(repA.testStartingEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers.ManySuite")
      ...
      assert(repA.testSucceededEvent.get.suiteClassName.get === "org.scalatestplus.junit.helpers.ManySuite")
