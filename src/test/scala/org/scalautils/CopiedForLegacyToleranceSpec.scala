...
class CopiedForLegacyToleranceSpec extends Spec with Tolerance {
  ...
  */
  object `The === syntax` {
    ...
    def `should be None if the number is within the given interval` {
    ...
    // I'm going to live with this assymetry, since this is the legacy stuff and likely no one will ever do this anyway. The
    // assymetry is that interval on the left gives you Boolean, whereas interval on the right gives you Option[String]
    ...
    def `should be defined if the number is outside the given interval` {

      // Double +- Double
      assert((sevenDotOh === (7.5 +- 0.2)).isDefined)
      assert((sevenDotOh === (6.5 +- 0.2)).isDefined)
      assert((minusSevenDotOh === (-7.5 +- 0.2)).isDefined)
      assert((minusSevenDotOh === (-6.5 +- 0.2)).isDefined)

      // Double +- Float
      assert((sevenDotOh === (7.5 +- 0.2f)).isDefined)
      assert((sevenDotOh === (6.5 +- 0.2f)).isDefined)
      assert((minusSevenDotOh === (-7.5 +- 0.2f)).isDefined)
      assert((minusSevenDotOh === (-6.5 +- 0.2f)).isDefined)

      // Double +- Long
      assert((sevenDotOh === (4.0 +- 2L)).isDefined)
      assert((sevenDotOh === (9.1 +- 2L)).isDefined)
      assert((minusSevenDotOh === (-4.0 +- 2L)).isDefined)
      assert((minusSevenDotOh === (-9.1 +- 2L)).isDefined)

      // Double +- Int
      assert((sevenDotOh === (4.0 +- 2)).isDefined)
      assert((sevenDotOh === (9.1 +- 2)).isDefined)
      assert((minusSevenDotOh === (-4.0 +- 2)).isDefined)
      assert((minusSevenDotOh === (-9.1 +- 2)).isDefined)

      // Double +- Short
      assert((sevenDotOh === (4.0 +- 2.toShort)).isDefined)
      assert((sevenDotOh === (9.1 +- 2.toShort)).isDefined)
      assert((minusSevenDotOh === (-4.0 +- 2.toShort)).isDefined)
      assert((minusSevenDotOh === (-9.1 +- 2.toShort)).isDefined)

      // Double +- Byte
      assert((sevenDotOh === (4.0 +- 2.toByte)).isDefined)
      assert((sevenDotOh === (9.1 +- 2.toByte)).isDefined)
      assert((minusSevenDotOh === (-4.0 +- 2.toByte)).isDefined)
      assert((minusSevenDotOh === (-9.1 +- 2.toByte)).isDefined)

      // Float +- Float
      assert((sevenDotOhFloat === (7.5f +- 0.2f)).isDefined)
      assert((sevenDotOhFloat === (6.5f +- 0.2f)).isDefined)
      assert((minusSevenDotOhFloat === (-7.5f +- 0.2f)).isDefined)
      assert((minusSevenDotOhFloat === (-6.5f +- 0.2f)).isDefined)

      // Float +- Long
      assert((sevenDotOhFloat === (4.0f +- 2L)).isDefined)
      assert((sevenDotOhFloat === (9.1f +- 2L)).isDefined)
      assert((minusSevenDotOhFloat === (-4.0f +- 2L)).isDefined)
      assert((minusSevenDotOhFloat === (-9.1f +- 2L)).isDefined)

      // Float +- Int
      assert((sevenDotOhFloat === (4.0f +- 2)).isDefined)
      assert((sevenDotOhFloat === (9.1f +- 2)).isDefined)
      assert((minusSevenDotOhFloat === (-4.0f +- 2)).isDefined)
      assert((minusSevenDotOhFloat === (-9.1f +- 2)).isDefined)

      // Float +- Short
      assert((sevenDotOhFloat === (4.0f +- 2.toShort)).isDefined)
      assert((sevenDotOhFloat === (9.1f +- 2.toShort)).isDefined)
      assert((minusSevenDotOhFloat === (-4.0f +- 2.toShort)).isDefined)
      assert((minusSevenDotOhFloat === (-9.1f +- 2.toShort)).isDefined)

      // Float +- Byte
      assert((sevenDotOhFloat === (4.0f +- 2.toByte)).isDefined)
      assert((sevenDotOhFloat === (9.1f +- 2.toByte)).isDefined)
      assert((minusSevenDotOhFloat === (-4.0f +- 2.toByte)).isDefined)
      assert((minusSevenDotOhFloat === (-9.1f +- 2.toByte)).isDefined)

      // Long +- Long
      assert((sevenLong === (4L +- 2L)).isDefined)
      assert((sevenLong === (10L +- 2L)).isDefined)
      assert((minusSevenLong === (-4L +- 2L)).isDefined)
      assert((minusSevenLong === (-10L +- 2L)).isDefined)

      // Long +- Int
      assert((sevenLong === (4L +- 2)).isDefined)
      assert((sevenLong === (10L +- 2)).isDefined)
      assert((minusSevenLong === (-4L +- 2)).isDefined)
      assert((minusSevenLong === (-10L +- 2)).isDefined)

      // Long +- Short
      assert((sevenLong === (4L +- 2.toShort)).isDefined)
      assert((sevenLong === (10L +- 2.toShort)).isDefined)
      assert((minusSevenLong === (-4L +- 2.toShort)).isDefined)
      assert((minusSevenLong === (-10L +- 2.toShort)).isDefined)

      // Long +- Byte
      assert((sevenLong === (4L +- 2.toByte)).isDefined)
      assert((sevenLong === (10L +- 2.toByte)).isDefined)
      assert((minusSevenLong === (-4L +- 2.toByte)).isDefined)
      assert((minusSevenLong === (-10L +- 2.toByte)).isDefined)

      // Int +- Int
      assert((sevenInt === (4 +- 2)).isDefined)
      assert((sevenInt === (10 +- 2)).isDefined)
      assert((minusSevenInt === (-4 +- 2)).isDefined)
      assert((minusSevenInt === (-10 +- 2)).isDefined)

      // Int +- Short
      assert((sevenInt === (4 +- 2.toShort)).isDefined)
      assert((sevenInt === (10 +- 2.toShort)).isDefined)
      assert((minusSevenInt === (-4 +- 2.toShort)).isDefined)
      assert((minusSevenInt === (-10 +- 2.toShort)).isDefined)

      // Int +- Byte
      assert((sevenInt === (4 +- 2.toByte)).isDefined)
      assert((sevenInt === (10 +- 2.toByte)).isDefined)
      assert((minusSevenInt === (-4 +- 2.toByte)).isDefined)
      assert((minusSevenInt === (-10 +- 2.toByte)).isDefined)

      // Short +- Short
      assert((sevenShort === (4.toShort +- 2.toShort)).isDefined)
      assert((sevenShort === (10.toShort +- 2.toShort)).isDefined)
      assert((minusSevenShort === ((-4).toShort +- 2.toShort)).isDefined)
      assert((minusSevenShort === ((-10).toShort +- 2.toShort)).isDefined)

      // Short +- Byte
      assert((sevenShort === (4.toShort +- 2.toByte)).isDefined)
      assert((sevenShort === (10.toShort +- 2.toByte)).isDefined)
      assert((minusSevenShort === ((-4).toShort +- 2.toByte)).isDefined)
      assert((minusSevenShort === ((-10).toShort +- 2.toByte)).isDefined)

      // Byte +- Byte
      assert((sevenByte === (4.toByte +- 2.toByte)).isDefined)
      assert((sevenByte === (10.toByte +- 2.toByte)).isDefined)
      assert((minusSevenByte === ((-4).toByte +- 2.toByte)).isDefined)
      assert((minusSevenByte === ((-10).toByte +- 2.toByte)).isDefined)
    }
  ...
  object `The !== syntax` {
    ...
    def `should be None if the number is outside the given interval` {
    ...
    def `should be defined if the number is within the given interval` {

      // Double +- Double
      assert((sevenDotOh !== (7.1 +- 0.2)).isDefined)
      assert((sevenDotOh !== (6.9 +- 0.2)).isDefined)
      assert((sevenDotOh !== (7.0 +- 0.2)).isDefined)
      assert((sevenDotOh !== (7.2 +- 0.2)).isDefined)
      assert((sevenDotOh !== (6.8 +- 0.2)).isDefined)
      assert((minusSevenDotOh !== (-7.1 +- 0.2)).isDefined)
      assert((minusSevenDotOh !== (-6.9 +- 0.2)).isDefined)
      assert((minusSevenDotOh !== (-7.0 +- 0.2)).isDefined)
      assert((minusSevenDotOh !== (-7.2 +- 0.2)).isDefined)
      assert((minusSevenDotOh !== (-6.8 +- 0.2)).isDefined)

      // Double +- Float
      assert((sevenDotOh !== (7.1 +- 0.2f)).isDefined)
      assert((sevenDotOh !== (6.9 +- 0.2f)).isDefined)
      assert((sevenDotOh !== (7.0 +- 0.2f)).isDefined)
      assert((sevenDotOh !== (7.2 +- 0.2f)).isDefined)
      assert((sevenDotOh !== (6.8 +- 0.2f)).isDefined)
      assert((minusSevenDotOh !== (-7.1 +- 0.2f)).isDefined)
      assert((minusSevenDotOh !== (-6.9 +- 0.2f)).isDefined)
      assert((minusSevenDotOh !== (-7.0 +- 0.2f)).isDefined)
      assert((minusSevenDotOh !== (-7.2 +- 0.2f)).isDefined)
      assert((minusSevenDotOh !== (-6.8 +- 0.2f)).isDefined)

      // Double +- Long
      assert((sevenDotOh !== (7.1 +- 2L)).isDefined)
      assert((sevenDotOh !== (6.9 +- 2L)).isDefined)
      assert((sevenDotOh !== (7.0 +- 2L)).isDefined)
      assert((sevenDotOh !== (7.2 +- 2L)).isDefined)
      assert((sevenDotOh !== (6.8 +- 2L)).isDefined)
      assert((minusSevenDotOh !== (-7.1 +- 2L)).isDefined)
      assert((minusSevenDotOh !== (-6.9 +- 2L)).isDefined)
      assert((minusSevenDotOh !== (-7.0 +- 2L)).isDefined)
      assert((minusSevenDotOh !== (-7.2 +- 2L)).isDefined)
      assert((minusSevenDotOh !== (-6.8 +- 2L)).isDefined)

      // Double +- Int
      assert((sevenDotOh !== (7.1 +- 2)).isDefined)
      assert((sevenDotOh !== (6.9 +- 2)).isDefined)
      assert((sevenDotOh !== (7.0 +- 2)).isDefined)
      assert((sevenDotOh !== (7.2 +- 2)).isDefined)
      assert((sevenDotOh !== (6.8 +- 2)).isDefined)
      assert((minusSevenDotOh !== (-7.1 +- 2)).isDefined)
      assert((minusSevenDotOh !== (-6.9 +- 2)).isDefined)
      assert((minusSevenDotOh !== (-7.0 +- 2)).isDefined)
      assert((minusSevenDotOh !== (-7.2 +- 2)).isDefined)
      assert((minusSevenDotOh !== (-6.8 +- 2)).isDefined)

      // Double +- Short
      assert((sevenDotOh !== (7.1 +- 2.toShort)).isDefined)
      assert((sevenDotOh !== (6.9 +- 2.toShort)).isDefined)
      assert((sevenDotOh !== (7.0 +- 2.toShort)).isDefined)
      assert((sevenDotOh !== (7.2 +- 2.toShort)).isDefined)
      assert((sevenDotOh !== (6.8 +- 2.toShort)).isDefined)
      assert((minusSevenDotOh !== (-7.1 +- 2.toShort)).isDefined)
      assert((minusSevenDotOh !== (-6.9 +- 2.toShort)).isDefined)
      assert((minusSevenDotOh !== (-7.0 +- 2.toShort)).isDefined)
      assert((minusSevenDotOh !== (-7.2 +- 2.toShort)).isDefined)
      assert((minusSevenDotOh !== (-6.8 +- 2.toShort)).isDefined)

      // Double +- Byte
      assert((sevenDotOh !== (7.1 +- 2.toByte)).isDefined)
      assert((sevenDotOh !== (6.9 +- 2.toByte)).isDefined)
      assert((sevenDotOh !== (7.0 +- 2.toByte)).isDefined)
      assert((sevenDotOh !== (7.2 +- 2.toByte)).isDefined)
      assert((sevenDotOh !== (6.8 +- 2.toByte)).isDefined)
      assert((minusSevenDotOh !== (-7.1 +- 2.toByte)).isDefined)
      assert((minusSevenDotOh !== (-6.9 +- 2.toByte)).isDefined)
      assert((minusSevenDotOh !== (-7.0 +- 2.toByte)).isDefined)
      assert((minusSevenDotOh !== (-7.2 +- 2.toByte)).isDefined)
      assert((minusSevenDotOh !== (-6.8 +- 2.toByte)).isDefined)

      // Float +- Float
      assert((sevenDotOhFloat !== (7.1f +- 0.2f)).isDefined)
      assert((sevenDotOhFloat !== (6.9f +- 0.2f)).isDefined)
      assert((sevenDotOhFloat !== (7.0f +- 0.2f)).isDefined)
      assert((sevenDotOhFloat !== (7.2f +- 0.2f)).isDefined)
      assert((sevenDotOhFloat !== (6.8f +- 0.2f)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.1f +- 0.2f)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.9f +- 0.2f)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.0f +- 0.2f)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.2f +- 0.2f)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.8f +- 0.2f)).isDefined)

      // Float +- Long
      assert((sevenDotOhFloat !== (7.1f +- 2L)).isDefined)
      assert((sevenDotOhFloat !== (6.9f +- 2L)).isDefined)
      assert((sevenDotOhFloat !== (7.0f +- 2L)).isDefined)
      assert((sevenDotOhFloat !== (7.2f +- 2L)).isDefined)
      assert((sevenDotOhFloat !== (6.8f +- 2L)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.1f +- 2L)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.9f +- 2L)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.0f +- 2L)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.2f +- 2L)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.8f +- 2L)).isDefined)

      // Float +- Int
      assert((sevenDotOhFloat !== (7.1f +- 2)).isDefined)
      assert((sevenDotOhFloat !== (6.9f +- 2)).isDefined)
      assert((sevenDotOhFloat !== (7.0f +- 2)).isDefined)
      assert((sevenDotOhFloat !== (7.2f +- 2)).isDefined)
      assert((sevenDotOhFloat !== (6.8f +- 2)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.1f +- 2)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.9f +- 2)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.0f +- 2)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.2f +- 2)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.8f +- 2)).isDefined)

      // Float +- Short
      assert((sevenDotOhFloat !== (7.1f +- 2.toShort)).isDefined)
      assert((sevenDotOhFloat !== (6.9f +- 2.toShort)).isDefined)
      assert((sevenDotOhFloat !== (7.0f +- 2.toShort)).isDefined)
      assert((sevenDotOhFloat !== (7.2f +- 2.toShort)).isDefined)
      assert((sevenDotOhFloat !== (6.8f +- 2.toShort)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.1f +- 2.toShort)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.9f +- 2.toShort)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.0f +- 2.toShort)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.2f +- 2.toShort)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.8f +- 2.toShort)).isDefined)

      // Float +- Byte
      assert((sevenDotOhFloat !== (7.1f +- 2.toByte)).isDefined)
      assert((sevenDotOhFloat !== (6.9f +- 2.toByte)).isDefined)
      assert((sevenDotOhFloat !== (7.0f +- 2.toByte)).isDefined)
      assert((sevenDotOhFloat !== (7.2f +- 2.toByte)).isDefined)
      assert((sevenDotOhFloat !== (6.8f +- 2.toByte)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.1f +- 2.toByte)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.9f +- 2.toByte)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.0f +- 2.toByte)).isDefined)
      assert((minusSevenDotOhFloat !== (-7.2f +- 2.toByte)).isDefined)
      assert((minusSevenDotOhFloat !== (-6.8f +- 2.toByte)).isDefined)

      // Long +- Long
      assert((sevenLong !== (9L +- 2L)).isDefined)
      assert((sevenLong !== (8L +- 2L)).isDefined)
      assert((sevenLong !== (7L +- 2L)).isDefined)
      assert((sevenLong !== (6L +- 2L)).isDefined)
      assert((sevenLong !== (5L +- 2L)).isDefined)
      assert((minusSevenLong !== (-9L +- 2L)).isDefined)
      assert((minusSevenLong !== (-8L +- 2L)).isDefined)
      assert((minusSevenLong !== (-7L +- 2L)).isDefined)
      assert((minusSevenLong !== (-6L +- 2L)).isDefined)
      assert((minusSevenLong !== (-5L +- 2L)).isDefined)

      // Long +- Int
      assert((sevenLong !== (9L +- 2)).isDefined)
      assert((sevenLong !== (8L +- 2)).isDefined)
      assert((sevenLong !== (7L +- 2)).isDefined)
      assert((sevenLong !== (6L +- 2)).isDefined)
      assert((sevenLong !== (5L +- 2)).isDefined)
      assert((minusSevenLong !== (-9L +- 2)).isDefined)
      assert((minusSevenLong !== (-8L +- 2)).isDefined)
      assert((minusSevenLong !== (-7L +- 2)).isDefined)
      assert((minusSevenLong !== (-6L +- 2)).isDefined)
      assert((minusSevenLong !== (-5L +- 2)).isDefined)

      // Long +- Short
      assert((sevenLong !== (9L +- 2.toShort)).isDefined)
      assert((sevenLong !== (8L +- 2.toShort)).isDefined)
      assert((sevenLong !== (7L +- 2.toShort)).isDefined)
      assert((sevenLong !== (6L +- 2.toShort)).isDefined)
      assert((sevenLong !== (5L +- 2.toShort)).isDefined)
      assert((minusSevenLong !== (-9L +- 2.toShort)).isDefined)
      assert((minusSevenLong !== (-8L +- 2.toShort)).isDefined)
      assert((minusSevenLong !== (-7L +- 2.toShort)).isDefined)
      assert((minusSevenLong !== (-6L +- 2.toShort)).isDefined)
      assert((minusSevenLong !== (-5L +- 2.toShort)).isDefined)

      // Long +- Byte
      assert((sevenLong !== (9L +- 2.toByte)).isDefined)
      assert((sevenLong !== (8L +- 2.toByte)).isDefined)
      assert((sevenLong !== (7L +- 2.toByte)).isDefined)
      assert((sevenLong !== (6L +- 2.toByte)).isDefined)
      assert((sevenLong !== (5L +- 2.toByte)).isDefined)
      assert((minusSevenLong !== (-9L +- 2.toByte)).isDefined)
      assert((minusSevenLong !== (-8L +- 2.toByte)).isDefined)
      assert((minusSevenLong !== (-7L +- 2.toByte)).isDefined)
      assert((minusSevenLong !== (-6L +- 2.toByte)).isDefined)
      assert((minusSevenLong !== (-5L +- 2.toByte)).isDefined)

      // Int +- Int
      assert((sevenInt !== (9 +- 2)).isDefined)
      assert((sevenInt !== (8 +- 2)).isDefined)
      assert((sevenInt !== (7 +- 2)).isDefined)
      assert((sevenInt !== (6 +- 2)).isDefined)
      assert((sevenInt !== (5 +- 2)).isDefined)
      assert((minusSevenInt !== (-9 +- 2)).isDefined)
      assert((minusSevenInt !== (-8 +- 2)).isDefined)
      assert((minusSevenInt !== (-7 +- 2)).isDefined)
      assert((minusSevenInt !== (-6 +- 2)).isDefined)
      assert((minusSevenInt !== (-5 +- 2)).isDefined)

      // Int +- Short
      assert((sevenInt !== (9 +- 2.toShort)).isDefined)
      assert((sevenInt !== (8 +- 2.toShort)).isDefined)
      assert((sevenInt !== (7 +- 2.toShort)).isDefined)
      assert((sevenInt !== (6 +- 2.toShort)).isDefined)
      assert((sevenInt !== (5 +- 2.toShort)).isDefined)
      assert((minusSevenInt !== (-9 +- 2.toShort)).isDefined)
      assert((minusSevenInt !== (-8 +- 2.toShort)).isDefined)
      assert((minusSevenInt !== (-7 +- 2.toShort)).isDefined)
      assert((minusSevenInt !== (-6 +- 2.toShort)).isDefined)
      assert((minusSevenInt !== (-5 +- 2.toShort)).isDefined)

      // Int +- Byte
      assert((sevenInt !== (9 +- 2.toByte)).isDefined)
      assert((sevenInt !== (8 +- 2.toByte)).isDefined)
      assert((sevenInt !== (7 +- 2.toByte)).isDefined)
      assert((sevenInt !== (6 +- 2.toByte)).isDefined)
      assert((sevenInt !== (5 +- 2.toByte)).isDefined)
      assert((minusSevenInt !== (-9 +- 2.toByte)).isDefined)
      assert((minusSevenInt !== (-8 +- 2.toByte)).isDefined)
      assert((minusSevenInt !== (-7 +- 2.toByte)).isDefined)
      assert((minusSevenInt !== (-6 +- 2.toByte)).isDefined)
      assert((minusSevenInt !== (-5 +- 2.toByte)).isDefined)

      // Short +- Short
      assert((sevenShort !== (9.toShort +- 2.toShort)).isDefined)
      assert((sevenShort !== (8.toShort +- 2.toShort)).isDefined)
      assert((sevenShort !== (7.toShort +- 2.toShort)).isDefined)
      assert((sevenShort !== (6.toShort +- 2.toShort)).isDefined)
      assert((sevenShort !== (5.toShort +- 2.toShort)).isDefined)
      assert((minusSevenShort !== ((-9).toShort +- 2.toShort)).isDefined)
      assert((minusSevenShort !== ((-8).toShort +- 2.toShort)).isDefined)
      assert((minusSevenShort !== ((-7).toShort +- 2.toShort)).isDefined)
      assert((minusSevenShort !== ((-6).toShort +- 2.toShort)).isDefined)
      assert((minusSevenShort !== ((-5).toShort +- 2.toShort)).isDefined)

      // Short +- Byte
      assert((sevenShort !== (9.toShort +- 2.toByte)).isDefined)
      assert((sevenShort !== (8.toShort +- 2.toByte)).isDefined)
      assert((sevenShort !== (7.toShort +- 2.toByte)).isDefined)
      assert((sevenShort !== (6.toShort +- 2.toByte)).isDefined)
      assert((sevenShort !== (5.toShort +- 2.toByte)).isDefined)
      assert((minusSevenShort !== ((-9).toShort +- 2.toByte)).isDefined)
      assert((minusSevenShort !== ((-8).toShort +- 2.toByte)).isDefined)
      assert((minusSevenShort !== ((-7).toShort +- 2.toByte)).isDefined)
      assert((minusSevenShort !== ((-6).toShort +- 2.toByte)).isDefined)
      assert((minusSevenShort !== ((-5).toShort +- 2.toByte)).isDefined)

      // Byte +- Byte
      assert((sevenByte !== (9.toByte +- 2.toByte)).isDefined)
      assert((sevenByte !== (8.toByte +- 2.toByte)).isDefined)
      assert((sevenByte !== (7.toByte +- 2.toByte)).isDefined)
      assert((sevenByte !== (6.toByte +- 2.toByte)).isDefined)
      assert((sevenByte !== (5.toByte +- 2.toByte)).isDefined)
      assert((minusSevenByte !== ((-9).toByte +- 2.toByte)).isDefined)
      assert((minusSevenByte !== ((-8).toByte +- 2.toByte)).isDefined)
      assert((minusSevenByte !== ((-7).toByte +- 2.toByte)).isDefined)
      assert((minusSevenByte !== ((-6).toByte +- 2.toByte)).isDefined)
      assert((minusSevenByte !== ((-5).toByte +- 2.toByte)).isDefined)
    }
