...
class ListShouldContainOnlyLogicalAndSpec extends Spec with Matchers {
  ...
  object `a List` {
    ...
    object `when used with (contain only (..) and contain only (..))` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (newContain only ("fee", "fie", "foe", "fum") and newContain only ("fie", "fee", "fum", "foe"))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain only ("happy", "birthday", "to", "you") and newContain only ("fee", "fie", "foe", "fum"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (newContain only ("fee", "fie", "foe", "fum") and newContain only ("happy", "birthday", "to", "you"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        fumList should (newContain only ("FEE", "FIE", "FOE", "FUM") and newContain only ("FEE", "FIE", "FUM", "FOE"))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain only ("FEE", "FIE", "FOE", "FAM") and newContain only ("FEE", "FIE", "FUM", "FOE"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (newContain only ("FEE", "FIE", "FOE", "FUM") and (newContain only ("FEE", "FIE", "FAM", "FOE")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (newContain only ("FEE", "FIE", "FOE", "FUM") and newContain only ("FEE", "FIE", "FUM", "FOE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (newContain only ("FEE", "FIE", "FOE", "FAM") and newContain only ("FEE", "FIE", "FUM", "FOE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, Resources("didNotContainOnlyElements", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FAM\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          (fumList should (newContain only ("FEE", "FIE", "FOE", "FUM") and newContain only ("FEE", "FIE", "FAM", "FOE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, Resources("containedOnlyElements", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\"") + ", but " + Resources("didNotContainOnlyElements", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FAM\", \"FOE\""), fileName, thisLineNumber - 2)
        (fumList should (newContain only (" FEE ", " FIE ", " FOE ", " FUM ") and newContain only (" FEE ", " FIE ", " FOE ", " FUM "))) (after being lowerCased and trimmed, after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (equal (..) and contain only (..))` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (equal (fumList) and newContain only ("fie", "fee", "fum", "foe"))
        val e1 = intercept[TestFailedException] {
          fumList should (equal (toList) and newContain only ("fee", "fie", "foe", "fum"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (equal (fumList) and newContain only ("happy", "birthday", "to", "you"))
        }
      ...
      def `should use the implicit Equality in scope` {
        implicit val ise = upperCaseStringEquality
        fumList should (equal (fumList) and newContain only ("FEE", "FIE", "FOE", "FUM"))
        val e1 = intercept[TestFailedException] {
          fumList should (equal (toList) and newContain only ("FEE", "FIE", "FOE", "FUM"))
        }
        checkMessageStackDepth(e1, Resources("didNotEqual", decorateToStringValue(fumList), decorateToStringValue(toList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (equal (fumList) and (newContain only ("FEE", "FIE", "FOE", "FAM")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (equal (toList) and newContain only ("FEE", "FIE", "FOE", "FUM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (equal (toList) and newContain only ("FEE", "FIE", "FOE", "FAM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (equal (fumList) and newContain only ("FEE", "FIE", "FOE", "FUM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        (fumList should (equal (toList) and newContain only (" FEE ", " FIE ", " FOE ", " FUM "))) (decided by invertedListOfStringEquality, after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (legacyEqual (..) and contain only (..))` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (legacyEqual (fumList) and newContain only ("fie", "fee", "fum", "foe"))
        val e1 = intercept[TestFailedException] {
          fumList should (legacyEqual (toList) and newContain only ("fee", "fie", "foe", "fum"))
        }
        checkMessageStackDepth(e1, Resources("didNotEqual", decorateToStringValue(fumList), decorateToStringValue(toList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (legacyEqual (fumList) and newContain only ("happy", "birthday", "to", "you"))
        }
        checkMessageStackDepth(e2, Resources("equaled", decorateToStringValue(fumList), decorateToStringValue(fumList)) + ", but " + Resources("didNotContainOnlyElements", decorateToStringValue(fumList), "\"happy\", \"birthday\", \"to\", \"you\""), fileName, thisLineNumber - 2)
      }
      ...
      def `should use the implicit Equality in scope` {
        implicit val ise = upperCaseStringEquality
        fumList should (legacyEqual (fumList) and newContain only ("FEE", "FIE", "FOE", "FUM"))
        val e1 = intercept[TestFailedException] {
          fumList should (legacyEqual (toList) and newContain only ("FEE", "FIE", "FOE", "FUM"))
        }
        checkMessageStackDepth(e1, Resources("didNotEqual", decorateToStringValue(fumList), decorateToStringValue(toList)), fileName, thisLineNumber - 2)
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (legacyEqual (fumList) and newContain only ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (legacyEqual (fumList) and newContain only ("happy", "birthday", "to", "you"))) (decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (legacyEqual (toList) and newContain only ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality)
        }
        ...
        (fumList should (legacyEqual (fumList) and newContain only (" FEE ", " FIE ", " FOE ", " FUM "))) (after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (contain only (..) and legacyEqual (..))` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (newContain only ("fie", "fee", "fum", "foe") and legacyEqual (fumList))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain only ("fee", "fie", "foe", "fum") and legacyEqual (toList))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (newContain only ("happy", "birthday", "to", "you") and legacyEqual (fumList))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        fumList should (newContain only ("FIE", "FEE", "FUM", "FOE") and legacyEqual (fumList))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain only ("FIE", "FEE", "FAM", "FOE") and legacyEqual (toList))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (newContain only ("FIE", "FEE", "FUM", "FOE") and legacyEqual (fumList))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (newContain only ("FIE", "FEE", "FAM", "FOE") and legacyEqual (fumList))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, Resources("didNotContainOnlyElements", decorateToStringValue(fumList), "\"FIE\", \"FEE\", \"FAM\", \"FOE\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          (fumList should (newContain only ("FIE", "FEE", "FUM", "FOE") and legacyEqual (toList))) (decided by upperCaseStringEquality)
        }
        ...
        (fumList should (newContain only (" FEE ", " FIE ", " FOE ", " FUM ") and legacyEqual (fumList))) (after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (not contain only xx and not contain only xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not newContain only ("fee", "fie", "foe", "fuu") and not newContain only ("fie", "fee", "fuu", "foe"))
        val e1 = intercept[TestFailedException] {
          fumList should (not newContain only ("fee", "fie", "foe", "fum") and not newContain only ("happy", "birthday", "to", "you"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not newContain only ("happy", "birthday", "to", "you") and not newContain only ("fee", "fie", "foe", "fum"))
        }
      ...
      def `should use the implicit Equality in scope` {
        implicit val ise = upperCaseStringEquality
        fumList should (not newContain only ("FIE", "FEE", "FAM", "FOE") and not newContain only ("FIE", "FEE", "FOE", "FAM"))
        val e1 = intercept[TestFailedException] {
          fumList should (not newContain only ("FIE", "FEE", "FUM", "FOE") and not newContain only ("FIE", "FEE", "FOE", "FAM"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not newContain only ("FIE", "FEE", "FAM", "FOE") and (not newContain only ("FIE", "FEE", "FOE", "FUM")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not newContain only ("FIE", "FEE", "FAM", "FOE") and not newContain only ("FIE", "FEE", "FOE", "FAM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not newContain only ("FIE", "FEE", "FAM", "FOE") and not newContain only ("FIE", "FEE", "FOE", "FUM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not newContain only ("FIE", "FEE", "FUM", "FOE") and not newContain only ("FIE", "FEE", "FOE", "FAM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
    ...
    object `when used with (not equal (..) and not contain only (..))` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not equal (toList) and not newContain only ("fie", "fee", "fuu", "foe"))
        val e1 = intercept[TestFailedException] {
          fumList should (not equal (fumList) and not newContain only ("happy", "birthday", "to", "you"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not equal (toList) and not newContain only ("fee", "fie", "foe", "fum"))
        }
      ...
      def `should use the implicit Equality in scope` {
        implicit val ise = upperCaseStringEquality
        fumList should (not equal (toList) and not newContain only ("FIE", "FEE", "FAM", "FOE"))
        val e1 = intercept[TestFailedException] {
          fumList should (not equal (fumList) and not newContain only ("FIE", "FEE", "FAM", "FOE"))
        }
        checkMessageStackDepth(e1, Resources("equaled", decorateToStringValue(fumList), decorateToStringValue(fumList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (not equal (toList) and (not newContain only ("FIE", "FEE", "FUM", "FOE")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not equal (fumList) and not newContain only ("FIE", "FEE", "FAM", "FOE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not equal (fumList) and not newContain only ("FIE", "FEE", "FUM", "FOE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not equal (toList) and not newContain only ("FIE", "FEE", "FAM", "FOE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        (fumList should (not newContain only (" FEE ", " FIE ", " FOE ", " FUU ") and not newContain only (" FEE ", " FIE ", " FOE ", " FUU "))) (after being lowerCased and trimmed, after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (not be (..) and not contain only (..))` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not be (toList) and not newContain only ("fie", "fee", "fuu", "foe"))
        val e1 = intercept[TestFailedException] {
          fumList should (not be (fumList) and not newContain only ("happy", "birthday", "to", "you"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not be (toList) and not newContain only ("fee", "fie", "foe", "fum"))
        }
      ...
      def `should use the implicit Equality in scope` {
        implicit val ise = upperCaseStringEquality
        fumList should (not be (toList) and not newContain only ("FIE", "FEE", "FAM", "FOE"))
        val e1 = intercept[TestFailedException] {
          fumList should (not be (fumList) and not newContain only ("FIE", "FEE", "FAM", "FOE"))
        }
        checkMessageStackDepth(e1, Resources("wasEqualTo", decorateToStringValue(fumList), decorateToStringValue(fumList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (not be (toList) and (not newContain only ("FIE", "FEE", "FUM", "FOE")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not be (toList) and not newContain only ("FIE", "FEE", "FAM", "FOE"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not be (toList) and not newContain only ("FIE", "FEE", "FUM", "FOE"))) (decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not be (fumList) and not newContain only ("FIE", "FEE", "FAM", "FOE"))) (decided by upperCaseStringEquality)
        }
  ...
  object `col of Lists` {
    ...
    object `used with contain only xx and contain only xx` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (newContain only (3, 2, 1) and newContain only (1, 3, 2))
        atLeast (2, lists) should (newContain only (3, 1, 2) and newContain only (2, 3, 1))
        atMost (2, lists) should (newContain only (3, 1, 2) and newContain only (2, 3, 1))
        no (lists) should (newContain only (3, 6, 9) and newContain only (3, 4, 5))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (newContain only (1, 2, 3) and newContain only (1, 3, 2))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (list1s) should (newContain only (1, 2, 3) and newContain only (1, 3, 4))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (newContain only ("hi", "hello") and newContain only ("ho", "hey", "howdy"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (newContain only ("HELLO", "HI") and newContain only ("HI", "HELLO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (newContain only ("HO", "HELLO") and newContain only ("HI", "HELLO"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (hiLists) should (newContain only ("HELLO", "HI") and newContain only ("HO", "HELLO"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (newContain only ("HELLO", "HI") and newContain only ("HI", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (newContain only ("HO", "HELLO") and newContain only ("HI", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " did not contain only " + "(\"HO\", \"HELLO\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (newContain only ("HELLO", "HI") and newContain only ("HO", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " contained only " + "(\"HELLO\", \"HI\")" + ", but " + decorateToStringValue(List("hi", "hello")) + " did not contain only " + "(\"HO\", \"HELLO\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (be (..) and contain only (..))` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (be (List(3, 2, 1)) and newContain only (1, 3, 2))
        atLeast (2, lists) should (be (List(3, 2, 1)) and newContain only (1, 3, 2))
        atMost (2, lists) should (be (List(3, 2, 1)) and newContain only (2, 3, 1))
        no (lists) should (be (List(3, 6, 9)) and newContain only (3, 4, 5))
        no (nils) should (be (List(1, 6, 8)) and newContain only (1, 3, 4))
        no (listsNil) should (be (List(2, 6, 8)) and newContain only (3, 4, 5))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (be (List(3, 2, 1)) and newContain only (1, 3, 2))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (list1s) should (be (List(3, 2, 1)) and newContain only (2, 3, 8))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (nils) should (be (List("hey")) and newContain only ("hello", "hi"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (be (List("hi", "hello")) and newContain only ("ho", "hey", "howdy"))
        }
        ...
        val e5 = intercept[TestFailedException] {
          all (listsNil) should (be (List(3, 2, 1)) and newContain only (1, 3, 2))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (be (List("hi", "hello")) and newContain only ("HELLO", "HI"))
        ...
        val e2 = intercept[TestFailedException] {
          all (hiLists) should (be (List("hi", "hello")) and newContain only ("HO", "HELLO"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (be (List("hi", "hello")) and newContain only ("HELLO", "HI"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (be (List("HI", "HELLO")) and newContain only ("HELLO", "HI"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was not equal to " + decorateToStringValue(List("HI", "HELLO")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        ...
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (be (List("hi", "hello")) and newContain only ("HO", "HELLO"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was equal to " + decorateToStringValue(List("hi", "hello")) + ", but " + decorateToStringValue(List("hi", "hello")) + " did not contain only " + "(\"HO\", \"HELLO\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (not contain only xx and not contain only xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (not newContain only (3, 2, 8) and not newContain only (8, 3, 4))
        atLeast (2, lists) should (not newContain only (3, 8, 5) and not newContain only (8, 3, 4))
        atMost (2, lists) should (not newContain only (2, 4, 3) and newContain only (4, 3, 2))
        no (list1s) should (not newContain only (1, 2, 3) and not newContain only (1, 3, 2))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (not newContain only (2, 3, 4) and not newContain only (8, 3, 4))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (lists) should (not newContain only (3, 6, 8) and not newContain only (2, 3, 4))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not newContain only ("hello", "hi") and not newContain only ("ho", "hey", "howdy"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not newContain only ("ho", "hey", "howdy") and not newContain only ("hello", "hi"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (not newContain only ("HI") and not newContain only ("HO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (not newContain only ("HELLO", "HI") and not newContain only ("HO"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (hiLists) should (not newContain only ("HI") and not newContain only ("HELLO", "HI"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (not newContain only ("HI") and not newContain only ("HO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (not newContain only ("HELLO", "HI") and not newContain only ("HO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " contained only " + "(\"HELLO\", \"HI\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (not newContain only ("HI") and not newContain only ("HELLO", "HI"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " did not contain only " + "(\"HI\")" + ", but " + decorateToStringValue(List("hi", "hello")) + " contained only " + "(\"HELLO\", \"HI\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (not be (..) and not contain only (..))` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (not be (List(2)) and not newContain only (8, 3, 4))
        atLeast (2, lists) should (not be (List(3)) and not newContain only (8, 3, 4))
        atMost (2, lists) should (not be (List(4, 3, 2)) and not newContain only (3, 4, 2))
        no (list1s) should (not be (List(3, 2, 1)) and not newContain only (1, 2, 3))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (not be (List(4, 3, 2)) and not newContain only (8, 3, 4))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (lists) should (not be (List(3)) and not newContain only (2, 3, 4))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("hi", "hello")) and not newContain only ("ho", "hey", "howdy"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("ho")) and not newContain only ("hello", "hi"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (not be (List("ho")) and not newContain only ("HO", "HELLO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("hi", "hello")) and not newContain only ("HELLO", "HI"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("ho")) and not newContain only ("HI", "HELLO"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (not be (List("ho")) and not newContain only ("HO", "HELLO"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (not be (List("hi", "hello")) and not newContain only ("HELLO", "HI"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was equal to " + decorateToStringValue(List("hi", "hello")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (not be (List("ho")) and not newContain only ("HI", "HELLO"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was not equal to " + decorateToStringValue(List("ho")) + ", but " + decorateToStringValue(List("hi", "hello")) + " contained only " + "(\"HI\", \"HELLO\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
