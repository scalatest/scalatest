  ...
  object `NotWord ` {
    ...
    object `contain(ResultOfNoneOfApplication) method returns MatcherFactory1` {
      ...
      def `should have correct MatcherResult` {
        mr should have (
          'matches (false),
          'failureMessage (FailureMessages("didNotContainOneOfElements", lhs, UnquotedString("1, 2"))),
          'negatedFailureMessage (FailureMessages("containedOneOfElements", lhs, UnquotedString("1, 2"))),
          'midSentenceFailureMessage (FailureMessages("didNotContainOneOfElements", lhs, UnquotedString("1, 2"))),
          'midSentenceNegatedFailureMessage (FailureMessages("containedOneOfElements", lhs, UnquotedString("1, 2"))),
          'rawFailureMessage (FailureMessages("didNotContainOneOfElements")),
          'rawNegatedFailureMessage (FailureMessages("containedOneOfElements")),
          'rawMidSentenceFailureMessage (FailureMessages("didNotContainOneOfElements")),
          'rawMidSentenceNegatedFailureMessage (FailureMessages("containedOneOfElements")),
      ...
      def `should have correct negated MatcherResult` {
        nmr should have (
          'matches (true),
          'failureMessage (FailureMessages("containedOneOfElements", lhs, UnquotedString("1, 2"))),
          'negatedFailureMessage (FailureMessages("didNotContainOneOfElements", lhs, UnquotedString("1, 2"))),
          'midSentenceFailureMessage (FailureMessages("containedOneOfElements", lhs, UnquotedString("1, 2"))),
          'midSentenceNegatedFailureMessage (FailureMessages("didNotContainOneOfElements", lhs, UnquotedString("1, 2"))),
          'rawFailureMessage (FailureMessages("containedOneOfElements")),
          'rawNegatedFailureMessage (FailureMessages("didNotContainOneOfElements")),
          'rawMidSentenceFailureMessage (FailureMessages("containedOneOfElements")),
          'rawMidSentenceNegatedFailureMessage (FailureMessages("didNotContainOneOfElements")),
