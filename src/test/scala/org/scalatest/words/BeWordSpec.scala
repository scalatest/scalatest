...
class BeWordSpec extends Spec with FileMocks {
  ...
  object `BeWord ` {
    ...
    object `=== method returns Matcher` {
      ...
      def `should have correct MatcherResult` {
        mr should have (
          ...
          'negatedFailureMessage ("\"che[]se\" was equal to \"che[e]se\""),
          'midSentenceFailureMessage ("\"che[]se\" was not equal to \"che[e]se\""),
          'midSentenceNegatedFailureMessage ("\"che[]se\" was equal to \"che[e]se\""),
      ...
      def `should have correct negated MatcherResult` {
        nmr should have (
          'matches (true),
          'failureMessage ("\"che[]se\" was equal to \"che[e]se\""),
          'negatedFailureMessage ("\"che[]se\" was not equal to \"che[e]se\""),
          'midSentenceFailureMessage ("\"che[]se\" was equal to \"che[e]se\""),
    ...
    object `apply(Spread) method returns Matcher` {
      ...
      def `should have pretty toString` {
        mt.toString should be ("be " + spread)
      }
      ...
      def `should have correct MatcherResult` {
        mr should have (
          ...
          'failureMessageArgs(Vector(7.0, spread)),
          'negatedFailureMessageArgs(Vector(7.0, spread)),
          'midSentenceFailureMessageArgs(Vector(7.0, spread)),
          'midSentenceNegatedFailureMessageArgs(Vector(7.0, spread))    
        )
      }
    ...
    object `apply(ResultOfATypeInvocation) method returns Matcher` {
      ...
      def `should have correct MatcherResult` {
        mr should have (
          ...
          'failureMessageArgs(Vector(myFile, clazz)),
          'negatedFailureMessageArgs(Vector(myFile, clazz)),
          'midSentenceFailureMessageArgs(Vector(myFile, clazz)),
          'midSentenceNegatedFailureMessageArgs(Vector(myFile, clazz))    
        )
      }
