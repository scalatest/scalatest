...
class ListShouldContainInOrderLogicalAndSpec extends Spec with Matchers {
  ...
  object `a List` {
    ...
    object `when used with (contain inOrder xx and contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (newContain inOrder ("fum", "foe", "fie", "fee") and newContain inOrder ("fum", "foe", "fie", "fee"))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain inOrder ("fee", "fie", "foe", "fum") and newContain inOrder ("fum", "foe", "fie", "fee"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (newContain inOrder ("fum", "foe", "fie", "fee") and newContain inOrder ("fee", "fie", "foe", "fum"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (newContain inOrder ("FUM", "FOE", "FIE", "FEE") and newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (newContain inOrder ("FEE", "FIE", "FOE", "FUM") and newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, Resources("didNotContainAllOfElementsInOrder", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          (fumList should (newContain inOrder ("FUM", "FOE", "FIE", "FEE") and newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, Resources("containedAllOfElementsInOrder", decorateToStringValue(fumList), "\"FUM\", \"FOE\", \"FIE\", \"FEE\"") + ", but " + Resources("didNotContainAllOfElementsInOrder", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
        (fumList should (newContain inOrder (" FUM ", " FOE ", " FIE ", " FEE ") and newContain inOrder (" FUM ", " FOE ", " FIE ", " FEE "))) (after being lowerCased and trimmed, after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (equal xx and contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (equal (fumList) and newContain inOrder ("fum", "foe", "fie", "fee"))
        val e1 = intercept[TestFailedException] {
          fumList should (equal (toList) and newContain inOrder ("fum", "foe", "fie", "fee"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (equal (fumList) and newContain inOrder ("fee", "fie", "foe", "fum"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        checkMessageStackDepth(e1, Resources("didNotEqual", decorateToStringValue(fumList), decorateToStringValue(toList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (equal (fumList) and (newContain inOrder ("FEE", "FIE", "FOE", "FAM")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (equal (toList) and newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (equal (toList) and newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (equal (fumList) and newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        (fumList should (equal (toList) and newContain inOrder (" FUM ", " FOE ", " FIE ", " FEE "))) (decided by invertedListOfStringEquality, after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (legacyEqual xx and contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (legacyEqual (fumList) and newContain inOrder ("fum", "foe", "fie", "fee"))
        val e1 = intercept[TestFailedException] {
          fumList should (legacyEqual (toList) and newContain inOrder ("fum", "foe", "fie", "fee"))
        }
        checkMessageStackDepth(e1, Resources("didNotEqual", decorateToStringValue(fumList), decorateToStringValue(toList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (legacyEqual (fumList) and newContain inOrder ("fee", "fie", "foe", "fum"))
        }
        checkMessageStackDepth(e2, Resources("equaled", decorateToStringValue(fumList), decorateToStringValue(fumList)) + ", but " + Resources("didNotContainAllOfElementsInOrder", decorateToStringValue(fumList), "\"fee\", \"fie\", \"foe\", \"fum\""), fileName, thisLineNumber - 2)
      }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (legacyEqual (fumList) and newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (legacyEqual (fumList) and newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (legacyEqual (toList) and newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality)
        }
        ...
        (fumList should (legacyEqual (fumList) and newContain inOrder (" FUM ", " FOE ", " FIE ", " FEE "))) (after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (contain inOrder xx and legacyEqual xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (newContain inOrder ("fum", "foe", "fie", "fee") and legacyEqual (fumList))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain inOrder ("fum", "foe", "fie", "fee") and legacyEqual (toList))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (newContain inOrder ("fee", "fie", "foe", "fum") and legacyEqual (fumList))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        fumList should (newContain inOrder ("FUM", "FOE", "FIE", "FEE") and legacyEqual (fumList))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain inOrder ("FEE", "FIE", "FOE", "FUM") and legacyEqual (toList))
        }
        checkMessageStackDepth(e1, Resources("didNotContainAllOfElementsInOrder", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (newContain inOrder ("HAPPY", "BIRTHDAY", "TO", "YOU") and (legacyEqual (fumList)))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (newContain inOrder ("FUM", "FOE", "FIE", "FEE") and legacyEqual (fumList))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (newContain inOrder ("FEE", "FIE", "FOE", "FUM") and legacyEqual (fumList))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, Resources("didNotContainAllOfElementsInOrder", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          (fumList should (newContain inOrder ("FUM", "FOE", "FIE", "FEE") and legacyEqual (toList))) (decided by upperCaseStringEquality)
        }
        ...
        (fumList should (newContain inOrder (" FUM ", " FOE ", " FIE ", " FEE ") and legacyEqual (fumList))) (after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (not contain inOrder xx and not contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not newContain inOrder ("fee", "fie", "foe", "fum") and not newContain inOrder ("fee", "fie", "foe", "fum"))
        val e1 = intercept[TestFailedException] {
          fumList should (not newContain inOrder ("fum", "foe", "fie", "fee") and not newContain inOrder ("happy", "birthday", "to", "you"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not newContain inOrder ("fee", "fie", "foe", "fum") and not newContain inOrder ("fum", "foe", "fie", "fee"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        fumList should (not newContain inOrder ("FEE", "FIE", "FOE", "FUM") and not newContain inOrder ("FEE", "FIE", "FOE", "FUM"))
        val e1 = intercept[TestFailedException] {
          fumList should (not newContain inOrder ("FUM", "FOE", "FIE", "FEE") and not newContain inOrder ("FEE", "FIE", "FOE", "FUM"))
        }
        checkMessageStackDepth(e1, Resources("containedAllOfElementsInOrder", decorateToStringValue(fumList), "\"FUM\", \"FOE\", \"FIE\", \"FEE\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (not newContain inOrder ("FEE", "FIE", "FOE", "FUM") and (not newContain inOrder ("FUM", "FOE", "FIE", "FEE")))
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not newContain inOrder ("FEE", "FIE", "FOE", "FUM") and not newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not newContain inOrder ("FEE", "FIE", "FOE", "FUM") and not newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not newContain inOrder ("FUM", "FOE", "FIE", "FEE") and not newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
    ...
    object `when used with (not equal xx and not contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not equal (toList) and not newContain inOrder ("fee", "fie", "foe", "fum"))
        val e1 = intercept[TestFailedException] {
          fumList should (not equal (fumList) and not newContain inOrder ("fee", "fie", "foe", "fum"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not equal (toList) and not newContain inOrder ("fum", "foe", "fie", "fee"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not equal (fumList) and not newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not equal (fumList) and not newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not equal (toList) and not newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
    ...
    object `when used with (not be xx and not contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not be (toList) and not newContain inOrder ("fee", "fie", "foe", "fum"))
        val e1 = intercept[TestFailedException] {
          fumList should (not be (fumList) and not newContain inOrder ("fee", "fie", "foe", "fum"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not be (toList) and not newContain inOrder ("fum", "foe", "fie", "fee"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not be (toList) and not newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not be (toList) and not newContain inOrder ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not be (fumList) and not newContain inOrder ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality)
        }
        ...
        (fumList should (not newContain inOrder (" FEE ", " FIE ", " FOE ", " FUU ") and not newContain inOrder (" FEE ", " FIE ", " FOE ", " FUU "))) (after being lowerCased and trimmed, after being lowerCased and trimmed)
      }
    }
  }
  ...
  object `col of Lists` {
    ...
    object `used with contain inOrder xx and contain inOrder xx` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (newContain inOrder (1, 2, 3) and newContain inOrder (1, 2, 3))
        atLeast (2, lists) should (newContain inOrder (1, 2, 3) and newContain inOrder (1, 2, 3))
        atMost (2, lists) should (newContain inOrder (1, 2, 3) and newContain inOrder (1, 2, 3))
        no (lists) should (newContain inOrder (3, 6, 9) and newContain inOrder (3, 4, 5))
        no (nils) should (newContain inOrder (1, 2, 8) and newContain inOrder (1, 3, 4))
        no (listsNil) should (newContain inOrder (3, 8, 5) and newContain inOrder (3, 4, 5))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (newContain inOrder (1, 2, 3) and newContain inOrder (1, 2, 3))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (list1s) should (newContain inOrder (1, 2, 3) and newContain inOrder (1, 3, 4))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (nils) should (newContain inOrder ("hi", "hello") and newContain inOrder ("ho", "hey", "howdy"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (newContain inOrder ("hi", "hello") and newContain inOrder ("hello", "hi"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (newContain inOrder ("HI", "HELLO") and newContain inOrder ("HI", "HELLO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (newContain inOrder ("HO", "HELLO") and newContain inOrder ("HI", "HELLO"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (newContain inOrder ("HI", "HELLO") and newContain inOrder ("HI", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (newContain inOrder ("HO", "HELLO") and newContain inOrder ("HI", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(hiLists(0)) + " did not contain all of " + "(\"HO\", \"HELLO\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (newContain inOrder ("HI", "HELLO") and newContain inOrder ("HELLO", "HI"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(hiLists(0)) + " contained all of " + "(\"HI\", \"HELLO\")" + " in order" + ", but " + decorateToStringValue(hiLists(0)) + " did not contain all of " + "(\"HELLO\", \"HI\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (be xx and contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (be (List(0, 1, 2, 2, 3)) and newContain inOrder (1, 2, 3))
        atLeast (2, lists) should (be (List(0, 1, 2, 3, 3)) and newContain inOrder (1, 2, 3))
        atMost (2, lists) should (be (List(3, 2, 1)) and newContain inOrder (1, 2, 3))
        no (lists) should (be (List(3, 6, 9)) and newContain inOrder (3, 4, 5))
        no (nils) should (be (List(1, 6, 8)) and newContain inOrder (1, 3, 4))
        no (listsNil) should (be (List(2, 6, 8)) and newContain inOrder (3, 4, 5))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (be (List(0, 1, 2, 3, 3)) and newContain inOrder (1, 2, 3))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (list1s) should (be (List(0, 1, 2, 2, 3)) and newContain inOrder (2, 3, 8))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (nils) should (be (List("hey")) and newContain inOrder ("hi", "hello"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (be (List("he", "hi", "hello")) and newContain inOrder ("hello", "hi"))
        }
        ...
        val e5 = intercept[TestFailedException] {
          all (listsNil) should (be (List(0, 1, 2, 3)) and newContain inOrder (1, 2, 3))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (be (List("he", "hi", "hello")) and newContain inOrder ("HI", "HELLO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (be (List("HI", "HELLO")) and newContain inOrder ("HI", "HELLO"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (be (List("he", "hi", "hello")) and newContain inOrder ("HI", "HELLO"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (be (List("HI", "HELLO")) and newContain inOrder ("HI", "HELLO"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(hiLists(0)) + " was not equal to " + decorateToStringValue(List("HI", "HELLO")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (be (List("he", "hi", "hello")) and newContain inOrder ("HELLO", "HI"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(hiLists(0)) + " was equal to " + decorateToStringValue(List("he", "hi", "hello")) + ", but " + decorateToStringValue(hiLists(0)) + " did not contain all of " + "(\"HELLO\", \"HI\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (not contain inOrder xx and not contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (not newContain inOrder (3, 2, 8) and not newContain inOrder (8, 3, 4))
        atLeast (2, lists) should (not newContain inOrder (3, 8, 5) and not newContain inOrder (8, 3, 4))
        atMost (2, lists) should (not newContain inOrder (2, 4, 3) and newContain inOrder (2, 3, 4))
        no (list1s) should (not newContain inOrder (1, 2, 3) and not newContain inOrder (1, 2, 3))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (not newContain inOrder (2, 3, 4) and not newContain inOrder (8, 3, 4))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (lists) should (not newContain inOrder (3, 6, 8) and not newContain inOrder (2, 3, 4))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not newContain inOrder ("hi", "hello") and not newContain inOrder ("ho", "hey", "howdy"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not newContain inOrder ("ho", "hey", "howdy") and not newContain inOrder ("hi", "hello"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (not newContain inOrder ("HELLO", "HI") and not newContain inOrder ("HELLO", "HO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (not newContain inOrder ("HI", "HELLO") and not newContain inOrder ("HO"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (hiLists) should (not newContain inOrder ("HELLO", "HI") and not newContain inOrder ("HI", "HELLO"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (not newContain inOrder ("HELLO", "HI") and not newContain inOrder ("HELLO", "HO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (not newContain inOrder ("HI", "HELLO") and not newContain inOrder ("HO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(hiLists(0)) + " contained all of " + "(\"HI\", \"HELLO\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (not newContain inOrder ("HELLO", "HI") and not newContain inOrder ("HI", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(hiLists(0)) + " did not contain all of " + "(\"HELLO\", \"HI\")" + " in order" + ", but " + decorateToStringValue(hiLists(0)) + " contained all of " + "(\"HI\", \"HELLO\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (not be xx and not contain inOrder xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (not be (List(2)) and not newContain inOrder (8, 3, 4))
        atLeast (2, lists) should (not be (List(3)) and not newContain inOrder (8, 3, 4))
        atMost (2, lists) should (not be (List(8, 2, 3, 4)) and not newContain inOrder (2, 3, 4))
        no (list1s) should (not be (List(0, 1, 2, 2, 3)) and not newContain inOrder (1, 2, 3))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (not be (List(8, 2, 3, 4)) and not newContain inOrder (8, 3, 4))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (lists) should (not be (List(3)) and not newContain inOrder (2, 3, 4))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("he", "hi", "hello")) and not newContain inOrder ("ho", "hey", "howdy"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("ho")) and not newContain inOrder ("hi", "hello"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (not be (List("ho")) and not newContain inOrder ("HO", "HELLO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("he", "hi", "hello")) and not newContain inOrder ("HELLO", "HI"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (not be (List("ho")) and not newContain inOrder ("HO", "HELLO"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (not be (List("he", "hi", "hello")) and not newContain inOrder ("HELLO", "HI"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(hiLists(0)) + " was equal to " + decorateToStringValue(List("he", "hi", "hello")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (not be (List("ho")) and not newContain inOrder ("HI", "HELLO"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(hiLists(0)) + " was not equal to " + decorateToStringValue(List("ho")) + ", but " + decorateToStringValue(hiLists(0)) + " contained all of " + "(\"HI\", \"HELLO\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
