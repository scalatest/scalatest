  ...
  object `PartialFunction ` {
    ...
    object `should be definedAt` {
      ...
      def `should throw TestFailedException with correct stack depth when PartialFunction is not defined at the specified value` {
        ...
        assert(caught.message === Some("0 was not defined at " + fraction))
      ...
      def `should throw TestFailedException with correct stack depth when first expression in logical-and expression failed` {
        ...
        assert(caught1.message === Some("0 was not defined at " + fraction))
        ...
        assert(caught2.message === Some("0 was not defined at " + fraction))
        ...
        assert(caught3.message === Some("0 was not defined at " + fraction))
        ...
        assert(caught4.message === Some(fraction + " did not equal " + fraction2))
        ...
        assert(caught5.message === Some(fraction + " did not equal " + fraction2))
        ...
        assert(caught6.message === Some(fraction + " did not equal " + fraction2))
      ...
      def `should throw TestFailedException with correct stack depth when second expression in logical-and expression failed` {
        ...
        assert(caught1.message === Some("8 was defined at " + fraction + ", but 0 was not defined at " + fraction))
        assert(caught1.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught1.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught2.message === Some("8 was defined at " + fraction + ", but 0 was not defined at " + fraction))
        assert(caught2.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught2.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught3.message === Some("8 was defined at " + fraction + ", but 0 was not defined at " + fraction))
        assert(caught3.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught3.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught4.message === Some("8 was defined at " + fraction + ", but " + fraction + " did not equal " + fraction2))
        assert(caught4.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught4.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught5.message === Some("8 was defined at " + fraction + ", but " + fraction + " did not equal " + fraction2))
        assert(caught5.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught5.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught6.message === Some("8 was defined at " + fraction + ", but " + fraction + " did not equal " + fraction2))
        assert(caught6.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught6.failedCodeLineNumber === Some(thisLineNumber - 4))
      }
      ...
      def `should throw TestFailedException with correct stack depth when both expression in logical-or expression failed` {
        ...
        assert(caught1.message === Some("0 was not defined at " + fraction + ", and 0 was not defined at " + fraction))
        assert(caught1.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught1.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught2.message === Some("0 was not defined at " + fraction + ", and 0 was not defined at " + fraction))
        assert(caught2.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught2.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught3.message === Some("0 was not defined at " + fraction + ", and 0 was not defined at " + fraction))
        assert(caught3.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught3.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught4.message === Some("0 was not defined at " + fraction + ", and " + fraction + " did not equal " + fraction2))
        assert(caught4.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught4.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught5.message === Some(fraction + " did not equal " + fraction2 + ", and 0 was not defined at " + fraction))
        assert(caught5.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught5.failedCodeLineNumber === Some(thisLineNumber - 4))
      }
    }
    ...
    object `should not be definedAt` {
      ...
      def `should throw TestFailedException with correct stack depth when PartialFunction is defined at the specified value` {
        ...
        assert(caught.message === Some("8 was defined at " + fraction))
        assert(caught.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught.failedCodeLineNumber === Some(thisLineNumber - 4))
      }
      ...
      def `should throw TestFailedException with correct stack depth when first expression in logical-and expression failed` {
        ...
        assert(caught1.message === Some("8 was defined at " + fraction))
        assert(caught1.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught1.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught2.message === Some("8 was defined at " + fraction))
        assert(caught2.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught2.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught3.message === Some("8 was defined at " + fraction))
        assert(caught3.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught3.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught4.message === Some(fraction + " equaled " + fraction))
        assert(caught4.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught4.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught5.message === Some(fraction + " equaled " + fraction))
        assert(caught5.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught5.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught6.message === Some(fraction + " equaled " + fraction))
        assert(caught6.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught6.failedCodeLineNumber === Some(thisLineNumber - 4))
      }
      ...
      def `should throw TestFailedException with correct stack depth when second expression in logical-and expression failed` {
        ...
        assert(caught1.message === Some("0 was not defined at " + fraction + ", but 8 was defined at " + fraction))
        assert(caught1.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught1.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught2.message === Some("0 was not defined at " + fraction + ", but 8 was defined at " + fraction))
        assert(caught2.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught2.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught3.message === Some("0 was not defined at " + fraction + ", but 8 was defined at " + fraction))
        assert(caught3.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught3.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught4.message === Some("0 was not defined at " + fraction + ", but " + fraction + " equaled " + fraction))
        assert(caught4.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught4.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught5.message === Some("0 was not defined at " + fraction + ", but " + fraction + " equaled " + fraction))
        assert(caught5.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught5.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught6.message === Some("0 was not defined at " + fraction + ", but " + fraction + " equaled " + fraction))
        assert(caught6.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught6.failedCodeLineNumber === Some(thisLineNumber - 4))
      }
      ...
      def `should throw TestFailedException with correct stack depth when both expression in logical-or expression failed` {
        ...
        assert(caught1.message === Some("8 was defined at " + fraction + ", and 8 was defined at " + fraction))
        assert(caught1.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught1.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught2.message === Some("8 was defined at " + fraction + ", and 8 was defined at " + fraction))
        assert(caught2.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught2.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught3.message === Some("8 was defined at " + fraction + ", and 8 was defined at " + fraction))
        assert(caught3.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught3.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught4.message === Some("8 was defined at " + fraction + ", and " + fraction + " equaled " + fraction))
        assert(caught4.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught4.failedCodeLineNumber === Some(thisLineNumber - 4))
        ...
        assert(caught5.message === Some(fraction + " equaled " + fraction + ", and 8 was defined at " + fraction))
        assert(caught5.failedCodeFileName === Some("ShouldBeDefinedAtSpec.scala"))
        assert(caught5.failedCodeLineNumber === Some(thisLineNumber - 4))
      }
