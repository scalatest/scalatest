...
class NoneOfContainMatcherSpec extends Spec with Matchers {
  ...
  object `not noneOf ` {
    ...
    def `should succeed when left List contains element in right List` {
      List(1, 2, 3) should not contain newNoneOf (0, 2, 8)
      Array(1, 2, 3) should not contain newNoneOf (0, 2, 8)
      javaList(1, 2, 3) should not contain newNoneOf (0, 2, 8)
      
      Set(1, 2, 3) should not contain newNoneOf (0, 2, 8)
      javaSet(1, 2, 3) should not contain newNoneOf (0, 2, 8)
      
      Map(1 -> "one", 2 -> "two", 3 -> "three") should not contain newNoneOf (0 -> "zero", 2 -> "two", 8 -> "eight")
      javaMap(1 -> "one", 2 -> "two", 3 -> "three") should not contain newNoneOf (0 -> "zero", 2 -> "two", 8 -> "eight")
    }
    ...
    def `should work with ContainMatcher directly` {
      ...
      List(1, 2, 8) should not contain newNoneOf (0, 2, 8)
      Array(1, 2, 8) should not contain newNoneOf (0, 2, 8)
      Set(1, 2, 8) should not contain newNoneOf (0, 2, 8)
      
      javaList(1, 2, 8) should not contain newNoneOf (0, 2, 8)
      javaSet(1, 2, 8) should not contain newNoneOf (0, 2, 8)
      
      Map(1 -> "one", 2 -> "two", 8 -> "eight") should not contain mapMatcher
      Map(1 -> "one", 2 -> "two", 8 -> "eight") should not contain newNoneOf (0 -> "zero", 2 -> "two", 8 -> "eight")
      
      javaMap(1 -> "one", 2 -> "two", 8 -> "eight") should not contain mapMatcher
      javaMap(1 -> "one", 2 -> "two", 8 -> "eight") should not contain newNoneOf (0 -> "zero", 2 -> "two", 8 -> "eight")
    }
