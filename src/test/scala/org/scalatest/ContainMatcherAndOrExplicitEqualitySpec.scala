  ...
  object `ContainMatcher ` {
    ...
    object `when use with 'and'` {
      ...
      def `should pass when both contain passes` {
        ...
        left should ((contain theSameElementsAs (right1)) (equality) and (contain theSameIteratedElementsAs (right2)) (equality))
        ...
        left should ((contain theSameIteratedElementsAs (right2)) (equality) and (contain theSameElementsAs (right1)) (equality))
      ...
      def `should failed with correctly stack depth and message when first contain failed but second contain passed` {
        ...
        val e = intercept[exceptions.TestFailedException] {
          left should ((contain theSameIteratedElementsAs right) (equality) and (contain theSameElementsAs right) (equality)) 
        }
      ...
      def `should failed with correctly stack depth and message when first contain passed but second contain failed` {
        ...
        val e = intercept[exceptions.TestFailedException] {
          left should ((contain theSameElementsAs right) (equality) and (contain theSameIteratedElementsAs right) (equality)) 
        }
      ...
      def `should pass when not contain and contain passes` {
        ...
        left should (not contain theSameIteratedElementsAs (right1) (equality) and (contain theSameElementsAs (right2)) (equality))
      ...
      def `should pass when contain and not contain passes` {
        ...
        left should ((contain theSameElementsAs (right2)) (equality) and not contain theSameIteratedElementsAs (right1) (equality))
      ...
      def `should pass when not contain and not contain passes` {
        ...
        left should (not contain theSameElementsAs (right2) (equality) and not contain theSameIteratedElementsAs (right1) (equality))
      ...
      def `should failed with correctly stack depth and message when first contain passed but second not contain failed` {
        ...
        val e = intercept[exceptions.TestFailedException] {
          left should ((contain theSameElementsAs right1) (equality) and not contain theSameIteratedElementsAs (right2) (equality)) 
        }
      ...
      def `should failed with correctly stack depth and message when first not contain failed and second not contain failed` {
        ...
        val e = intercept[exceptions.TestFailedException] {
          left should (not contain theSameIteratedElementsAs (right1) (equality) and not contain theSameElementsAs (right2) (equality)) 
        }
        e.message should be (Some(left + " contained the same iterated elements as " + right1))
        e.failedCodeFileName should be (Some("ContainMatcherAndOrExplicitEqualitySpec.scala"))
        e.failedCodeLineNumber should be (Some(thisLineNumber - 4))
    ...
    object `when use with 'or'` {
      ...
      def `should pass when one of contain passes` {
        ...
        left should ((contain theSameElementsAs (right1)) (equality) or (contain theSameIteratedElementsAs (right2)) (equality))
        ...
        left should ((contain theSameIteratedElementsAs (right2)) (equality) or (contain theSameElementsAs (right1)) (equality))
      ...
      def `should pass when not contain and contain passes` {
        ...
        left should (not contain theSameIteratedElementsAs (right1) (equality) or (contain theSameElementsAs (right2)) (equality))
      ...
      def `should pass when contain and not contain passes` {
        ...
        left should ((contain theSameElementsAs (right2)) (equality) or not contain theSameIteratedElementsAs (right1) (equality))
      ...
      def `should pass when not contain and not contain passes` {
        ...
        left should (not contain theSameElementsAs (right2) (equality) or not contain theSameIteratedElementsAs (right1) (equality))
      ...
      def `should failed with correctly stack depth and message when first contain failed and second not contain failed` {
        ...
        val e = intercept[exceptions.TestFailedException] {
          left should ((contain theSameIteratedElementsAs (right)) (equality) or not contain theSameElementsAs (right) (equality)) 
        }
      ...
      def `should failed with correctly stack depth and message when first not contain failed and second not contain failed` {
        ...
        val e = intercept[exceptions.TestFailedException] {
          left should (not contain theSameIteratedElementsAs (right1) (equality) or not contain theSameElementsAs (right2) (equality)) 
        }
