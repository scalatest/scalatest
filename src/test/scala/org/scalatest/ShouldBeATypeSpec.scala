...
*/
    ...
    def `should do nothing if the property is false, when used with not` { pending
/*
...
*/
    ...
    def `should throw TestFailedException if the property is true, when used with not` { pending
/*
      val caught1 = intercept[TestFailedException] {
...
*/
    ...
    def `should do nothing if the the property returns true, when used in a logical-and expression` { pending
/*
...
*/
    ...
    def `should throw TestFailedException if at least one of the properties returns false, when used in a logical-and expression` { pending
/*
      // first false
      val caught1 = intercept[TestFailedException] {
...
*/
    ...
    def `should do nothing if the property returns true, when used in a logical-or expression` { pending
/*
      // second true
...
*/
    ...
    def `should throw TestFailedException if the both properties return false, when used in a logical-or expression` { pending
/*
      val caught1 = intercept[TestFailedException] {
...
*/
    ...
    def `should do nothing if the property returns false, when used in a logical-and expression with not` { pending
/*
...
*/
    ...
    def `should throw TestFailedException if at least one property returns false, when used in a logical-and expression with not` { pending
/*
      // second false
      val caught1 = intercept[TestFailedException] {
...
*/
    ...
    def `should do nothing if the property returns false, when used in a logical-or expression with not` { pending
/*
      // first true
...
*/
    ...
    def `should throw TestFailedException if both properties return false, when used in a logical-or expression with not` { pending
/*
      val caught1 = intercept[TestFailedException] {
