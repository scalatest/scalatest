...
class AllOfContainMatcherDeciderSpec extends Spec with Matchers with Explicitly with StringNormalizers {
  ...
  val javaMapIncremented: Normalizer[java.util.Map.Entry[Int, String]] = 
    new Normalizer[java.util.Map.Entry[Int, String]] {
      var count = 0
