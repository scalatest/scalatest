...
class ShouldContainNewValueSpec extends Spec with Matchers with Checkers with ReturnsNormallyThrowsAssertion {
  ...
  object `The 'contain value (Int)' syntax` {
    ...
    object `on scala.collection.immutable.Map` {
      ...
      def `should throw TestFailedException if map does not contain the specified value` {
        val caught1 = intercept[TestFailedException] {
          Map("one" -> 1, "two" -> 2) should contain newValue (3)
        }
      ...
      def `should throw TestFailedException if contains the specified value when used with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          Map("one" -> 1, "two" -> 2) should (not contain newValue (2))
        }
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-and expression` {
        ...
        val caught1 = intercept[TestFailedException] {
          Map("one" -> 1, "two" -> 2) should { contain newValue (5) and (contain newValue (2)) }
        }
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-or expression` {
        ...
        val caught1 = intercept[TestFailedException] {
          Map("one" -> 1, "two" -> 2) should { contain newValue (55) or (contain newValue (22)) }
        }
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-and expression with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          Map("one" -> 1, "two" -> 2) should { not { contain newValue (3) } and not { contain newValue (2) }}
        }
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-or expression with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          Map("one" -> 1, "two" -> 2) should { not { contain newValue (2) } or not { contain newValue (2) }}
        }
      ...
      def `should work on parallel form` {
        Map("one" -> 1, "two" -> 2).par should contain newValue (2)
      }
    }
    ...
    object `on scala.collection.mutable.Map` {
      ...
      def `should do nothing if map contains specified value` {
        mutable.Map("one" -> 1, "two" -> 2) should contain newValue (2)
        mutable.Map("one" -> 1, "two" -> 2) should (contain newValue (2))
        mutable.Map(1 -> "one", 2 -> "two") should contain newValue ("two")
      }

      def `should do nothing if map does not contain the specified value and used with not` {
        mutable.Map("one" -> 1, "two" -> 2) should not { contain newValue (3) }
        mutable.Map("one" -> 1, "two" -> 2) should not contain newValue (3)
        mutable.Map("one" -> 1, "two" -> 2) should (not contain newValue (3))
      }

      def `should do nothing when map contains specified value and used in a logical-and expression` {
        mutable.Map("one" -> 1, "two" -> 2) should { contain newValue (2) and (contain newValue (1)) }
        mutable.Map("one" -> 1, "two" -> 2) should ((contain newValue (2)) and (contain newValue (1)))
        mutable.Map("one" -> 1, "two" -> 2) should (contain newValue (2) and contain newValue (1))
      }

      def `should do nothing when map contains specified value and used in a logical-or expression` {
        mutable.Map("one" -> 1, "two" -> 2) should { contain newValue (7) or (contain newValue (1)) }
        mutable.Map("one" -> 1, "two" -> 2) should ((contain newValue (7)) or (contain newValue (1)))
        mutable.Map("one" -> 1, "two" -> 2) should (contain newValue (7) or contain newValue (1))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-and expression with not` {
        mutable.Map("one" -> 1, "two" -> 2) should { not { contain newValue (5) } and not { contain newValue (3) }}
        mutable.Map("one" -> 1, "two" -> 2) should ((not contain newValue (5)) and (not contain newValue (3)))
        mutable.Map("one" -> 1, "two" -> 2) should (not contain newValue (5) and not contain newValue (3))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-or expression with not` {
        mutable.Map("one" -> 1, "two" -> 2) should { not { contain newValue (2) } or not { contain newValue (3) }}
        mutable.Map("one" -> 1, "two" -> 2) should ((not contain newValue (2)) or (not contain newValue (3)))
        mutable.Map("one" -> 1, "two" -> 2) should (not contain newValue (2) or not contain newValue (3))
      }
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-and expression` {
        val map1 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught1 = intercept[TestFailedException] {
          map1 should { contain newValue (5) and (contain newValue (2)) }
        }
        assert(caught1.getMessage === map1 + " did not contain value 5")
        
        val map2 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught2 = intercept[TestFailedException] {
          map2 should ((contain newValue (5)) and (contain newValue (2)))
        }
        assert(caught2.getMessage === map2 + " did not contain value 5")
        
        val map3 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught3 = intercept[TestFailedException] {
          map3 should (contain newValue (5) and contain newValue (2))
        }
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-and expression with not` {
        val map1 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught1 = intercept[TestFailedException] {
          map1 should { not { contain newValue (3) } and not { contain newValue (2) }}
        }
        assert(caught1.getMessage === map1 + " did not contain value 3, but " + map1 + " contained value 2")
        
        val map2 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught2 = intercept[TestFailedException] {
          map2 should ((not contain newValue (3)) and (not contain newValue (2)))
        }
        assert(caught2.getMessage === map2 + " did not contain value 3, but " + map2 + " contained value 2")
        
        val map3 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught3 = intercept[TestFailedException] {
          map3 should (not contain newValue (3) and not contain newValue (2))
        }
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-or expression with not` {
        val map1 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught1 = intercept[TestFailedException] {
          map1 should { not { contain newValue (2) } or not { contain newValue (2) }}
        }
        assert(caught1.getMessage === map1 + " contained value 2, and " + map1 + " contained value 2")
        
        val map2 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught2 = intercept[TestFailedException] {
          map2 should ((not contain newValue (2)) or (not contain newValue (2)))
        }
        assert(caught2.getMessage === map2 + " contained value 2, and " + map2 + " contained value 2")
        
        val map3 = mutable.Map("one" -> 1, "two" -> 2) 
        val caught3 = intercept[TestFailedException] {
          map3 should (not contain newValue (2) or not contain newValue (2))
        }
        assert(caught3.getMessage === map3 + " contained value 2, and " + map3 + " contained value 2")
      }

      def `should work on parallel form` {
        mutable.Map("one" -> 1, "two" -> 2).par should contain newValue (2)
      }
    }
    ...
    object `on scala.collection.Map` {
      ...
      def `should do nothing if map contains specified value` {
        map should contain newValue (2)
        map should (contain newValue (2))
      }

      def `should do nothing if map does not contain the specified value and used with not` {
        map should not { contain newValue (3) }
        map should not contain newValue (3)
        map should (not contain newValue (3))
      }

      def `should do nothing when map contains specified value and used in a logical-and expression` {
        map should { contain newValue (2) and (contain newValue (1)) }
        map should ((contain newValue (2)) and (contain newValue (1)))
        map should (contain newValue (2) and contain newValue (1))
      }

      def `should do nothing when map contains specified value and used in a logical-or expression` {
        map should { contain newValue (7) or (contain newValue (1)) }
        map should ((contain newValue (7)) or (contain newValue (1)))
        map should (contain newValue (7) or contain newValue (1))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-and expression with not` {
        map should { not { contain newValue (5) } and not { contain newValue (3) }}
        map should ((not contain newValue (5)) and (not contain newValue (3)))
        map should (not contain newValue (5) and not contain newValue (3))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-or expression with not` {
        map should { not { contain newValue (2) } or not { contain newValue (3) }}
        map should ((not contain newValue (2)) or (not contain newValue (3)))
        map should (not contain newValue (2) or not contain newValue (3))
      }
      ...
      def `should throw TestFailedException if contains the specified value when used with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          map should (not contain newValue (2))
        }
        assert(caught1.getMessage === "Map(one -> 1, two -> 2) contained value 2")
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-and expression` {
        ...
        val caught1 = intercept[TestFailedException] {
          map should { contain newValue (5) and (contain newValue (2)) }
        }
        assert(caught1.getMessage === "Map(one -> 1, two -> 2) did not contain value 5")
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-or expression` {
        ...
        val caught1 = intercept[TestFailedException] {
          map should { contain newValue (55) or (contain newValue (22)) }
        }
        assert(caught1.getMessage === "Map(one -> 1, two -> 2) did not contain value 55, and Map(one -> 1, two -> 2) did not contain value 22")
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-and expression with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          map should { not { contain newValue (3) } and not { contain newValue (2) }}
        }
        assert(caught1.getMessage === "Map(one -> 1, two -> 2) did not contain value 3, but Map(one -> 1, two -> 2) contained value 2")
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-or expression with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          map should { not { contain newValue (2) } or not { contain newValue (2) }}
        }
        assert(caught1.getMessage === "Map(one -> 1, two -> 2) contained value 2, and Map(one -> 1, two -> 2) contained value 2")
      ...
      def `should work on parallel form` {
        map.par should contain newValue (2)
      }
    }
    ...
    object `on scala.collection.immutable.HashMap` {
      ...
      def `should do nothing if map contains specified value` {
        HashMap("one" -> 1, "two" -> 2) should contain newValue (2)
        HashMap("one" -> 1, "two" -> 2) should (contain newValue (2))
        HashMap(1 -> "one", 2 -> "two") should contain newValue ("two")
      }

      def `should do nothing if map does not contain the specified value and used with not` {
        HashMap("one" -> 1, "two" -> 2) should not { contain newValue (3) }
        HashMap("one" -> 1, "two" -> 2) should not contain newValue (3)
        HashMap("one" -> 1, "two" -> 2) should (not contain newValue (3))
      }

      def `should do nothing when map contains specified value and used in a logical-and expression` {
        HashMap("one" -> 1, "two" -> 2) should { contain newValue (2) and (contain newValue (1)) }
        HashMap("one" -> 1, "two" -> 2) should ((contain newValue (2)) and (contain newValue (1)))
        HashMap("one" -> 1, "two" -> 2) should (contain newValue (2) and contain newValue (1))
      }

      def `should do nothing when map contains specified value and used in a logical-or expression` {
        HashMap("one" -> 1, "two" -> 2) should { contain newValue (7) or (contain newValue (1)) }
        HashMap("one" -> 1, "two" -> 2) should ((contain newValue (7)) or (contain newValue (1)))
        HashMap("one" -> 1, "two" -> 2) should (contain newValue (7) or contain newValue (1))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-and expression with not` {
        HashMap("one" -> 1, "two" -> 2) should { not { contain newValue (5) } and not { contain newValue (3) }}
        HashMap("one" -> 1, "two" -> 2) should ((not contain newValue (5)) and (not contain newValue (3)))
        HashMap("one" -> 1, "two" -> 2) should (not contain newValue (5) and not contain newValue (3))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-or expression with not` {
        HashMap("one" -> 1, "two" -> 2) should { not { contain newValue (2) } or not { contain newValue (3) }}
        HashMap("one" -> 1, "two" -> 2) should ((not contain newValue (2)) or (not contain newValue (3)))
        HashMap("one" -> 1, "two" -> 2) should (not contain newValue (2) or not contain newValue (3))
      }
      ...
      def `should throw TestFailedException if map does not contain the specified value` {
        val caught1 = intercept[TestFailedException] {
          HashMap("one" -> 1, "two" -> 2) should contain newValue (3)
        }
        //assert(caught1.getMessage === "Map(one -> 1, two -> 2) did not contain value 3")
      ...
      def `should throw TestFailedException if contains the specified value when used with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          HashMap("one" -> 1, "two" -> 2) should (not contain newValue (2))
        }
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-and expression` {
        ...
        val caught1 = intercept[TestFailedException] {
          HashMap("one" -> 1, "two" -> 2) should { contain newValue (5) and (contain newValue (2)) }
        }
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-or expression` {
        ...
        val caught1 = intercept[TestFailedException] {
          HashMap("one" -> 1, "two" -> 2) should { contain newValue (55) or (contain newValue (22)) }
        }
        //assert(caught1.getMessage === "Map(one -> 1, two -> 2) did not contain value 55, and Map(one -> 1, two -> 2) did not contain value 22")
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-and expression with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          HashMap("one" -> 1, "two" -> 2) should { not { contain newValue (3) } and not { contain newValue (2) }}
        }
        //assert(caught1.getMessage === "Map(one -> 1, two -> 2) did not contain value 3, but Map(one -> 1, two -> 2) contained value 2")
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-or expression with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          HashMap("one" -> 1, "two" -> 2) should { not { contain newValue (2) } or not { contain newValue (2) }}
        }
        //assert(caught1.getMessage === "Map(one -> 1, two -> 2) contained value 2, and Map(one -> 1, two -> 2) contained value 2")
      ...
      def `should work on parallel form` {
        HashMap("one" -> 1, "two" -> 2).par should contain newValue (2)
      }
    }
    ...
    object `on scala.collection.mutable.HashMap` {
      ...
      def `should do nothing if map contains specified value` {
        mutable.HashMap("one" -> 1, "two" -> 2) should contain newValue (2)
        mutable.HashMap("one" -> 1, "two" -> 2) should (contain newValue (2))
        mutable.HashMap(1 -> "one", 2 -> "two") should contain newValue ("two")
      }

      def `should do nothing if map does not contain the specified value and used with not` {
        mutable.HashMap("one" -> 1, "two" -> 2) should not { contain newValue (3) }
        mutable.HashMap("one" -> 1, "two" -> 2) should not contain newValue (3)
        mutable.HashMap("one" -> 1, "two" -> 2) should (not contain newValue (3))
      }

      def `should do nothing when map contains specified value and used in a logical-and expression` {
        mutable.HashMap("one" -> 1, "two" -> 2) should { contain newValue (2) and (contain newValue (1)) }
        mutable.HashMap("one" -> 1, "two" -> 2) should ((contain newValue (2)) and (contain newValue (1)))
        mutable.HashMap("one" -> 1, "two" -> 2) should (contain newValue (2) and contain newValue (1))
      }

      def `should do nothing when map contains specified value and used in a logical-or expression` {
        mutable.HashMap("one" -> 1, "two" -> 2) should { contain newValue (7) or (contain newValue (1)) }
        mutable.HashMap("one" -> 1, "two" -> 2) should ((contain newValue (7)) or (contain newValue (1)))
        mutable.HashMap("one" -> 1, "two" -> 2) should (contain newValue (7) or contain newValue (1))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-and expression with not` {
        mutable.HashMap("one" -> 1, "two" -> 2) should { not { contain newValue (5) } and not { contain newValue (3) }}
        mutable.HashMap("one" -> 1, "two" -> 2) should ((not contain newValue (5)) and (not contain newValue (3)))
        mutable.HashMap("one" -> 1, "two" -> 2) should (not contain newValue (5) and not contain newValue (3))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-or expression with not` {
        mutable.HashMap("one" -> 1, "two" -> 2) should { not { contain newValue (2) } or not { contain newValue (3) }}
        mutable.HashMap("one" -> 1, "two" -> 2) should ((not contain newValue (2)) or (not contain newValue (3)))
        mutable.HashMap("one" -> 1, "two" -> 2) should (not contain newValue (2) or not contain newValue (3))
      }
      ...
      def `should work on parallel form` {
        mutable.HashMap("one" -> 1, "two" -> 2).par should contain newValue (2)
      }
    }
    ...
    object `on java.util.Map` {
      ...
      def `should do nothing if map contains specified value` {
        javaMap should contain newValue (2)
        javaMap should (contain newValue (2))
      }

      def `should do nothing if map does not contain the specified value and used with not` {
        javaMap should not { contain newValue (3) }
        javaMap should not contain newValue (3)
        javaMap should (not contain newValue (3))
      }

      def `should do nothing when map contains specified value and used in a logical-and expression` {
        javaMap should { contain newValue (2) and (contain newValue (1)) }
        javaMap should ((contain newValue (2)) and (contain newValue (1)))
        javaMap should (contain newValue (2) and contain newValue (1))
      }

      def `should do nothing when map contains specified value and used in a logical-or expression` {
        javaMap should { contain newValue (9) or (contain newValue (1)) }
        javaMap should ((contain newValue (9)) or (contain newValue (1)))
        javaMap should (contain newValue (9) or contain newValue (1))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-and expression with not` {
        javaMap should { not { contain newValue (5) } and not { contain newValue (3) }}
        javaMap should ((not contain newValue (5)) and (not contain newValue (3)))
        javaMap should (not contain newValue (5) and not contain newValue (3))
      }

      def `should do nothing when map does not contain the specified value and used in a logical-or expression with not` {
        javaMap should { not { contain newValue (2) } or not { contain newValue (3) }}
        javaMap should ((not contain newValue (2)) or (not contain newValue (3)))
        javaMap should (not contain newValue (2) or not contain newValue (3))
      }
      ...
      def `should throw TestFailedException if map does not contain the specified value` {
        val caught1 = intercept[TestFailedException] {
          javaMap should contain newValue (3)
        }
      ...
      def `should throw TestFailedException if contains the specified value when used with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          javaMap should (not contain newValue (2))
        }
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-and expression` {
        ...
        val caught1 = intercept[TestFailedException] {
          javaMap should { contain newValue (5) and (contain newValue (2)) }
        }
      ...
      def `should throw an TestFailedException when map doesn't contain specified value and used in a logical-or expression` {
        ...
        val caught1 = intercept[TestFailedException] {
          javaMap should { contain newValue (55) or (contain newValue (22)) }
        }
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-and expression with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          javaMap should { not { contain newValue (3) } and not { contain newValue (2) }}
        }
      ...
      def `should throw an TestFailedException when map contains specified value and used in a logical-or expression with not` {
        ...
        val caught1 = intercept[TestFailedException] {
          javaMap should { not { contain newValue (2) } or not { contain newValue (2) }}
        }
