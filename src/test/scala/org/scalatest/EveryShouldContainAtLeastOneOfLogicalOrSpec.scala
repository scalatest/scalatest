...
class EveryShouldContainAtLeastOneOfLogicalOrSpec extends FreeSpec with Matchers {
  ...
  "every of Everys" - {
    ...
    "when used with (contain oneOf (..) and contain oneOf (..)) syntax" - {
      ...
      "should do nothing if valid, else throw a TFE with an appropriate error message" in {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(One(2)) + " did not contain at least one of (6, 7, 8), and " + decorateToStringValue(One(2)) + " did not contain at least one of (1, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
      }
      ...
      "should use the implicit Equality in scope" in {
        ...
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(One("hi")) + " did not contain at least one of (\"hi\", \"he\"), and " + decorateToStringValue(One("hi")) + " did not contain at least one of (\"hi\", \"he\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    ...
    "when used with (not contain oneOf (..) and not contain oneOf (..))" - {
      ...
      "should do nothing if valid, else throw a TFE with an appropriate error message" in {
        ...
        checkMessageStackDepth(e1, allErrMsg(2, decorateToStringValue(One(2)) + " contained at least one of (2, 6, 8), and " + decorateToStringValue(One(2)) + " contained at least one of (2, 3, 4)", thisLineNumber - 2, lists), fileName, thisLineNumber - 2)
      }
      ...
      "should use the implicit Equality in scope" in {
        ...
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(One("hi")) + " contained at least one of (\"HI\", \"HE\"), and " + decorateToStringValue(One("hi")) + " contained at least one of (\"HI\", \"HE\")", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
