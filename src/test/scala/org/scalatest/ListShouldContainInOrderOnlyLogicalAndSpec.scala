...
class ListShouldContainInOrderOnlyLogicalAndSpec extends Spec with Matchers {
  ...
  object `a List` {
    ...
    object `when used with (contain inOrderOnly xx and contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (newContain inOrderOnly ("fum", "foe", "fie", "fee") and newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain inOrderOnly ("fee", "fie", "foe", "fum") and newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (newContain inOrderOnly ("fum", "foe", "fie", "fee") and newContain inOrderOnly ("fee", "fie", "foe", "fum"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE") and newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM") and newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, Resources("didNotContainInOrderOnlyElements", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          (fumList should (newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE") and newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, Resources("containedInOrderOnlyElements", decorateToStringValue(fumList), "\"FUM\", \"FOE\", \"FIE\", \"FEE\"") + ", but " + Resources("didNotContainInOrderOnlyElements", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
        (fumList should (newContain inOrderOnly (" FUM ", " FOE ", " FIE ", " FEE ") and newContain inOrderOnly (" FUM ", " FOE ", " FIE ", " FEE "))) (after being lowerCased and trimmed, after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (equal xx and contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (equal (fumList) and newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        val e1 = intercept[TestFailedException] {
          fumList should (equal (toList) and newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (equal (fumList) and newContain inOrderOnly ("fee", "fie", "foe", "fum"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        checkMessageStackDepth(e1, Resources("didNotEqual", decorateToStringValue(fumList), decorateToStringValue(toList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (equal (fumList) and (newContain inOrderOnly ("FEE", "FIE", "FOE", "FAM")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (equal (toList) and newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (equal (toList) and newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (equal (fumList) and newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        (fumList should (equal (toList) and newContain inOrderOnly (" FUM ", " FOE ", " FIE ", " FEE "))) (decided by invertedListOfStringEquality, after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (legacyEqual xx and contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (legacyEqual (fumList) and newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        val e1 = intercept[TestFailedException] {
          fumList should (legacyEqual (toList) and newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        }
        checkMessageStackDepth(e1, Resources("didNotEqual", decorateToStringValue(fumList), decorateToStringValue(toList)), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (legacyEqual (fumList) and newContain inOrderOnly ("fee", "fie", "foe", "fum"))
        }
        checkMessageStackDepth(e2, Resources("equaled", decorateToStringValue(fumList), decorateToStringValue(fumList)) + ", but " + Resources("didNotContainInOrderOnlyElements", decorateToStringValue(fumList), "\"fee\", \"fie\", \"foe\", \"fum\""), fileName, thisLineNumber - 2)
      }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (legacyEqual (fumList) and newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (legacyEqual (fumList) and newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (legacyEqual (toList) and newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality)
        }
        ...
        (fumList should (legacyEqual (fumList) and newContain inOrderOnly (" FUM ", " FOE ", " FIE ", " FEE "))) (after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (contain inOrderOnly xx and legacyEqual xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (newContain inOrderOnly ("fum", "foe", "fie", "fee") and legacyEqual (fumList))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain inOrderOnly ("fum", "foe", "fie", "fee") and legacyEqual (toList))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (newContain inOrderOnly ("fee", "fie", "foe", "fum") and legacyEqual (fumList))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        fumList should (newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE") and legacyEqual (fumList))
        val e1 = intercept[TestFailedException] {
          fumList should (newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM") and legacyEqual (toList))
        }
        checkMessageStackDepth(e1, Resources("didNotContainInOrderOnlyElements", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (newContain inOrderOnly ("HAPPY", "BIRTHDAY", "TO", "YOU") and (legacyEqual (fumList)))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE") and legacyEqual (fumList))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM") and legacyEqual (fumList))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, Resources("didNotContainInOrderOnlyElements", decorateToStringValue(fumList), "\"FEE\", \"FIE\", \"FOE\", \"FUM\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          (fumList should (newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE") and legacyEqual (toList))) (decided by upperCaseStringEquality)
        }
        ...
        (fumList should (newContain inOrderOnly (" FUM ", " FOE ", " FIE ", " FEE ") and legacyEqual (fumList))) (after being lowerCased and trimmed)
      }
    }
    ...
    object `when used with (not contain inOrderOnly xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not newContain inOrderOnly ("fee", "fie", "foe", "fum") and not newContain inOrderOnly ("fee", "fie", "foe", "fum"))
        val e1 = intercept[TestFailedException] {
          fumList should (not newContain inOrderOnly ("fum", "foe", "fie", "fee") and not newContain inOrderOnly ("happy", "birthday", "to", "you"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not newContain inOrderOnly ("fee", "fie", "foe", "fum") and not newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        fumList should (not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM") and not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))
        val e1 = intercept[TestFailedException] {
          fumList should (not newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE") and not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))
        }
        checkMessageStackDepth(e1, Resources("containedInOrderOnlyElements", decorateToStringValue(fumList), "\"FUM\", \"FOE\", \"FIE\", \"FEE\""), fileName, thisLineNumber - 2)
        val e2 = intercept[TestFailedException] {
          fumList should (not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM") and (not newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE")))
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM") and not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM") and not newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE") and not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
    ...
    object `when used with (not equal xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not equal (toList) and not newContain inOrderOnly ("fee", "fie", "foe", "fum"))
        val e1 = intercept[TestFailedException] {
          fumList should (not equal (fumList) and not newContain inOrderOnly ("fee", "fie", "foe", "fum"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not equal (toList) and not newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not equal (fumList) and not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not equal (fumList) and not newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not equal (toList) and not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        }
    ...
    object `when used with (not be xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not be (toList) and not newContain inOrderOnly ("fee", "fie", "foe", "fum"))
        val e1 = intercept[TestFailedException] {
          fumList should (not be (fumList) and not newContain inOrderOnly ("fee", "fie", "foe", "fum"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          fumList should (not be (toList) and not newContain inOrderOnly ("fum", "foe", "fie", "fee"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not be (toList) and not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (fumList should (not be (toList) and not newContain inOrderOnly ("FUM", "FOE", "FIE", "FEE"))) (decided by upperCaseStringEquality)
        }
        ...
        val e2 = intercept[TestFailedException] {
          (fumList should (not be (fumList) and not newContain inOrderOnly ("FEE", "FIE", "FOE", "FUM"))) (decided by upperCaseStringEquality)
        }
        ...
        (fumList should (not newContain inOrderOnly (" FEE ", " FIE ", " FOE ", " FUU ") and not newContain inOrderOnly (" FEE ", " FIE ", " FOE ", " FUU "))) (after being lowerCased and trimmed, after being lowerCased and trimmed)
      }
    }
  }
  ...
  object `col of Lists` {
    ...
    object `used with contain inOrderOnly xx and contain inOrderOnly xx` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (newContain inOrderOnly (1, 2, 3) and newContain inOrderOnly (1, 2, 3))
        atLeast (2, lists) should (newContain inOrderOnly (1, 2, 3) and newContain inOrderOnly (1, 2, 3))
        atMost (2, lists) should (newContain inOrderOnly (1, 2, 3) and newContain inOrderOnly (1, 2, 3))
        no (lists) should (newContain inOrderOnly (3, 6, 9) and newContain inOrderOnly (3, 4, 5))
        no (nils) should (newContain inOrderOnly (1, 2, 8) and newContain inOrderOnly (1, 3, 4))
        no (listsNil) should (newContain inOrderOnly (3, 8, 5) and newContain inOrderOnly (3, 4, 5))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (newContain inOrderOnly (1, 2, 3) and newContain inOrderOnly (1, 2, 3))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (list1s) should (newContain inOrderOnly (1, 2, 3) and newContain inOrderOnly (1, 3, 4))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (nils) should (newContain inOrderOnly ("hi", "hello") and newContain inOrderOnly ("ho", "hey", "howdy"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (newContain inOrderOnly ("hi", "hello") and newContain inOrderOnly ("hello", "hi"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (newContain inOrderOnly ("HI", "HELLO") and newContain inOrderOnly ("HI", "HELLO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (newContain inOrderOnly ("HO", "HELLO") and newContain inOrderOnly ("HI", "HELLO"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (newContain inOrderOnly ("HI", "HELLO") and newContain inOrderOnly ("HI", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (newContain inOrderOnly ("HO", "HELLO") and newContain inOrderOnly ("HI", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " did not contain only " + "(\"HO\", \"HELLO\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (newContain inOrderOnly ("HI", "HELLO") and newContain inOrderOnly ("HELLO", "HI"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " contained only " + "(\"HI\", \"HELLO\")" + " in order" + ", but " + decorateToStringValue(List("hi", "hello")) + " did not contain only " + "(\"HELLO\", \"HI\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (be xx and contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (be (List(1, 2, 2, 3)) and newContain inOrderOnly (1, 2, 3))
        atLeast (2, lists) should (be (List(1, 2, 3, 3)) and newContain inOrderOnly (1, 2, 3))
        atMost (2, lists) should (be (List(3, 2, 1)) and newContain inOrderOnly (1, 2, 3))
        no (lists) should (be (List(3, 6, 9)) and newContain inOrderOnly (3, 4, 5))
        no (nils) should (be (List(1, 6, 8)) and newContain inOrderOnly (1, 3, 4))
        no (listsNil) should (be (List(2, 6, 8)) and newContain inOrderOnly (3, 4, 5))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (be (List(1, 2, 3, 3)) and newContain inOrderOnly (1, 2, 3))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (list1s) should (be (List(1, 2, 2, 3)) and newContain inOrderOnly (2, 3, 8))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (nils) should (be (List("hey")) and newContain inOrderOnly ("hi", "hello"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (be (List("hi", "hello")) and newContain inOrderOnly ("hello", "hi"))
        }
        ...
        val e5 = intercept[TestFailedException] {
          all (listsNil) should (be (List(1, 2, 3)) and newContain inOrderOnly (1, 2, 3))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (be (List("hi", "hello")) and newContain inOrderOnly ("HI", "HELLO"))
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (be (List("hi", "hello")) and newContain inOrderOnly ("HI", "HELLO"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (be (List("HI", "HELLO")) and newContain inOrderOnly ("HI", "HELLO"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was not equal to " + decorateToStringValue(List("HI", "HELLO")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        ...
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (be (List("hi", "hello")) and newContain inOrderOnly ("HELLO", "HI"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was equal to " + decorateToStringValue(List("hi", "hello")) + ", but " + decorateToStringValue(List("hi", "hello")) + " did not contain only " + "(\"HELLO\", \"HI\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (not contain inOrderOnly xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (not newContain inOrderOnly (3, 2, 8) and not newContain inOrderOnly (8, 3, 4))
        atLeast (2, lists) should (not newContain inOrderOnly (3, 8, 5) and not newContain inOrderOnly (8, 3, 4))
        atMost (2, lists) should (not newContain inOrderOnly (2, 4, 3) and newContain inOrderOnly (2, 3, 4))
        no (list1s) should (not newContain inOrderOnly (1, 2, 3) and not newContain inOrderOnly (1, 2, 3))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (not newContain inOrderOnly (2, 3, 4) and not newContain inOrderOnly (8, 3, 4))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (lists) should (not newContain inOrderOnly (3, 6, 8) and not newContain inOrderOnly (2, 3, 4))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not newContain inOrderOnly ("hi", "hello") and not newContain inOrderOnly ("ho", "hey", "howdy"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not newContain inOrderOnly ("ho", "hey", "howdy") and not newContain inOrderOnly ("hi", "hello"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (not newContain inOrderOnly ("HELLO", "HI") and not newContain inOrderOnly ("HELLO", "HO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (not newContain inOrderOnly ("HI", "HELLO") and not newContain inOrderOnly ("HO"))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (hiLists) should (not newContain inOrderOnly ("HELLO", "HI") and not newContain inOrderOnly ("HI", "HELLO"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (not newContain inOrderOnly ("HELLO", "HI") and not newContain inOrderOnly ("HELLO", "HO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (not newContain inOrderOnly ("HI", "HELLO") and not newContain inOrderOnly ("HO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " contained only " + "(\"HI\", \"HELLO\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (not newContain inOrderOnly ("HELLO", "HI") and not newContain inOrderOnly ("HI", "HELLO"))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " did not contain only " + "(\"HELLO\", \"HI\")" + " in order" + ", but " + decorateToStringValue(List("hi", "hello")) + " contained only " + "(\"HI\", \"HELLO\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
    ...
    object `when used with (not be xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (not be (List(2)) and not newContain inOrderOnly (8, 3, 4))
        atLeast (2, lists) should (not be (List(3)) and not newContain inOrderOnly (8, 3, 4))
        atMost (2, lists) should (not be (List(2, 3, 4)) and not newContain inOrderOnly (2, 3, 4))
        no (list1s) should (not be (List(1, 2, 2, 3)) and not newContain inOrderOnly (1, 2, 3))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (not be (List(2, 3, 4)) and not newContain inOrderOnly (8, 3, 4))
        }
        ...
        val e2 = intercept[TestFailedException] {
          all (lists) should (not be (List(3)) and not newContain inOrderOnly (2, 3, 4))
        }
        ...
        val e3 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("hi", "hello")) and not newContain inOrderOnly ("ho", "hey", "howdy"))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("ho")) and not newContain inOrderOnly ("hi", "hello"))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (not be (List("ho")) and not newContain inOrderOnly ("HO", "HELLO"))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("hi", "hello")) and not newContain inOrderOnly ("HELLO", "HI"))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (not be (List("ho")) and not newContain inOrderOnly ("HO", "HELLO"))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (not be (List("hi", "hello")) and not newContain inOrderOnly ("HELLO", "HI"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was equal to " + decorateToStringValue(List("hi", "hello")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (not be (List("ho")) and not newContain inOrderOnly ("HI", "HELLO"))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was not equal to " + decorateToStringValue(List("ho")) + ", but " + decorateToStringValue(List("hi", "hello")) + " contained only " + "(\"HI\", \"HELLO\")" + " in order", thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
