...
/*
    ...
    object `when used with (not contain inOrderOnly xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not newContain newInOrderOnly (LinkedList("fee", "fie", "foe", "fum")) and not newContain newInOrderOnly (LinkedList("fee", "fie", "foe", "fum")))
        val e1 = intercept[TestFailedException] {
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not newContain newInOrderOnly (LinkedList("FEE", "FIE", "FOE", "FUM")) and not newContain newInOrderOnly (LinkedList("FEE", "FIE", "FOE", "FUM")))) (decided by upperCaseStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
    ...
    object `when used with (not equal xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not equal (toList) and not newContain newInOrderOnly (LinkedList("fee", "fie", "foe", "fum")))
        val e1 = intercept[TestFailedException] {
          fumList should (not equal (fumList) and not newContain newInOrderOnly (LinkedList("fee", "fie", "foe", "fum")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not equal (fumList) and not newContain newInOrderOnly (LinkedList("FEE", "FIE", "FOE", "FUM")))) (decided by invertedListOfStringEquality, decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
    ...
    object `when used with (not be xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        fumList should (not be (toList) and not newContain newInOrderOnly (LinkedList("fee", "fie", "foe", "fum")))
        val e1 = intercept[TestFailedException] {
          fumList should (not be (fumList) and not newContain newInOrderOnly (LinkedList("fee", "fie", "foe", "fum")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (fumList should (not be (toList) and not newContain newInOrderOnly (LinkedList("FEE", "FIE", "FOE", "FUM")))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
        ...
        (fumList should (not newContain newInOrderOnly (LinkedList(" FEE ", " FIE ", " FOE ", " FUU ")) and not newContain newInOrderOnly (LinkedList(" FEE ", " FIE ", " FOE ", " FUU ")))) (after being lowerCased and trimmed, after being lowerCased and trimmed)
      }
    }
 */
  }
...
/*
  object `col of Lists` {
    ...
    object `when used with (not be xx and not contain inOrderOnly xx)` {
      ...
      def `should do nothing if valid, else throw a TFE with an appropriate error message` {
        all (list1s) should (not be (List(2)) and not newContain newInOrderOnly (LinkedList(8, 3, 4)))
        atLeast (2, lists) should (not be (List(3)) and not newContain newInOrderOnly (LinkedList(8, 3, 4)))
        atMost (2, lists) should (not be (List(2, 3, 4)) and not newContain newInOrderOnly (LinkedList(2, 3, 4)))
        no (list1s) should (not be (List(1, 2, 3)) and not newContain newInOrderOnly (LinkedList(1, 2, 3)))
        
        val e1 = intercept[TestFailedException] {
          all (lists) should (not be (List(2, 3, 4)) and not newContain newInOrderOnly (LinkedList(8, 3, 4)))
        }
        ...
        val e4 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("ho")) and not newContain newInOrderOnly (LinkedList("hi", "hello")))
        }
      ...
      def `should use the implicit Equality in scope` {
        ...
        all (hiLists) should (not be (List("ho")) and not newContain newInOrderOnly (LinkedList("HO", "HELLO")))
        
        val e1 = intercept[TestFailedException] {
          all (hiLists) should (not be (List("hi", "hello")) and not newContain newInOrderOnly (LinkedList("HELLO", "HI")))
        }
      ...
      def `should use an explicitly provided Equality` {
        (all (hiLists) should (not be (List("ho")) and not newContain newInOrderOnly (LinkedList("HO", "HELLO")))) (decided by upperCaseStringEquality)
        val e1 = intercept[TestFailedException] {
          (all (hiLists) should (not be (List("hi", "hello")) and not newContain newInOrderOnly (LinkedList("HELLO", "HI")))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e1, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was equal to " + decorateToStringValue(List("hi", "hello")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
        
        val e2 = intercept[TestFailedException] {
          (all (hiLists) should (not be (List("ho")) and not newContain newInOrderOnly (LinkedList("HI", "HELLO")))) (decided by upperCaseStringEquality)
        }
        checkMessageStackDepth(e2, allErrMsg(0, decorateToStringValue(List("hi", "hello")) + " was not equal to " + decorateToStringValue(List("ho")) + ", but " + decorateToStringValue(List("hi", "hello")) + " contained the same elements in the same (iterated) order as " + decorateToStringValue(LinkedList("HI", "HELLO")), thisLineNumber - 2, hiLists), fileName, thisLineNumber - 2)
      }
    }
