  ...
  object `ContainMatcher ` {
    ...
    object `when use with 'and'` {
      ...
      def `should pass when both contain passes` {
        ...
        (left should (contain theSameElementsAs (right1) and contain oneOf (" one", " three", "five "))) (decided by equality afterBeing trimmed, decided by equality afterBeing trimmed)
        ...
        (left should (contain oneOf (" one", " three", "five ") and contain theSameElementsAs (right1))) (decided by equality afterBeing trimmed, decided by equality afterBeing trimmed)
    ...
    object `when use with 'or'` {
      ...
      def `should pass when one of contain passes` {
        ...
        (left should (contain theSameElementsAs (right1) or contain oneOf (" one", " three", "five "))) (decided by equality afterBeing trimmed, decided by equality afterBeing trimmed)
        ...
        (left should (contain oneOf (" one", " three", "five ") or contain theSameElementsAs (right1))) (decided by equality afterBeing trimmed, decided by equality afterBeing trimmed)
