...
class InOrderOnlyContainMatcherSpec
/*
class InOrderOnlyContainMatcherSpec extends Spec with Matchers {
  ...
  object `not inOrderOnly ` {
    ...
    def `should succeed when left List contains element not in right List` {
      List(1, 2, 3) should not contain newInOrderOnly (1, 2)
      Array(1, 2, 3) should not contain newInOrderOnly (1, 2)
      javaList(1, 2, 3) should not contain newInOrderOnly (1, 2)
      
      LinkedHashMap(1 -> "one", 2 -> "two", 3 -> "three") should not contain newInOrderOnly (1 -> "one", 2 -> "two")
      javaMap(1 -> "one", 2 -> "two", 3 -> "three") should not contain newInOrderOnly (1 -> "one", 2 -> "two")
    }
    
    def `should succeed when left List contains element in right List but in different order` {
      List(1, 2, 3) should not contain newInOrderOnly (3, 2, 1)
      Array(1, 2, 3) should not contain newInOrderOnly (3, 2, 1)
      javaList(1, 2, 3) should not contain newInOrderOnly (3, 2, 1)
      
      LinkedHashMap(1 -> "one", 2 -> "two", 3 -> "three") should not contain newInOrderOnly (3 -> "three", 2 -> "two", 1 -> "one")
      javaMap(1 -> "one", 2 -> "two", 3 -> "three") should not contain newInOrderOnly (3 -> "three", 2 -> "two", 1 -> "one")
    }
    ...
    def `should work with ContainMatcher directly` {
      ...
      List(1, 2, 8) should not contain newInOrderOnly (3, 2, 1)
      Array(1, 2, 8) should not contain newInOrderOnly (3, 2, 1)
      javaList(1, 2, 8) should not contain newInOrderOnly (3, 2, 1)
      
      LinkedHashMap(1 -> "one", 2 -> "two", 8 -> "eight") should not contain mapMatcher
      javaMap(1 -> "one", 2 -> "two", 8 -> "eight") should not contain mapMatcher
      
      LinkedHashMap(1 -> "one", 2 -> "two", 8 -> "eight") should not contain newInOrderOnly (3 -> "three", 2 -> "two", 1 -> "one")
      javaMap(1 -> "one", 2 -> "two", 8 -> "eight") should not contain newInOrderOnly (3 -> "three", 2 -> "two", 1 -> "one")
    }
    ...
    def `should throw TestFailedException with correct stack depth and message when left List contains only element in right List in same order` {
      ...
      val left3 = LinkedHashMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e3 = intercept[exceptions.TestFailedException] {
        left3 should not contain newInOrderOnly (1 -> "one", 2 -> "two", 3 -> "three")
      }
      checkStackDepth(e3, left3, Array(1 -> "one", 2 -> "two", 3 -> "three"), thisLineNumber - 2)
      
      val left4 = javaMap(1 -> "one", 2 -> "two", 3 -> "three")
      val e4 = intercept[exceptions.TestFailedException] {
        left4 should not contain newInOrderOnly (1 -> "one", 2 -> "two", 3 -> "three")
      }
      checkStackDepth(e4, left4, Array(1 -> "one", 2 -> "two", 3 -> "three"), thisLineNumber - 2)
      
      val left5 = Array(1, 2, 3)
      val e5 = intercept[exceptions.TestFailedException] {
        left5 should not contain newInOrderOnly (1, 2, 3)
      }
