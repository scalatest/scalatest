 ...
 *
 * <p>
 * The techniques in <code>PropSpec</code> are identical to those in <code>FunSuite</code>, but with &ldquo;<code>test</code>&rdquo;
...
class PropSpec extends PropSpecLike with ClassicTests {
