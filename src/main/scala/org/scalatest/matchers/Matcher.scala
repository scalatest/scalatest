...
// TODO: mention not short circuited, and the precendence is even between and and or
  ...
  final class AndContainWord {
     ...
     * </pre>
     */
    def allElementsOf[R](elements: GenTraversable[R]): MatcherFactory1[T, EvidenceThat[R]#CanBeContainedInAggregation] =
     ...
     * </pre>
     */
    def inOrderElementsOf[R](elements: GenTraversable[R]): MatcherFactory1[T, EvidenceThat[R]#CanBeContainedInSequence] =
     ...
     * </pre>
     */
    def oneElementOf[R](elements: GenTraversable[R]): MatcherFactory1[T, EvidenceThat[R]#CanBeContainedIn] =
     ...
     * </pre>
     */
    def atLeastOneElementOf[R](elements: GenTraversable[R]): MatcherFactory1[T, EvidenceThat[R]#CanBeContainedInAggregation] =
  ...
  final class AndNotWord {
     ...
     * </pre>
     */
    def be_==(o: Null): Matcher[T with AnyRef] = outerInstance.and(MatcherWords.not.be_==(o))
     ...
     * </pre>
     */
    def contain[R](right: ResultOfOneElementOfApplication[R]): MatcherFactory1[T, EvidenceThat[R]#CanBeContainedIn] =
      outerInstance.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain[R](right: ResultOfAtLeastOneElementOfApplication[R]): MatcherFactory1[T, EvidenceThat[R]#CanBeContainedInAggregation] =
      outerInstance.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain[R](right: ResultOfAllElementsOfApplication[R]): MatcherFactory1[T, EvidenceThat[R]#CanBeContainedInAggregation] =
      outerInstance.and(MatcherWords.not.contain(right))
     ...
     * </pre>
     */
    def contain[R](right: ResultOfInOrderElementsOfApplication[R]): MatcherFactory1[T, EvidenceThat[R]#CanBeContainedInSequence] =
      outerInstance.and(MatcherWords.not.contain(right))
...
// TODO: Write tests and impl for contain ResultOfKey/ValueWordApplication
  ...
  final class OrNotWord {
     ...
     *
     * <pre class="stHighlight">
     * aMatcher or not be_== (null)
     *                  ^
     * </pre>
     */
    def be_==(o: Null): Matcher[T with AnyRef] = outerInstance.or(MatcherWords.not.be_==(o))
