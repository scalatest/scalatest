 ...
 * supertype <a href="TripleEqualsConstraints.html"><code>TripleEqualsConstraints</code></a>, you can achieve the same
 ...
 * @author Bill Venners
 */
trait TripleEquals extends TripleEqualsConstraints {
