...
class NonEmptyVectorSpec extends UnitSpec {
  ...
  */
  ...
  it should "have a scanLeft method" in {
    ...
    NonEmptyVector(1, 2, 3).scanLeft("z")(_ + _) shouldBe NonEmptyVector("z", "z1", "z12", "z123")
    NonEmptyVector(0).scanLeft("z")(_ + _) shouldBe NonEmptyVector("z", "z0")
  }
  it should "have a scanRight method" in {
    ...
    NonEmptyVector(1, 2, 3).scanRight("z")(_ + _) shouldBe NonEmptyVector("123z", "23z", "3z", "z")
    NonEmptyVector(0).scanRight("z")(_ + _) shouldBe NonEmptyVector("0z", "z")
  }
