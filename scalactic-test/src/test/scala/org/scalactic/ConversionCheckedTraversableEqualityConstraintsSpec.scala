...
class ConversionCheckedTraversableEqualityConstraintsSpec extends FunSpec with NonImplicitAssertions with ConversionCheckedTripleEquals with TraversableEqualityConstraints {
