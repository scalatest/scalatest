...
class ConversionCheckedMapEqualityConstraintsSpec extends FunSpec with NonImplicitAssertions with ConversionCheckedTripleEquals with MapEqualityConstraints {
